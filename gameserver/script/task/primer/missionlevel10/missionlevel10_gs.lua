...
function PrimerLv10:OnLogin()
  if me.GetTask(1025, 33) == 2 then
    if Task:GetPlayerTask(me).tbTasks[tonumber(PrimerLv10.TASK_MAIN_ID, 16)] and Task:GetPlayerTask(me).tbTasks[tonumber(PrimerLv10.TASK_MAIN_ID, 16)].nReferId == tonumber(PrimerLv10.TASK_SUB_ID, 16) then
...
PlayerEvent:RegisterGlobal("OnLoginOnly", PrimerLv10.OnLogin, PrimerLv10)

...
function PrimerLv20:OnLogin()
  if me.GetTask(1025, 32) == 2 then
    if Task:GetPlayerTask(me).tbTasks[tonumber(PrimerLv20.TASK_MAIN_ID, 16)] and Task:GetPlayerTask(me).tbTasks[tonumber(PrimerLv20.TASK_MAIN_ID, 16)].nReferId == tonumber(PrimerLv20.TASK_SUB_ID, 16) then
...
PlayerEvent:RegisterGlobal("OnLoginOnly", PrimerLv20.OnLogin, PrimerLv20)

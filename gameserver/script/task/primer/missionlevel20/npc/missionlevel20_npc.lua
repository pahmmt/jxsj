...
function tbZhuzi:OnDialog()
  ...
  GeneralProcess:StartProcess("开启中...", 3 * Env.GAME_FPS, { self.OpenXiezi, self, him.dwId, me.nId }, nil, tbEvent)
end
...
function tbBottle:OnDialog()
  --	GeneralProcess:StartProcess("开启中...", 3 * Env.GAME_FPS, {self.OpenBottle,self,him.dwId,me.nId},nil,tbEvent);
end

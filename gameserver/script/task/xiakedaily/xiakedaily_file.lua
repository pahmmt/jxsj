...
function XiakeDaily:NewRefer(nReferId)
  ...
  tbReferData.szName = "侠客任务"
  tbReferData.tbDesc = {}
  tbReferData.tbDesc.szMainDesc = "完成每日指定的两个任务，可获得丰厚的奖励。\n每周完成第六次还有额外的令牌奖励。"
...
function XiakeDaily:SyncTask(nTarget1, nTarget2)
  ...
  local szDescribe = "江湖之上风起云涌，真正的侠义乃是急人之难、出言必信、锄强扶弱的豪侠之士。\n"
  ...
  szDescribe = szDescribe .. "任务完成后找临安府的<pos=夏侯元韬,29,1643,3946>领取奖励。"

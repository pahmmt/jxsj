...
tbGuWeng.tbLifePresentText = {
  ...
  [80] = {
    { "二哥，你的蛊好像不怎么厉害！", "天绝使" },
    { "胡说，你懂啥，现在出来都是没什么用的，厉害的在后头呢！", "碧蜈使" },
  },
  [70] = { { "二哥……", "天绝使" }, { "闭嘴！", "碧蜈使" } },
  [30] = {
    { "二哥，我看你的蛊是真的不行了！怕不是臭了吧？", "天绝使" },
    {
      "又不是在腌咸菜，什么臭不臭的，怕什么？出了事有我顶着，这都是些小屁孩，我怎么跟他们计较，传出去我还怎么见人？",
      "碧蜈使",
    },
  },
...
function tbDuXieYouChong:OnDeath(pNpc)
  ...
  if tbInstancing.nDuXieYouChong >= self.NEED_COUNT and tbInstancing.nXieWangOut == 0 then
    ...
    for _, teammate in ipairs(tbPlayList) do
      Task.tbArmyCampInstancingManager:ShowTip(teammate, "碧蜈使已出现")
    end
  end
end
...
tbBiWuShi.tbText = {
  ...
  [70] = {
    { "怎么的？看不起人？知道我是谁不？", "我可是百蛮山的老大！" },
    { "二哥，大姐知道会不高兴的！", "天绝使" },
    { "不高兴？她什么时候高兴过？", "她要是高兴的话早就是你二嫂了！" },
  },
  [50] = { "点子扎手！", "有点吃不消了！" },
  [30] = {
    { "我看我们还是去找大姐吧！", "天绝使" },

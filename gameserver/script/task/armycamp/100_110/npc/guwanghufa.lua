...
function tbHuFa:OnDeath(pNpc)
  ...
  local pDeng = KNpc.Add2(self.DENG_ID, 110, tbInstancing.tbChangShengDeng[tbInstancing.nChangShengDengCount], nSubWorld, self.tbPos[nIndex][1], self.tbPos[nIndex][2], 0, 0, 0, 0, self.tbSeries[tbInstancing.tbChangShengDeng[tbInstancing.nChangShengDengCount]][2])
  assert(pDeng)

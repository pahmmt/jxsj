...
function tbGift:OnOK()
  ...
  while pFind do
    local nDelCount = 0
    for _, tbItem in ipairs(tbNeedItemList) do
      if tbItem.nRemainCount > 0 and tbItem[1] == pFind.nGenre and tbItem[2] == pFind.nDetail and tbItem[3] == pFind.nParticular and (tbItem[4] == pFind.nLevel or tbItem[4] == -1) then

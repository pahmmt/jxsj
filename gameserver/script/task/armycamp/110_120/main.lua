...
function tbInstancing:OnPlayerEnter(nPlayerId)
  ...
  Task.tbArmyCampInstancingManager:ShowTip(pPlayer, "您进入了由" .. self.szOpenerName .. "在" .. self.szRegisterMapName .. "开启的" .. self.tbSetting.szName .. "副本", 20)

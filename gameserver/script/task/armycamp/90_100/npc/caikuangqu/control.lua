...
function tbNpc:OnDialog()
  ...
  if tbInstancing.tbBarrierPairs[nTrapIndex][3] == 1 then
    Task.tbArmyCampInstancingManager:ShowTip(me, "该机关已经被解开！")
    return
  end
  ...
  GeneralProcess:StartProcess("正在开启机关", 7 * 18, { self.OnOpen, self, me.nId, nSubWorld, nTrapIndex }, { me.Msg, "开启被打断！" }, tbEvent)
end
...
function tbNpc:OnOpen(nPlayerId, nMapId, nTrapIndex)
  ...
  Task.tbArmyCampInstancingManager:ShowTip(pPlayer, "一阵响声过后，一道闸门应声开启。")
end

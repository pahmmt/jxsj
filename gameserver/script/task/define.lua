...
Task.tbemTypeName = {
  [Task.emType_Main] = "<color=yellow>[剧情]<color>",
  [Task.emType_Branch] = "[世界]",
  [Task.emType_World] = "<color=blue>[江湖]<color>",
  [Task.emType_Random] = "[随机]",
  [Task.emType_Camp] = "<color=green>[军营]<color>",
}
...
Task.tbZhenYuanExpAward = { --奖励经验点数，每周奖励次数，任务变量主ID，次数子ID，时间子ID

...
function tb:Init(nNpcTempId, nNpcMapId, szOption, szRepeat, nAimMapId, nAimPosX, nAimPosY, nRange, szMainInfo, szYesOpt, szCancelOpt, szStaticDesc, szDynamicDesc, szBeforePop, szLaterPop, nFightState)

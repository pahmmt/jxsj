...
Merchant.TASK_ITEM_FIX = {
  -- 等级  任务变量,累计最大值,名称
  [1] = { nTask = 11, nMax = 3, szName = "宋金大将令牌", nLiveTime = 3600 * 2 }, --商会牌子1
  [2] = { nTask = 12, nMax = 6, szName = "宋金副将令牌", nLiveTime = 3600 * 2 }, --商会牌子2
  [3] = { nTask = 13, nMax = 15, szName = "宋金统领令牌", nLiveTime = 3600 * 2 }, --商会牌子3
  [4] = { nTask = 14, nMax = 9, szName = "白虎堂三层令牌", nLiveTime = 3600 * 2, hide = 1 }, --商会牌子4
  [5] = { nTask = 15, nMax = 9, szName = "白虎堂二层令牌", nLiveTime = 3600 * 2, hide = 1 }, --商会牌子5
  [6] = { nTask = 16, nMax = 15, szName = "白虎堂一层令牌", nLiveTime = 3600 * 2, hide = 1 }, --商会牌子6
  [7] = { nTask = 17, nMax = 10, szName = "逍遥谷5级令牌" }, --商会牌子7
  [8] = { nTask = 18, nMax = 10, szName = "逍遥谷4级令牌" }, --商会牌子8
  [9] = { nTask = 19, nMax = 10, szName = "逍遥谷3级令牌" }, --商会牌子8
  [10] = { nTask = 20, nMax = 10, szName = "逍遥谷2级令牌" }, --商会牌子8
  [11] = { nTask = 22, nMax = 10, szName = "家族令牌（初级）", item = { 18, 1, 110, 1 } }, --商会牌子8
  [12] = { nTask = 23, nMax = 10, szName = "门派竞技初级令牌", item = { 18, 1, 81, 1 } }, --商会牌子8
}

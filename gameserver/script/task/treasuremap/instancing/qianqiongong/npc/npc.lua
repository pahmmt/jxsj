...
function tbNpc_Task:OnDialog() end
...
function tbNpc_Hiding:OnExit() end
...
function tbNpc_Outside:OnDialog()
  ...
  Dialog:Say("你现在要离开这里吗？", { "是的", self.SendOut, self, me, nMapId, nMapX, nMapY }, { "暂不" })
end

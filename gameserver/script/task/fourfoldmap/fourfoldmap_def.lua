...
Fourfold.TIME_GET_READY = 3 -- 准备时间（分钟）
...
Fourfold.DEF_MAX_TIME = EventManager.IVER_nFourfoldMapMaxTime * 3600 --最大累计增加时间10小时;
Fourfold.DEF_PRE_TIME = EventManager.IVER_nFourfoldMapPreTime * 3600 --每天累计增加2小时;
Fourfold.DEF_MIN_OPEN_TIME = 120 * 60 --时间大于120分才能开启
...
Fourfold.UI_READYTIME_MSG = "<color=green>秘境开启剩余时间：<color=white>%s\n"
Fourfold.UI_TIME_MSG = "<color=green>秘境关闭剩余时间：<color=white>%s\n\n<color=green>秘境修炼剩余时间：<color=white>%s\n"
Fourfold.UI_STAIC_MSG = "<color=yellow>秘境修行中...<color>"

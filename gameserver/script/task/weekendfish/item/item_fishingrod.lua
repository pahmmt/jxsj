...
function tbClass:OnUse()
  if me.GetTask(WeekendFish.TASK_GROUP, WeekendFish.TASK_FISHING_STATE) == 1 then -- 收鱼
    ...
    GeneralProcess:StartProcess("钓鱼中", WeekendFish.PROCESS_TIME, { WeekendFish.ProcessFinish, WeekendFish, me.nId, pNpcFloat.dwId, pNpcFish.dwId, 1 }, { WeekendFish.ProcessBreak, WeekendFish, me.nId, pNpcFloat.dwId, pNpcFish.dwId, 1 }, tbEvent)
    -- 定时器随机是否钓到鱼
  end
  return 0
end

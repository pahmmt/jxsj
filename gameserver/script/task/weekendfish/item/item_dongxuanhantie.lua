...
function tbClass:MakeDongxuanhantieDlg(nIndex, nCount)
  ...
  GeneralProcess:StartProcess(szProductName .. "加工", self.nTime * Env.GAME_FPS, { self.MakeDongxuanhantie, self, me.nId, nIndex, nCount }, nil, tbEvent)
end

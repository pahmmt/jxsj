...
function tbClass:OnUse()
  ...
  GeneralProcess:StartProcess("ÓãÈº¼ø±ðÖÐ", WeekendFish.DETECT_FISH_SORT, { WeekendFish.DetectFinishSort, WeekendFish, me.nId, var, pNpcDetect.dwId }, { WeekendFish.DetectFinishSortBreak, WeekendFish, me.nId, pNpcDetect.dwId }, tbEvent)
  return 0
end

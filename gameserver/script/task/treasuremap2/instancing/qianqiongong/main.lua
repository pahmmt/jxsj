...
local tbBossPos = {
  ...
  [2] = { 1565, 2950, 6963, 2, 20 }, -- 萧媛媛（木）
  [3] = { 1579, 2819, 6965, 3, 25 }, -- 肖良（火）
  [4] = { 1714, 2775, 6966, 4, 25 }, -- 肖玉（土）
  [5] = { 1812, 2670, 6964, 5, 30 }, -- 冷霜然（水）
}
...
function tbInstancing:OnNew()
  ...
  for i = 1, #tbBossPos do
    ...
    if pNpc then
      pNpc.GetTempTable("TreasureMap2").nNpcScore = tbBossPos[i][5]
    end
    -- 统一注册血量触发事件，50% 和  30%

...
function tbTrap_Start:OnPlayer()
  ...
  if not nCaptainId then
    print("ERROR,qianqiongong trap start")
    return
  end
...
function tbTrap_1:OnPlayer()
  ...
  local nCaptainId = me.GetTempTable("TreasureMap2").nCaptainId
  if not nCaptainId then
    print("ERROR,qianqiongong trap 1")
    return
  end
...
function tbTrap_2:OnPlayer()
  ...
  local nCaptainId = me.GetTempTable("TreasureMap2").nCaptainId
  if not nCaptainId then
    print("ERROR,qianqiongong trap 2")
    return
  end
...
function tbTrap_3:OnPlayer()
  ...
  local nCaptainId = me.GetTempTable("TreasureMap2").nCaptainId
  if not nCaptainId then
    print("ERROR,qianqiongong trap 3")
    return
  end
...
function tbTrap_4:OnPlayer()
  ...
  local nCaptainId = me.GetTempTable("TreasureMap2").nCaptainId
  if not nCaptainId then
    print("ERROR,qianqiongong trap 4")
    return
  end

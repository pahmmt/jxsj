...
function tbBag_2:OnOpen(nPlayerId, dwNpcId)
  ...
  if pNpc and pNpc.nIndex > 0 then
    ...
    -- 通知附近的玩家
    TreasureMap2:NotifyAroundPlayer(pPlayer, "<color=yellow>" .. pPlayer.szName .. "得到了一张古琴！<color>")

...
tbInstancing.tbEnemyHole = {
  { 9788, 0, { 47264 / 32, 101152 / 32 }, { 47136 / 32, 101696 / 32 }, { 47840 / 32, 99776 / 32 }, { 48480 / 32, 100384 / 32 }, { 48288 / 32, 101856 / 32 } },
  { 9789, 0, { 47680 / 32, 100736 / 32 }, { 48384 / 32, 101152 / 32 } },
  { 9790, 0, { 47680 / 32, 100160 / 32 }, { 48032 / 32, 100576 / 32 }, { 48224 / 32, 99872 / 32 }, { 48480 / 32, 101536 / 32 }, { 47392 / 32, 101152 / 32 } },
  { 9791, 0, { 47296 / 32, 100352 / 32 }, { 47968 / 32, 101600 / 32 }, { 48352 / 32, 99616 / 32 }, { 48128 / 32, 101056 / 32 } },
} --陷阱等机关
...
function tbInstancing:AfterJoin()
  Dialog:SendBlackBoardMsg(me, "携卖国盟约者已分两路，先前去龙门关一探")
end
  ...
  if nLevel <= 1 then
    ...
    if nRand <= nRate then
      ...
      if not pItem then
        ...
        local szMsg = string.format("恭喜玩家<color=green>%s<color>在<color=red>【龙门飞剑】<color>副本中获得了稀有坐骑<color=purple>【%s】<color>", pPlayer.szName, pItem.szName)

...
local nNpcLevel = tbInstancing.nLevel
-- 百人战 NPC 及坐标
tbInstancing.tbSoldierPos_1 = {
  --    ID    等级 五行    X     Y       CAMP
  [1] = { 6997, 0, 1, 1654, 3067, 5 },
  [2] = { 6997, 0, 1, 1657, 3070, 5 },
  [3] = { 6997, 0, 1, 1660, 3073, 5 },
  [4] = { 6997, 0, 1, 1652, 3074, 5 },
  [5] = { 6997, 0, 1, 1656, 3078, 5 },
}
...
tbInstancing.tbDoctorPos = {
  [1] = { 7004, 0, 1, 1652, 3074, 5 },
  [2] = { 7004, 0, 1, 1656, 3078, 5 },
}
...
function tbInstancing:OnNew()
  ...
  self.tbBossPos = {
    ...
    [1] = { 6982, 0, 1, 1683, 3141, 5, 40 }, -- 铁浮屠 BOSS1
    [2] = { 6988, 0, 1, 1715, 3085, 5, 40 }, -- 百羽 BOSS2
    [3] = { 6989, 0, 2, 1734, 2944, 5, 40 }, -- 黄散一 BOSS3
    [4] = { 6990, 0, 2, 1691, 2891, 5, 45 }, -- 柳生 BOSS4
    [5] = { 6991, 0, 2, 1678, 2903, 5, 45 }, -- 贾茹 BOSS4
    [6] = { 6994, 0, 2, 1588, 2887, 5, 50 }, -- 谷仙仙
    [7] = { 6995, 0, 2, 1610, 3042, 5, 60 }, -- 醉僧
  }

  self.tbNpcPos = {
    --    ID    等级 五行    X     Y       CAMP
    [1] = { 6983, 0, 1, 1598, 3177, 0 }, -- 陶子战斗1
    [2] = { 6984, 0, 1, 1598, 3177, 0 }, -- 陶子对话1
    [3] = { 6985, 0, 1, 1598, 3177, 0 }, -- 陶子战斗2
    [4] = { 6981, 0, 1, 1593, 3180, 5 }, -- 铁莫西
    [5] = { 6986, 0, 1, 1688, 3136, 0 }, -- 青青战斗
    [6] = { 6987, 0, 1, 1688, 3136, 0 }, -- 青青对话
    [7] = { 2792, 0, 1, 1686, 3135, 0 }, -- 陶子对话2
    [8] = { 7000, 0, 1, 1605, 2895, 5 }, -- 花豹1
    [9] = { 7000, 0, 1, 1601, 2898, 5 }, -- 花豹2
    [10] = { 7009, 0, 1, 1629, 2930, 0 }, -- 牧童
    [11] = { 7010, 0, 1, 1631, 2933, 0 }, -- 绵羊
    [12] = { 7011, 0, 1, 1564, 3205, 0 }, -- 阮小六
    [13] = { 7012, 0, 1, 1734, 2944, 0 }, -- 黄散一对话

    [14] = { 6998, 0, 1, 1710, 3070, 5 }, -- 黑熊
    [15] = { 6998, 0, 1, 1715, 3066, 5 }, -- 黑熊
    [16] = { 6998, 0, 1, 1721, 3069, 5 }, -- 黑熊
  }
...
function tbInstancing:AddNpc(tbPos, nMapId)
  ...
  if pNpc then
    ...
    if tbPos[7] then
      pNpc.GetTempTable("TreasureMap2").nNpcScore = tbPos[7]
    end
  end
  return pNpc
end
...
function tbInstancing:AddSeekNpc(nNpcId, nLevel, nX, nY, tbSeekPos, nCamp, pPlayer, nCallBack, tbNpc)
  local nNpcLevel = self.nNpcLevel
  local pFightNpc = KNpc.Add2(nNpcId, nNpcLevel, -1, self.nMapId, nX, nY, 0, 0, 1)
...
function tbInstancing:tbActions_2()
  ...
  for i = 1, #tbPos do
    self:AddSeekNpc(tbPos[i][1], tbPos[i][2], tbPos[i][4], tbPos[i][5], { { 1661, 3058 }, { 1663, 3056 } }, 5, nil, 0, nil)
  end
end

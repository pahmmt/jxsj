...
TreasureMap2.MSG_REMAIN = "<color=green>剩余时间：<color=white>%s\n"
TreasureMap2.MSG_INSTANCE = "<color=green>%s %d星难度\n战斗积分：<color=white>%s\n\n"
--
...
TreasureMap2.LEVEL_RATE = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5 } -- 分数的难度系数加成
...
--[[
--以后可以考虑填成配置表 
--LQY: 已经配成表了 TreasureMapEx/MapsInfo.txt
...
TreasureMap2.LINGPAI_PRESENT = {
  ...
  [6] = {
    [1] = { tbItem = { 18, 1, 998, 2 }, nCount = 1 }, -- 95
    [2] = { tbItem = { 18, 1, 999, 2 }, nCount = 1 },
  }, -- 95
  [7] = {
    [1] = { tbItem = { 18, 1, 998, 2 }, nCount = 1 }, -- 100
    [2] = { tbItem = { 18, 1, 999, 2 }, nCount = 1 },
  }, -- 100
  [8] = {
    [1] = { tbItem = { 18, 1, 998, 3 }, nCount = 1 }, -- 110
    [2] = { tbItem = { 18, 1, 999, 3 }, nCount = 1 },
  }, -- 110
  [9] = {
    [1] = { tbItem = { 18, 1, 998, 3 }, nCount = 1 }, -- 120
    [2] = { tbItem = { 18, 1, 999, 3 }, nCount = 1 },
  }, -- 120
  [10] = {
    [1] = { tbItem = { 18, 1, 998, 3 }, nCount = 1 }, -- 130
    [2] = { tbItem = { 18, 1, 999, 3 }, nCount = 1 },
  }, -- 130
}
...
TreasureMap2.LINGPAI_WABAO = {
  ...
  [5] = {
    [1] = { tbItem = { 18, 1, 998, 2 }, nPro = 15 }, -- 90
    [2] = { tbItem = { 18, 1, 999, 2 }, nPro = 15 },
  }, -- 90
  [6] = {
    [1] = { tbItem = { 18, 1, 998, 2 }, nPro = 15 }, -- 100
    [2] = { tbItem = { 18, 1, 999, 2 }, nPro = 15 },
  }, -- 100
  [7] = {
    [1] = { tbItem = { 18, 1, 995, 3 }, nPro = 10 }, -- 110
    [2] = { tbItem = { 18, 1, 996, 3 }, nPro = 10 }, -- 110
    [3] = { tbItem = { 18, 1, 997, 3 }, nPro = 10 },
  }, -- 110
  [8] = {
    [1] = { tbItem = { 18, 1, 995, 3 }, nPro = 10 }, -- 120

...
Partner.BIND_PARTNERQUIP_MINTIME = 3600 * 3 * 24 -- 3天后可解绑同伴装备
Partner.BIND_PARTNERQUIP_MAXTIME = 3600 * 4 * 24 -- 4天后申请解绑失效
...
Partner.tbFsTalRate = { --技能个数，  领悟度曲线上限，该技能个数对应的最高同伴档次（对应maintenance.txt中的skilluprate列）。
  [2] = { 45, 40 },
  [3] = { 65, 50 },
  [4] = { 85, 70 },
  [5] = { 95, 80 },
...
Partner.szGiftContent = "无上智慧精华液可在龙五太爷处拆解。向同伴赠送礼物可增加其领悟度。\n可赠送的礼物有：<color=yellow>玄晶、魂石、金条、逍遥谷成品、领土战成品、秦陵成品、智慧精华、蓝田美玉、2级以及2级以上宝石原石<color>。\n<color=green>无上智慧精华液可在龙五太爷处拆解<color>"

...
tbItem.tbCardInfo = {
  [1] = {
    szName = "结义兄弟面具",
    tbCardGDPL = { 18, 1, 598, 5 },
    tbMarkGDPL = { 1, 13, 39, 1 },
    nNeedLevel = 1,
    nPurviewLevel = 2,
    nNeedSex = tbItem.SEX_MALE,
  },
  [2] = {
    szName = "闺中密友面具",
    tbCardGDPL = { 18, 1, 598, 6 },
    tbMarkGDPL = { 1, 13, 40, 1 },
    nNeedLevel = 1,
    nPurviewLevel = 2,
    nNeedSex = tbItem.SEX_FEMALE,
  },
  [3] = {
    szName = "蓝颜知己（华丽面具）",
    tbCardGDPL = { 18, 1, 598, 1 },
    tbMarkGDPL = { 1, 13, 35, 1 },
    nNeedLevel = 4,
    nPurviewLevel = 4,
    nNeedSex = tbItem.SEX_MALE,
  },
  [4] = {
    szName = "红颜知己（华丽面具）",
    tbCardGDPL = { 18, 1, 598, 2 },
    tbMarkGDPL = { 1, 13, 36, 1 },
    nNeedLevel = 4,
    nPurviewLevel = 4,
    nNeedSex = tbItem.SEX_FEMALE,
  },
  [5] = {
    szName = "蓝颜知己（普通面具）",
    tbCardGDPL = { 18, 1, 598, 3 },
    tbMarkGDPL = { 1, 13, 37, 1 },
    nNeedLevel = 4,
    nPurviewLevel = 4,
    nNeedSex = tbItem.SEX_MALE,
  },
  [6] = {
    szName = "红颜知己（普通面具）",
    tbCardGDPL = { 18, 1, 598, 4 },
    tbMarkGDPL = { 1, 13, 38, 1 },
    nNeedLevel = 4,
    nPurviewLevel = 4,
    nNeedSex = tbItem.SEX_FEMALE,
  },

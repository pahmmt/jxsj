...
-- 银元宝
local tbYinbao = Item:GetClass("kinsalary_yinbao")
function tbYinbao:OnUse()
  local nAddYinDing = 1000
  ...
  StatLog:WriteStatLog("stat_info", "family_salary", "open_yinbao", me.nId, nAddYinDing)
  return 1
end

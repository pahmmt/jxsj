...
function KinRepository:ApplyTakeAuthority_GS2(nPlayerId, dwKinId, nMemberId, nRoom)
  ...
  tbData.tbApplyRecord.nTimerId = Timer:Register(self.TAKE_REPOSITORY_APPLY_LAST, Kin.CancelExclusiveEvent_GS, Kin, dwKinId, Kin.KIN_EVENT_TAKE_REPOSITORY, nPlayerId)

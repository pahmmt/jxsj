...
if MODULE_GAMESERVER then
  ...
  function KinPlant:GetTempNpcInFo(nIndex, nTreeIndex)
    if nIndex and nTreeIndex and self.tbPlantNpcInfo[nIndex] and self.tbPlantNpcInfo[nIndex].tbTempNpcId[nTreeIndex] and self.tbPlantNpcInfo[nIndex].tbTime[nTreeIndex] then

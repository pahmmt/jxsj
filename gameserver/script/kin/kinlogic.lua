...
--以列表的PlayerId创建家族
function Kin:CreateKin(anPlayerId, anStoredRepute, szKinName, nCamp, nCreateTime, tbStock, nChallengeTimes)
  -- 阵营是否合法范围
  ...
  --设置称号
  cKin.SetTitleCaptain("族长")
  cKin.SetTitleAssistant("副族长")
  cKin.SetTitleMan("成员")
  cKin.SetTitleWoman("成员")
  cKin.SetTitleRetire("荣誉成员")
  cKin.SetChallengeTimes(nChallengeTimes)
  --组队队长作为族长
  cKin.SetCaptain(1)
  --设置ID生成器

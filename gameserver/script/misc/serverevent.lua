...
function ServerEvent:CdkeyVerifyResult(nResult) end
...
function ServerEvent:QueryNameResult(szRoleName, nResult) end

function ServerEvent:ChangeNameResult(szRoleName, nResult) end

function ServerEvent:ChangeTongNameResult(szOldTong, szNewTong, nResult) end

...
Atlantis.CHANGE_LIST = {
  [1] = {
    szBase = "楼兰珍宝·碧玉",
    szName = "碧血护腕碎片",
    tbBaseId = { 18, 1, 1235, 1 },
    tbItemId = { 18, 1, 1237, 1 },
    nNeedChip = 10,
    nNeedMoon = 3,
  },
  [2] = {
    szBase = "楼兰珍宝·灵晶",
    szName = "金鳞护腕碎片",
    tbBaseId = { 18, 1, 1235, 2 },
    tbItemId = { 18, 1, 1238, 1 },
    nNeedChip = 10,
    nNeedMoon = 10,
  },
  [3] = {
    szBase = "楼兰珍宝·雅瓷",
    szName = "碧血戒指碎片",
    tbBaseId = { 18, 1, 1236, 1 },
    tbItemId = { 18, 1, 1240, 1 },
    nNeedChip = 10,
    nNeedMoon = 4,
  },
  [4] = {
    szBase = "楼兰珍宝·白玉",
    szName = "金鳞戒指碎片",
    tbBaseId = { 18, 1, 1236, 2 },
    tbItemId = { 18, 1, 1241, 1 },
    nNeedChip = 10,
    nNeedMoon = 13,
  },
}

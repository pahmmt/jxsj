...
function tb1stRoom:StartRoom()
  ...
  self:InitTrapEnemy()
  self:StartSwitch()
  self.tbBase:UpdateUiState("夜逢迷镇斥候隐\n\n<color=red>解决所有斥候<color>")
end
...
function tb1stRoom:FailedRoom()
  ...
  self.tbBase:AllBlackBoard("布阵之人太过厉害！看来还需从头计议。")
end
...
function tb1stRoom:EndRoom()
  ...
  self.tbBase:AllBlackBoard("阵法瞬间消失，快快逮住前方斥候！")
  self:ClearRoom()
  self:RoomFinish()
end
...
function tb2ndRoom:StartRoom()
  ...
  self.tbBase:UpdateUiState("闹市偶遇少轻狂\n\n<color=red>打赢木铎落<color>")
end
...
function tb2ndRoom:OnBossPercent(nNpcId)
  ...
  self.tbBase:AllBlackBoard("兄弟们悠着点，别伤到旁的人！")
end
...
function tb2ndRoom:OnBossTalk(nNpcId)
  ...
  if szContent then
    ...
    self.tbBase:UpdateUiState("<color=red>跟着木铎落向前行走<color>")
    return 0
  end
end
...
function tb2ndRoom:FailedRoom()
  ...
  self:ClearRoom()
  self.tbBase:StartCurrentRoom()
  self.tbBase:AllBlackBoard("木铎落：“敢搭讪摩罗？！见你们一次打一次！”")
end
...
function tb2ndRoom:EndRoom()
  self.nIsFinished = 1
  self.tbBase:DropBox() --加宝箱
  self.tbBase:AllBlackBoard("恩，顺着这条路，尽头的石屋就是。后会有期！")
  self:ClearRoom()
  self:RoomFinish()
  -- 发经验
...
function tb3rdRoom:StartRoom()
  ...
  self:ClearRoom()
  self:StartAddBoss()
  self.tbBase:UpdateUiState("星河阵落异兽庞\n\n<color=red>击败星河异兽<color>")
end
...
function tb3rdRoom:FailedRoom()
  ...
  self:ClearRoom()
  self.tbBase:StartCurrentRoom()
  self.tbBase:AllBlackBoard("眼前一黑，星河异兽的蓝光离你们越来越远")
end
...
function tb3rdRoom:EndRoom()
  self.nIsFinished = 1
  self.tbBase:DropBox() --加宝箱
  self.tbBase:AllBlackBoard("星河异兽往前方石室遁逃，快追！")
  self:ClearRoom()
  self:RoomFinish()
end
...
function tb4thRoom:StartRoom()
  ...
  self:ClearRoom()
  self:AddStarManager()
  self.tbBase:UpdateUiState("月梦星棋谁人伤\n\n<color=red>解开灯棋阵<color>")
end
...
function tb4thRoom:StartFireLight()
  ...
  self.tbBase:UpdateUiState(string.format("月梦星棋谁人伤\n\n<color=green>点亮的灯：%s/%s<color>\n\n<color=red>点错的灯：%s/%s<color>", self.nFireCorrectLightCount, self.tbNeedFireLightCount[self.nCurrentStep], self.nFireErrorLightCount, self.nCanFireErrorCount))
end
...
function tb4thRoom:OnCastMovieSkill(nNpcId)
  ...
  self.tbBase:AllBlackBoard("灯棋阵已解，各位莫慌———————")
  return 0
end
...
function tb4thRoom:FailedRoom()
  ...
  self:ClearRoom()
  self.tbBase:StartCurrentRoom()
  self.tbBase:AllBlackBoard("莫非世间再无侠士可解灯棋阵之谜了么？")
end
...
function tb4thRoom:EndRoom()
  self.nIsFinished = 1
  self.tbBase:AllBlackBoard("他虽未言明，定有万般艰辛，先跟着他离开此地吧")
  self:ClearRoom()
  self:RoomFinish()
end
...
function tb5thRoom:StartRoom()
  ...
  self:AddStarManager()
  self:AddBoss()
  self.tbBase:UpdateUiState("一战嚣火追兵至\n\n<color=red>打败追兵头儿<color>")
end
...
function tb5thRoom:AddWalkNpc()
  ...
  if pNpc then
    ...
    self.tbBase:AllBlackBoard("风岫居士：“休要恋战！快跟我走！”")
  end
end
...
function tb5thRoom:OnBossPercent(nBossId, nPercent)
  ...
  self.tbBase:AllBlackBoard("人群中一人形迹可疑，先把那人解决了试试！")
...
function tb5thRoom:CastPassDebuff(nBossId)
  ...
  self.tbBase:AllBlackBoard("风岫居士：“硝云散！两人传递才保不死！”")
...
function tb5thRoom:FailedRoom()
  ...
  self:ClearRoom()
  self.tbBase:StartCurrentRoom()
  self.tbBase:AllBlackBoard("追兵头儿：“哈哈！九世星盘我带走了！”")
end
...
function tb6thRoom:StartRoom()
  ...
  self:AddBoss()
  self:AddStarManager()
  self.tbBase:UpdateUiState("故人相逢语又休\n\n<color=red>打赢拓跋浮樱<color>")
end
...
function tb6thRoom:FailedRoom()
  ...
  self:ClearRoom()
  self.tbBase:StartCurrentRoom()
  self.tbBase:AllBlackBoard("拓跋浮樱：“你们带不走他。”")
end
...
function tb6thRoom:EndRoom()
  ...
  self.tbBase:AllBlackBoard("风岫居士：“此人交给我，等异兽一到，你们速乘异兽离开！”")
end
...
function tb7thRoom:StartRoom()
  ...
  self:AddStarManager()
  self:AddUnFightBoss()
  self.tbBase:UpdateUiState("火海千重君莫留\n\n<color=red>冲过火海，关闭机关<color>")
end
...
function tb7thRoom:FailedRoom()
  ...
  self:ClearRoom()
  self.tbBase:StartCurrentRoom()
  self.tbBase:AllBlackBoard("你们迷失在辰虫的大火中，寻不到出路。")
end
...
function tb7thRoom:EndRoom()
  ...
  self.tbBase:AllBlackBoard("风岫和浮樱留在了火海里，这座名为辰虫的小镇再不曾出现过。")
  self.tbBase:DropBox() --加宝箱
  self:ClearRoom()
  self:RoomFinish()
end

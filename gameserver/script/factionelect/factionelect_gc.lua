...
function FactionElect:GetMenPaiDaNewsMsg()
  ...
  for i = 1, self.FACTION_NUM do
    ...
    szOneMsg = szOneMsg .. string.format("    名字：<color=yellow>%s<color>\n", tbInfo.szName) .. string.format("    等级：<color=green>%d<color>\n", tbInfo.nLevel) .. string.format("    家族：<color=pink>%s<color>\n", tbInfo.szKin) .. string.format("    帮会：<color=pink>%s<color>\n\n", tbInfo.szTong)

...
function LifeSkill:LoadAllRecipe()
  ...
  for _, tbRecipe in ipairs(tbRecipeSet) do
    ...
    tbRecipe.tbProductSet = {
      {
        tbItem = {
          tbRecipe.Produce1Genre,
          tbRecipe.Produce1Detail,
          tbRecipe.Produce1Parti,
          tbRecipe.Produce1Level,
          tbRecipe.Produce1Luck,
          tbRecipe.Produce1Series,
        },
      ...
      {
        tbItem = {
          tbRecipe.Produce2Genre,
          tbRecipe.Produce2Detail,
          tbRecipe.Produce2Parti,
          tbRecipe.Produce2Level,
          tbRecipe.Produce2Luck,
          tbRecipe.Produce2Series,
        },
      ...
      {
        tbItem = {
          tbRecipe.Produce3Genre,
          tbRecipe.Produce3Detail,
          tbRecipe.Produce3Parti,
          tbRecipe.Produce3Level,
          tbRecipe.Produce3Luck,
          tbRecipe.Produce3Series,
        },

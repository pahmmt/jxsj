...
Ladder.tbFacContext = {
  [Env.FACTION_ID_NOFACTION] = "世界修炼榜",
  [Env.FACTION_ID_SHAOLIN] = "少林修炼榜",
  [Env.FACTION_ID_TIANWANG] = "天王修炼榜",
  [Env.FACTION_ID_TANGMEN] = "唐门修炼榜",
  [Env.FACTION_ID_WUDU] = "五毒修炼榜",
  [Env.FACTION_ID_EMEI] = "峨嵋修炼榜",
  [Env.FACTION_ID_CUIYAN] = "翠烟修炼榜",
  [Env.FACTION_ID_GAIBANG] = "丐帮修炼榜",
  [Env.FACTION_ID_TIANREN] = "天忍修炼榜",
  [Env.FACTION_ID_WUDANG] = "武当修炼榜",
  [Env.FACTION_ID_KUNLUN] = "昆仑修炼榜",
  [Env.FACTION_ID_MINGJIAO] = "明教修炼榜",
  [Env.FACTION_ID_DALIDUANSHI] = "段氏修炼榜",
  [Env.FACTION_ID_GUMU] = "古墓修炼榜",
}

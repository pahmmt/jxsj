...
function PlayerEvent:Gb_PlayerLogin(bExchange)
  ...
  local szTongName = Transfer:GetPlayerTongName(me)
  local szKinName = Transfer:GetPlayerKinName(me)
  local szGateway = Transfer:GetMyGateway(me)
  GCExcute({ "Player:Login_GlobalServer_Global_GC", szGateway, me.nId, szTongName, szKinName })
end

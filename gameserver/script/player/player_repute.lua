...
function Player:AddReputeTitle(nCampId, nClassId, nLevel)
  if not self.tbTitleForRepute or not self.tbTitleForRepute[nCampId] or not self.tbTitleForRepute[nCampId][nClassId] or not self.tbTitleForRepute[nCampId][nClassId][nLevel] then
    return
  end

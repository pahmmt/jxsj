...
function tbXiMS:OnOpen() end

-- 在Mission被关闭“前”被调用
function tbXiMS:OnClose() end

-- 当玩家加入Mission“后”被调用
function tbXiMS:OnJoin(nGroupId) end

-- 当玩家离开Mission“前”被调用
function tbXiMS:BeforeLeave(nGroupId, szReason) end

-- 当玩家离开Mission“后”被调用
function tbXiMS:OnLeave(nGroupId, szReason) end

function tbXiMS:OpenXisuidao() end

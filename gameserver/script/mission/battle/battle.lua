...
function Battle:OpenBattle(nBattleId, nBattleLevel, nMapId, szMapName, nRuleType, nMapNpcNumType, nSeqNum, nBattleSeq, szBattleTime)
  ...
  local tbMission = Lib:NewClass(self.tbMissionBase, nBattleId, tbRuleData, szMapName, self.tbAllMapData[nMapId], nMapId, nMapNpcNumType, nSeqNum, nBattleSeq, szBattleTime)
...
if MODULE_GAMESERVER then
  PlayerEvent:RegisterGlobal("OnLoginOnly", Battle.OnPlayerLogin, Battle)
end

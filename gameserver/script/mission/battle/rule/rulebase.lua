...
-- 开始报名（之后）
function tbRuleBase:OnInit() end
...
-- 比赛结束（之前）
function tbRuleBase:OnClose() end

function tbRuleBase:OnLeave(pPlayer) end
...
function tbRuleBase:AddFightNpc(nCampId, szPosName, nRankId, bNoRevive)
  ...
  for i = 1, nNpcNumber do
    ...
    -- TODO:	最好不用Index
    tbNpcObj[#tbNpcObj + 1] = KNpc.Add2(tbAddNpc.nNpcId, tbAddNpc.nLevel, -1, tbPos[1], tbPos[2], tbPos[3], bRevive)
  end

...
function tbDaXia:OnGetPlayerNpc(tbBattleInfo, nCampId)
  ...
  local szFirMsg = string.format("<color=red>%s<color>军%s <color=green>%s<color> 现在已经成为战神大将！<color=red>%s<color>军将士们赶快去追随他吧！", Battle.NAME_CAMP[tbBattleInfo.tbCamp.nCampId], Battle.NAME_RANK[tbBattleInfo.nRank], tbBattleInfo.pPlayer.szName, Battle.NAME_CAMP[tbBattleInfo.tbCamp.nCampId])

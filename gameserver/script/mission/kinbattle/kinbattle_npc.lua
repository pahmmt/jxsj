...
function tbNpc:QueryResult()
  ...
  local szLastMaxKillTitle = "无"
  local szLastMaxSeriesTitle = "无"
  local szMaxKillTitle = "无"
  local szMaxSeriesTitle = "无"
  ...
  local szMsg = string.format(
    ...
    Lib:StrFillL(nLastKillTimes, 3),
    szLastMaxKillTitle,
    Lib:StrFillL(nLastMaxSeries, 3),
    szLastMaxSeriesTitle,
    nKinMatchTimes,
    nMatchTimes,
    nKillTimes,
    Lib:StrFillL(nMaxKillTimes, 3),
    szMaxKillTitle,
    Lib:StrFillL(nMaxSeries, 3),
    szMaxSeriesTitle
  )
  Dialog:Say(szMsg)
end

...
XoyoGame.NPC_POINT_PATH_LV6 = "\\setting\\xoyogame\\npc_pos_lv6.txt"
XoyoGame.NPC_POINT_PATH_LV7 = "\\setting\\xoyogame\\npc_pos_lv7.txt"
XoyoGame.NPC_POINT_PATH_LV8 = "\\setting\\xoyogame\\npc_pos_lv8.txt"
XoyoGame.NPC_POINT_PATH_LV15 = "\\setting\\xoyogame\\npc_pos_lv15.txt"
XoyoGame.NPC_POINT_PATH_LV16 = "\\setting\\xoyogame\\npc_pos_lv16.txt"
XoyoGame.NPC_POINT_PATH_LV17 = "\\setting\\xoyogame\\npc_pos_lv17.txt"
-- NPC移动路线
...
function XoyoGame:LoadRoomWeight(szPath)
  local tbNumColName = { RoomId = 1, Level = 1, Teams = 1, Weight = 1, WinExp = 1, LostExp = 1, LostRepute = 1, WinRepute = 1, Prestige = 1, TollGatePoint = 1 }
  local tbFile = Lib:LoadTabFile(szPath, tbNumColName)
  if tbFile then
    for _, tbItem in pairs(tbFile) do
      ...
      self.tbRoomExp[nRoomId].nTollGatePoint = tbItem.TollGatePoint or 0
    end
  end
end
...
XoyoGame:LoadNpcPoint(XoyoGame.NPC_POINT_PATH_LV6)
XoyoGame:LoadNpcPoint(XoyoGame.NPC_POINT_PATH_LV7)
XoyoGame:LoadNpcPoint(XoyoGame.NPC_POINT_PATH_LV8)
XoyoGame:LoadNpcPoint(XoyoGame.NPC_POINT_PATH_LV15)
XoyoGame:LoadNpcPoint(XoyoGame.NPC_POINT_PATH_LV16)
XoyoGame:LoadNpcPoint(XoyoGame.NPC_POINT_PATH_LV17)

...
tbRoom[1] = {
  ...
  LOCK = {
    ...
    [1] = {
      ...
      tbPrelock = {},
      tbStartEvent = {
        { XoyoGame.TIME_INFO, -1, "<color=green>离本关开启还有%s<color>", 1 },
    ...
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "杀死32头野狼" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {},
    },
    [4] = {
...
tbRoom[2] = {
  ...
  LOCK = {
    ...
    [2] = {
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3271>：“最近这山里的熊瞎子老不安分，可惜我这农活忙得走不开，看你们几个身手应该不错，去帮我收拾下这些猛兽吧。”",
        },
      },
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3271>：“没想到你们几个实力如此不济……想继续闯谷恐怕是凶多吉少。我看你们还是换条安全点的路吧。”",
        },
        { XoyoGame.DEL_NPC, "guaiwu" },
        { XoyoGame.TARGET_INFO, -1, "任务失败" },
      },
    ...
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "杀死28头黑熊" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {},
    ...
    [4] = {
      ...
      tbUnLockEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "任务完成" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3271>：“干得不错嘛！别急别急，坐下来烤烤火，休息一会，前方的道路自然会为你们开启。”",
        },
        { XoyoGame.DEL_NPC, "guaiwu" },
  ...
  LOCK = {
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "山坡下突然出现了4尊白虎雕像，周围聚集了许多猛虎，事有蹊跷，去调查一下那些雕像吧。",
        },
      },
      tbUnLockEvent = {
        { XoyoGame.DEL_NPC, "guaiwu" },
    ...
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "调查猛虎守卫的4尊雕像" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {},
  ...
  LOCK = {
    ...
    [2] = {
      ...
      tbUnLockEvent = {
        { XoyoGame.DEL_NPC, "guaiwu" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "似乎是嫌我们皮糙肉厚，鳄鱼对我们失去了兴趣，全部爬回了水里。看来我们只能换条路再想办法前进了……",
        },
        { XoyoGame.TARGET_INFO, -1, "任务失败" },
      },
    },
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "杀死40条鳄鱼" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "任务完成" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "终于干掉了所有鳄鱼，可以休息一会烤烤火了，逍遥谷中凶险异常，我们得认真面对下一项挑战啊。",
        },
...
tbRoom[5].LOCK[2].tbStartEvent[1] = {
  XoyoGame.MOVIE_DIALOG,
  -1,
  "<npc=3272>：“最近也不知哪里来了这么多鳄鱼，害得我都不敢出去捕鱼了，你们几个来得正好！去帮我收拾下这些猛兽吧。”",
}
tbRoom[5].LOCK[2].tbUnLockEvent[1] = {
  XoyoGame.MOVIE_DIALOG,
  -1,
  "<npc=3272>：“没想到你们几个实力如此不济……想继续闯谷恐怕是凶多吉少。我看你们还是换条安全点的路吧。”",
}
...
tbRoom[5].LOCK[3].tbStartEvent[4] = { XoyoGame.TARGET_INFO, -1, "杀死32条鳄鱼" }
...
tbRoom[5].LOCK[4].tbUnLockEvent = {
  ...
  { XoyoGame.TARGET_INFO, -1, "任务完成" },
  {
    XoyoGame.MOVIE_DIALOG,
    -1,
    "<npc=3272>：“干得不错嘛！别急别急，坐下来烤烤火，休息一会，前方的道路自然会为你们开启。”",
  },
...
tbRoom[6].LOCK[2].tbUnLockEvent[1] = {
  XoyoGame.MOVIE_DIALOG,
  -1,
  "似乎是嫌我们皮糙肉厚，鳄鱼对我们失去了兴趣，全部爬回了水里。哎……刚入谷就遇此猛兽，真不知前面还有什么凶险等着我们。",
}
...
tbRoom[6].LOCK[3].tbStartEvent[4] = { XoyoGame.TARGET_INFO, -1, "杀死28条鳄鱼" }
  ...
  LOCK = {
    ...
    [1] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TIME_INFO, -1, "<color=green>离本关开启还有%s<color>", 1 },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3273>：“各位大侠，帮个忙好吗？最近谷中野狼肆虐，我娘子出去好久了，我很担心她，可是又要照顾家中的孩子而不能脱身，如果各位能够把我娘子带回来，我会非常感激你们的。对了，你们顺着这条路往下走应该就能找到她了。”",
        },
        { XoyoGame.TARGET_INFO, -1, "找到筱璐，并护送筱潞回家" },
      },
      tbUnLockEvent = {},
    },
    [2] = {
      ...
      tbUnLockEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "任务完成" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3273>：“非常抱歉，我刚刚太冲动了。你们赶紧走吧，我需要冷静一下……前方的道路待会就会开启，你们好自为之。”\n说完，他便回到了屋内，我们隐约还能听到里面传来的婴儿的啼哭声……",
        },
      },
    },
    [3] = {
    ...
    [4] = {
      ...
      tbUnLockEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "任务完成" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3273>：“各位大侠的大恩大德我们今生难报。来来来，喝口酒，烤烤火，待会前方的道路就会开启了。”",
        },
    ...
    [5] = {
      ...
      tbUnLockEvent = {
        ...
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
        { XoyoGame.TARGET_INFO, -1, "击败发狂的任淼" },
    ...
    [6] = {
      ...
      tbUnLockEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "任务完成" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3273>：“各位，非常抱歉。看着自己娘子死在面前，我无法控制自己的情绪了。现在冷静下来想想，也不能责怪你们。各位休息下，烤烤火吧，前方的道路待会就会开启。”",
        },
        { XoyoGame.ADD_GOUHUO, 2, 150, "gouhuo", "7_gouhuo" },
      },
    },
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3274>：“你们来得正好，俺正愁找不到人帮手呢。这山顶有一匹无人能驯服的马王，俺们超哥吩咐俺今天内把它带回去，不过这一路上猛虎挡道，俺一个人搞不定哇……”",
        },
        { XoyoGame.ADD_NPC, 1, 28, 0, "guaiwu", "8_huanghu_3" }, -- 刷怪
        { XoyoGame.TARGET_INFO, -1, "护送任焱到达山顶" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {},
      ...
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3274>：“谢了哈，俺先回去交差了，哥几个先在这烤烤火，待会前方的道路自然会开启的。”",
        },
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" }, -- 完成任务设置标志
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
        { XoyoGame.DEL_NPC, "guaiwu" },
...
tbRoom[9].LOCK[1].tbStartEvent[1] = {
  XoyoGame.MOVIE_DIALOG,
  -1,
  "看着这片开阔的区域，心情也跟着舒畅起来。不过，树林里似乎传来了猛兽的气息……还是小心为妙。",
}
tbRoom[9].LOCK[2].tbStartEvent[1] = { XoyoGame.MOVIE_DIALOG, -1, "果然！数十头猛虎从林中蹿出，先杀光它们再寻找闯谷的道路吧。" }
tbRoom[9].LOCK[2].tbUnLockEvent[1] = {
  XoyoGame.MOVIE_DIALOG,
  -1,
  "似乎是嫌我们皮糙肉厚，老虎们对我们失去了兴趣，全部消失在密林里。哎……刚入谷就遇此猛兽，真不知前面还有什么凶险等着我们。",
}
...
tbRoom[9].LOCK[3].tbStartEvent[4] = { XoyoGame.TARGET_INFO, -1, "杀死40只黄虎" }
...
tbRoom[10].LOCK[1].tbStartEvent[1] = {
  XoyoGame.MOVIE_DIALOG,
  -1,
  "看着这片开阔的区域，心情也跟着舒畅起来。不过，树林里似乎传来了猛兽的气息……还是小心为妙。",
}
tbRoom[10].LOCK[2].tbStartEvent[1] = { XoyoGame.MOVIE_DIALOG, -1, "果然！数十头黑熊从林中蹿出，先杀光它们再寻找闯谷的道路吧。" }
tbRoom[10].LOCK[2].tbUnLockEvent[1] = {
  XoyoGame.MOVIE_DIALOG,
  -1,
  "似乎是嫌我们皮糙肉厚，熊瞎子也对我们失去了兴趣，全部消失在密林里。哎……刚入谷就遇此猛兽，真不知前面还有什么凶险等着我们。",
}
...
tbRoom[10].LOCK[3].tbStartEvent[4] = { XoyoGame.TARGET_INFO, -1, "杀死40头黑熊" }
...
tbRoom[11].LOCK[1].tbStartEvent[1] = {
  XoyoGame.MOVIE_DIALOG,
  -1,
  "看着这片开阔的区域，心情也跟着舒畅起来。不过，树林里似乎传来了猛兽的气息……还是小心为妙。",
}
tbRoom[11].LOCK[2].tbStartEvent[1] = { XoyoGame.MOVIE_DIALOG, -1, "果然！数十头野狼从林中蹿出，先杀光它们再寻找闯谷的道路吧。" }
tbRoom[11].LOCK[2].tbUnLockEvent[1] = {
  XoyoGame.MOVIE_DIALOG,
  -1,
  "似乎是嫌我们皮糙肉厚，狼群也对我们失去了兴趣，全部消失在密林里。哎……刚入谷就遇此猛兽，真不知前面还有什么凶险等着我们。",
}
...
tbRoom[11].LOCK[3].tbStartEvent[4] = { XoyoGame.TARGET_INFO, -1, "杀死40头野狼" }
...
tbRoom[12].LOCK[2].tbStartEvent[1] = {
  XoyoGame.MOVIE_DIALOG,
  -1,
  "<npc=3275>：“各位，我们被熊瞎子包围了。我跟它们斗了几个时辰了，不知各位可否帮我杀死他们呢？小心！又来了！”",
}
tbRoom[12].LOCK[2].tbUnLockEvent[1] = {
  XoyoGame.MOVIE_DIALOG,
  -1,
  "似乎是嫌我们皮糙肉厚，熊瞎子也对我们失去了兴趣，全部消失在密林里。哎……刚入谷就遇此猛兽，真不知前面还有什么凶险等着我们。",
}
...
tbRoom[12].LOCK[3].tbStartEvent[4] = { XoyoGame.TARGET_INFO, -1, "杀死40头黑熊" }
  ...
  LOCK = {
    ...
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "杀死32只花豹" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {},
    ...
    [4] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "杀死水潭边的猛兽" },
      },
      tbUnLockEvent = {
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" }, -- 完成任务设置标志
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
    ...
    [2] = {
      ...
      tbUnLockEvent = {
        ...
        { XoyoGame.DEL_NPC, "husong" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3263>：“哎哟……我的腰啊！你们还是送我回家养伤吧。以你们这种实力也别往谷深处去了，太危险了！”",
        },
        { XoyoGame.TARGET_INFO, -1, "任务失败" },
      },
    },
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3263>：“哎！谷中那狂人整的这些机关玩意又出来捣乱了，想出去采点药都不安生。你们几个看上去挺强的，就帮老汉一把吧。”",
        },
      ...
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3263>：“你们果然很强，要是有机会碰上制造这些机关兽的主，一定要帮我好好教训一下他！老汉我先走了，你们烤烤火，一会前方的道路自然会开启的。”",
        },
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" }, -- 完成任务设置标志
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
        { XoyoGame.DEL_NPC, "guaiwu" },
  ...
  LOCK = {
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3274>：“最近谷里居民抱怨说这湖里有水怪伤人，俺老大超哥派俺过来查探，不想碰上豹群……哥几个，帮个手吧。”",
        },
      },
      tbUnLockEvent = {},
    },
    [4] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "和任焱一起杀死32只花豹" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {},
    ...
    [5] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "和任焱一起杀死异兽" },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3274>：“哥几个，谢了哈！不过你们继续往深入谷里可能会遇上俺老大，他脾气不太好，你们最好小心点。待会前方的道路就会开启，你们先烤烤火吧。俺先走了哈。”",
        },
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" }, -- 完成任务设置标志
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
        { XoyoGame.DEL_NPC, "guaiwu" },
  ...
  LOCK = {
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3275>：“最近狼群肆虐，害得人们都不敢上山来观赏风景，我奉老大之命来收拾这群猛兽，不过好像数量有些多，你们……不介意帮我个忙吧。”",
        },
      },
      tbUnLockEvent = {},
    },
    [4] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "和任垚一起杀死28条野狼" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {},
    ...
    [5] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "和任垚一起杀死狼王" },
      },
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3275>：“呼！终于清静了。待会前方的道路就会开启，你们先烤烤火吧。在下先告辞了。”",
        },
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" }, -- 完成任务设置标志
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
        { XoyoGame.DEL_NPC, "guaiwu" },
  ...
  LOCK = {
    ...
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "杀死28条野狼" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {},
  ...
  LOCK = {
    ...
    [1] = {
      ...
      tbStartEvent = {
        { XoyoGame.ADD_NPC, 4, 1, 2, "husong", "18_renxin" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "小桥、流水、桃花，真是美不胜收！不过我们是来闯谷的，还是先找前边那位大叔问个路吧。",
        },
        { XoyoGame.TIME_INFO, -1, "<color=green>离本关开启还有%s<color>", 1 },
        { XoyoGame.TARGET_INFO, -1, "" },
      },
    ...
    [2] = {
      ...
      tbUnLockEvent = {
        ...
        { XoyoGame.DEL_NPC, "husong" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3284>：“哎呀！该死的猴子把我的新衣服弄破了，回去定遭娘子毒打，这可如何是好，如何是好啊！我……先闪了，你们自己想办法找路吧。”",
        },
        { XoyoGame.TARGET_INFO, -1, "任务失败" },
      },
    },
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3284>：“几位少侠，是不是觉得这桃花很美啊，不过近来山上的野猴却时常来捣乱，你们要不要随我一起教训一下这些泼猴？”",
        },
      },
      tbUnLockEvent = {},
    },
    [4] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "和任鑫一起教训捣乱的野猴" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {},
  ...
  LOCK = {
    ...
    [2] = {
      ...
      tbUnLockEvent = {
        { XoyoGame.DEL_NPC, "guaiwu" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "转瞬之间所有机关人都消失不见，只剩下狼狈不堪的我们。逍遥谷果然比想象的要艰险许多……",
        },
        { XoyoGame.TARGET_INFO, -1, "任务失败" },
      },
    },
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "杀死36个机关斧手" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "任务完成" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "真是一场恶战啊！要是有机会碰上制造这些机关人的主，一定要好好教训一下他！暂时还是先烤火休息下，等待下一个挑战吧。",
        },
  ...
  LOCK = {
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "似乎闯入了一个地下密道，前路也被阻住，看来要先找到打开这些铁栅栏的机关才能离开这里。",
        },
    ...
    [2] = {
      ...
      tbUnLockEvent = {
        ...
        { XoyoGame.DEL_NPC, "guaiwu" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "转瞬之间所有机关人都消失不见，只剩下迷失在密道里的我们……逍遥谷果然比想象的要艰险许多。",
        },
        { XoyoGame.TARGET_INFO, -1, "任务失败" },
      },
    },
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
        { XoyoGame.TARGET_INFO, -1, "解开密道的机关，找到出路" },
      },
      tbUnLockEvent = {
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3263>：“知道吗？这逍遥谷里产的仙灵果可是炼药的极品哦，谷里有位爷经常高价找我收呢。这不，今天又采了点，正想回家，却又遇上这些机关人。要不你们帮老汉我开条路，我给你们指明闯谷的道路，如何？”",
        },
      ...
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3263>：“你们真是好心人啊，要是有机会碰上制造这些机关人的主，一定要帮我好好教训一下他！老汉我先走了，你们烤烤火，一会前方的道路自然会开启的。”",
        },
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" }, -- 完成任务设置标志
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
        { XoyoGame.DEL_NPC, "guaiwu" },
  ...
  LOCK = {
    ...
    [2] = {
      ...
      tbUnLockEvent = {
        { XoyoGame.DEL_NPC, "guaiwu" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "转瞬之间剩下的毒蛇都逃进了石缝里，只剩下狼狈不堪的我们。哎，连几条蛇都收拾不掉，看来前方更是凶多吉少了。",
        },
        { XoyoGame.TARGET_INFO, -1, "任务失败" },
      },
    },
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "杀死36条蝮蛇" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {
    ...
    [1] = {
      ...
      tbStartEvent = {
        { XoyoGame.TIME_INFO, -1, "<color=green>离本关开启还有%s<color>", 1 },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "这山洞灯火通明，物资丰富，而且连投石机这种大规模杀伤性武器都有，究竟是什么人藏匿在此呢？",
        },
        { XoyoGame.TARGET_INFO, -1, "" },
      },
      tbUnLockEvent = {},
    ...
    [2] = {
      ...
      tbUnLockEvent = {
        { XoyoGame.DEL_NPC, "guaiwu" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "只听见洞外有人大吼一声：萧捕头来了！顷刻间，剩下的叛军都已逃匿无踪，只剩下一个疑问萦绕在我们心中：萧捕头是何许人也？",
        },
        { XoyoGame.TARGET_INFO, -1, "任务失败" },
      },
    },
  ...
  LOCK = {
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3264>：“我乃威震四海的萧不实，萧神捕！近日接到密报，有一股叛乱势力藏匿在逍遥谷研制大规模杀伤性武器，他们的头目应该就藏在此地，你们要不要和我一起进去将他捉拿归案？”",
        },
      },
      tbUnLockEvent = {},
    },
    [4] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "和萧不实一起捉拿叛军头目" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {},
      ...
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3264>：“你们这群小贼给我等着，萧爷爷我吃了10级磨刀石再来会你们！”\n说完一溜烟就不见了踪影，看来这残局得靠我们自己来收拾了……",
        },
      },
    },
  },
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3265>：“几位哥哥姐姐，晓菲听说逍遥谷里有很多好玩的东西，所以偷偷溜了进来，可是却在这迷路了……你们能帮帮我吗？”",
        },
    ...
    [2] = {
      ...
      tbUnLockEvent = {
        ...
        { XoyoGame.DEL_NPC, "husong" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "一群雪人把晓菲扛起，消失在风雪之中，我们能做的也只有祈求上苍保佑这位大小姐福大命大了……",
        },
        { XoyoGame.TARGET_INFO, -1, "任务失败" },
      ...
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3265>：“瞧，那边几棵树上有些奇怪的文字，可能是走出这雪山的关键，你们陪晓菲去看看吧。”",
        },
        { XoyoGame.TARGET_INFO, -1, "和晓菲一起找到雪山的出路" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
    },
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3265>：“哇……吓死晓菲了，还好有你们在。树上的秘文我认识，再去下一棵树那看看吧。”",
        },
    ...
    [11] = {
      ...
      tbUnLockEvent = {
        { XoyoGame.DEL_NPC, "husong" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3265>：“(*^__^*) 嘻嘻……任务完成！这些树上写的是：当雪之女王归来之时，吾族之秘宝才会重现光芒！究竟是什么意思呢？好啦，各位哥哥姐姐，晓菲先去找好玩的东西啦，后会有期咯。”",
        },
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" }, -- 完成任务设置标志
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
        { XoyoGame.CLOSE_INFO, -1 },
  ...
  LOCK = {
    ...
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "杀死24只野猴" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {},
    ...
    [5] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "消灭所有机关斧手" },
      },
      tbUnLockEvent = {
...
tbRoom[27] = {
  ...
  LOCK = {
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3275>：“我听说这一带的野狼变得异常了，特地过来看看，结果被它们重伤，为了村子的安全，你们几个可以帮我杀死这些野兽吗？”",
        },
        ...
        { XoyoGame.TIME_INFO, -1, "<color=green>离本关结束还有%s<color>", 2 },
        { XoyoGame.TARGET_INFO, -1, "杀死20只野狼" },
      },
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "只听见得一声奇怪的吼声，余下的狼群全部逃回山中。我们心中充满问号：到底是谁有这么大的威慑力？",
        },
        { XoyoGame.DEL_NPC, "guaiwu" },
        { XoyoGame.TARGET_INFO, -1, "任务失败" },
      },
    },
    [3] = { nTime = 30, nNum = 0, tbPrelock = { 1 }, tbStartEvent = {}, tbUnLockEvent = {} },
    [4] = { nTime = 0, nNum = 20, tbPrelock = { 1 }, tbStartEvent = {}, tbUnLockEvent = {} },
    [5] = {
      nTime = 0,
      nNum = 1,
      tbPrelock = { 3 },
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "保护任垚，同时杀死20只野狼" },
      },
      tbUnLockEvent = {
    ...
    [6] = { nTime = 150, nNum = 0, tbPrelock = { 3 }, tbStartEvent = {}, tbUnLockEvent = {
      { XoyoGame.DEL_NPC, "baohu" },
    } },
    [7] = {
      nTime = 0,
      ...
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3288>:“咦，狼怎么就全没了？哇哈哈哈，小朋友们，干得不错啊，来烤烤火休息一下吧。”",
        },
  ...
  LOCK = {
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "似乎进入了一个果园，在逍遥谷中走了这么久，终于有一个有吃的东西的地方了，都快饿死了。",
        },
        { XoyoGame.TIME_INFO, -1, "<color=green>离本关开启还有%s<color>", 1 },
    ...
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "在果园找点能填饱肚子的东西" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {},
    ...
    [4] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "击败40个果农" },
      },
      tbUnLockEvent = {
  ...
  LOCK = {
    ...
    [4] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "击败所有的劣质机关人" },
    ...
    [5] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "击败紫苑和所有机关人" },
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "瓜农：我最近按照谷主的要求培育了一种新型西瓜。现在谷主要我把成果运过去，可是大部分西瓜都被一群猴子抢走了，哎，不知各位能不能帮我夺回来。",
        },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
        ...
        { XoyoGame.TARGET_INFO, -1, "到坡下去抢回西瓜" },
      },
      tbUnLockEvent = {},
    },
    [4] = {
      ...
      tbUnLockEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "护送运送西瓜的马车" },
      },
    },
    [5] = {
      nTime = 0,
      ...
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "瓜农：“几位辛苦了，来吃口西瓜休息一下吧，我得继续赶路，先走了。待会前方的道路自会为你们打开。”",
        },
        { XoyoGame.DEL_NPC, "guaiwu" },
        { XoyoGame.DEL_NPC, "husong" },
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" }, -- 完成任务设置标志
      ...
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "转瞬之间，周大飞和所有幽灵都消失不见，只留下惊魂未定的我们和一堆散发着奇怪光芒的物体，难道……这就是传说中的秘宝？",
        },
        { XoyoGame.DEL_NPC, "guaiwu" },
        { XoyoGame.DEL_NPC, "husong" },
        { XoyoGame.TARGET_INFO, -1, "任务失败" },
      ...
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3267>：“为什么……我又要死在这种地方……究竟还要等多少年，我才能离开这鬼地方啊？”",
        },
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
        { XoyoGame.DEL_NPC, "guaiwu" },
        { XoyoGame.DEL_NPC, "husong" },
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3267>：“你们……是活人？太好了！求求你们带我离开鬼地方吧。这里好多幽灵，太可怕了。瞧，它们又出来了。”",
        },
        { XoyoGame.TARGET_INFO, -1, "护送周大飞离开此地" },
      ...
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3267>：“谢谢你们，我终于可以重见天日了，哈哈哈！哎？为什么……为什么我的身体在消失，为什么？我不要回到那个地方……不要啊……”\n转眼间，周大飞的身体已飞灰湮灭，只留下一堆篝火。算了，不去想那么多，专心烤火吧。",
        },
        { XoyoGame.DEL_NPC, "guaiwu" },
        { XoyoGame.DEL_NPC, "husong" },
  ...
  LOCK = {
    ...
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "干掉30个劣质机关人" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {},
    ...
    [4] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.CHANGE_TRAP, "33_trap_1", nil },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3228>：“居然能打败我制造的机关人，实力不赖嘛，过来陪我玩玩吧。”\n前方的铁栅栏好像打开了，过去瞧瞧是什么人在挑衅。",
        },
        { XoyoGame.TARGET_INFO, -1, "击败秦仲" },
      },
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "有惊无险的击败了秦仲。不过真是怪人处处有，逍遥谷里特别多，他们怎么就老喜欢整这些机关玩意来折磨人呢？",
        },
        { XoyoGame.DEL_NPC, "guaiwu" },
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" }, -- 完成任务设置标志
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
  ...
  LOCK = {
    ...
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "干掉34个幽冥鬼" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {},
  ...
  LOCK = {
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3279>：“哈哈哈，闯荡逍遥谷的侠士们，让我来考考你们对这个江湖的了解程度吧。请你们双方的队长来我这接受考验吧。”",
        },
        { XoyoGame.TIME_INFO, -1, "<color=green>离本关开启还有%s<color>", 1 },
        { XoyoGame.TARGET_INFO, -1, "" },
      },
    ...
    [2] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
        { XoyoGame.TARGET_INFO, -1, "由队长回答九天道人的问题" },
      },
      tbUnLockEvent = {
  ...
  LOCK = {
    ...
    [1] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TIME_INFO, -1, "<color=green>离开始PK剩余时间%s<color>", 1 },
        { XoyoGame.TARGET_INFO, -1, "敌方击败我方成员数：0\n我方击败敌方成员数：0" },
      },
      tbUnLockEvent = {},
    },
    [2] = {
      ...
      tbPrelock = { 1 },
      tbStartEvent = {
        { XoyoGame.TIME_INFO, -1, "<color=green>PK剩余时间%s<color>", 2 },
...
tbRoom[38] = {
  ...
  LOCK = {
    ...
    [1] = {
      ...
      tbStartEvent = {
        { XoyoGame.ADD_NPC, 1, 1, 0, "baohu", "38_cuixiaoou" }, -- 保护NPC
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3280>：最近谷里来了好多凶神恶煞的贼人，爸爸妈妈又出去了，小鸥好害怕妈妈辛苦培育的宝贝被贼人们抢走了，你们能帮帮我吗？",
        },
        { XoyoGame.TIME_INFO, -1, "<color=green>离本关开启还有%s<color>", 1 },
        { XoyoGame.TARGET_INFO, -1, "" },
    ...
    [11] = {
      ...
      tbPrelock = { 1 },
      tbStartEvent = {
        { XoyoGame.TIME_INFO, -1, "<color=green>离本关结束还有%s<color>", 11 },
        { XoyoGame.TARGET_INFO, -1, "保护翠小鸥" },
      },
      tbUnLockEvent = {
    ...
    [12] = {
      ...
      tbUnLockEvent = {
        { XoyoGame.DEL_NPC, "guaiwu" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "就在这时，小鸥站了起来！原来刚才她是装死的。幸好这位机智的小女孩向萧捕头说明了情况，我才能逃过一劫，真是谢天谢地啊。\n<npc=3280>：太好了，恶人们都走了！你们去看看我家的宝贝吧。应该就藏在瀑布下面。",
        },
    ...
    [13] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.ADD_NPC, 4, 1, 13, "guaiwu", "38_xiaobushi" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3264>: 我接到线报说，此处强盗出没，危害百姓生活因此过来看看。没想到你们这群没有人性畜生，连个小女孩都不放过！今天就要让你们尝尝萧某的厉害！",
        },
        { XoyoGame.TARGET_INFO, -1, "击败萧不实" },
        { XoyoGame.FINISH_ACHIEVE, -1, 208 }, -- achieve
        { XoyoGame.TIME_INFO, -1, "<color=green>离本关结束还有%s<color>", 12 },
      },
      tbUnLockEvent = {
        { XoyoGame.DEL_NPC, "guaiwu" },
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "经过一场艰难的战斗，我们终于制住了萧捕头。和萧捕头一番解释之后，他相信了我们，并带着小鸥的尸首离开了这里。我们也该休息下然后继续前进了。",
        },
        { XoyoGame.CLOSE_INFO, -1 },
        --{XoyoGame.FINISH_ACHIEVE, -1,208}, -- achieve
        { XoyoGame.TARGET_INFO, -1, "任务完成" },
    ...
    [14] = {
      ...
      tbUnLockEvent = {
        { XoyoGame.DEL_NPC, "guaiwu" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "这群强盗太难缠了。这是，传来一声巨吼：萧某在此！谁敢造次！声毕，只见那群强盗一溜烟作鸟兽散。只留下手舞足蹈的翠小鸥和狼狈不堪的我们。",
        },
        { XoyoGame.TARGET_INFO, -1, "任务失败" },
        { XoyoGame.DEL_NPC, "baohu" },
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "抵挡了一阵，但是还是有大批强盗涌了过来。想要真正保护小鸥，必须要收拾掉他们的头领才行",
        },
        { XoyoGame.ADD_NPC, 2, 18, 0, "guaiwu", "38_chuangguzei_3" },
        { XoyoGame.ADD_NPC, 3, 2, 15, "guaiwu", "38_chuangguzeitouling_3" },
        { XoyoGame.TARGET_INFO, -1, "击败2名闯谷贼头领" },
        { XoyoGame.TIME_INFO, -1, "<color=green>离本关结束还有%s<color>", 14 },
      },
      tbUnLockEvent = {
  ...
  LOCK = {
    ...
    [2] = {
      ...
      tbUnLockEvent = {
        ...
        { XoyoGame.DO_SCRIPT, "self.tbLock[3]:Close()" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "闯谷贼头领：“你们几个家伙还算有点真本事，好汉不吃眼前亏，兄弟们，撤！\n转眼间，所有贼人都逃匿无踪……”",
        },
        { XoyoGame.TARGET_INFO, -1, "任务失败" },
      },
    },
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "四处找找看有什么可疑的东西" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {},
    ...
    [4] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "干掉所有埋伏在此的闯谷贼" },
      },
      tbUnLockEvent = {},
    },
    [5] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "干掉闯谷贼头领" },
      },
      tbUnLockEvent = {
  ...
  LOCK = {
    ...
    [3] = {
      ...
      tbUnLockEvent = {
        ...
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "（一个奇怪的声音再次响起）“神奇的旅人啊，你们竟然可以解开我设下的机关。想必你们听过很多‘此地无银三百两’的故事，不过此地真的无银！哇哈哈哈哈哈。”",
        },
        { XoyoGame.CLOSE_INFO, -1 },
        { XoyoGame.TARGET_INFO, -1, "任务完成" },
    ...
    [4] = {
      ...
      tbUnLockEvent = {
        ...
        { XoyoGame.DEL_NPC, "jiguan" },
        { XoyoGame.TARGET_INFO, -1, "解开4个机关。请注意，要及时开启机关，否则守护兽是会不断涌出的。" },
      },
    },
    [5] = {
      nTime = 0,
  ...
  LOCK = {
    ...
    [1] = {
      ...
      tbStartEvent = {
        { XoyoGame.ADD_NPC, 1, 1, 0, "baishe", "41_jinghua" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3281>：“瞧这桃花开的，真是美啊！但山上的野猴们好像已经按耐不住了，老围着我家的桃树打转，帮我赶走它们吧。”",
        },
        { XoyoGame.TIME_INFO, -1, "<color=green>离本关开启还有%s<color>", 1 },
        { XoyoGame.TARGET_INFO, -1, "" },
    ...
    [2] = {
      ...
      tbUnLockEvent = {
        ...
        { XoyoGame.DO_SCRIPT, "self.tbLock[3]:Close()" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "大战一场以后，其他猴子都受到惊吓逃回了山上，没想到我们连几只猴子都收拾不了，惭愧啊。",
        },
        { XoyoGame.TARGET_INFO, -1, "任务失败" },
      },
    },
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "杀死32只野猴" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {},
  ...
  LOCK = {
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3268>：听说此地有个能造出完美机关兽的天才，本想来拜会他一下，却没想到他的机关兽如此凶悍……前方有座民房，你们能送我到那让我疗下伤吗？",
        },
        { XoyoGame.ADD_NPC, 2, 16, 0, "guaiwu", "42_jiguanjulang" }, -- 刷怪
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>护送剩余时间%s<color>", 2 },
        { XoyoGame.TARGET_INFO, -1, "将受伤的香玉仙送到民居内疗伤" },
      },
      tbUnLockEvent = {},
    },
    [4] = {
    ...
    [6] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 5 },
        { XoyoGame.TARGET_INFO, -1, "杀死所有机关巨狼" },
      },
      tbUnLockEvent = {
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" }, -- 完成任务设置标志
        { XoyoGame.DO_SCRIPT, "self.tbLock[5]:Close()" },
  ...
  LOCK = {
    ...
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "5分钟内消灭28只机关巨狼" },
        { XoyoGame.TIME_INFO, -1, "<color=green>离本关结束还有%s<color>", 3 },
      },
      tbUnLockEvent = {
        { XoyoGame.DEL_NPC, "guaiwu" },
    ...
    [7] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "教训这些野猴" },
      },
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "赶走了可恶的猴子，拿回了果子。这次的遭遇真令人不悦。好好休息下，准备继续前进吧。",
        },
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" },
        { XoyoGame.CLOSE_INFO, -1 },
        { XoyoGame.TARGET_INFO, -1, "任务完成" },
...
tbRoom[44] = {
  ...
  LOCK = {
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "没想到谷中还有如此规模宏大的地下宫殿……四周连个鬼影都没有，看来得小心行动才行。",
        },
        { XoyoGame.TIME_INFO, -1, "<color=green>离本关开启还有%s<color>", 1 },
        { XoyoGame.TARGET_INFO, -1, "" },
    ...
    [6] = {
      ...
      tbPrelock = { 4, 5 },
      tbStartEvent = {
        { XoyoGame.TARGET_INFO, -1, "杀死所有的机关巨狼" },
      },
      tbUnLockEvent = {},
    },
    [7] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TIME_INFO, -1, "<color=green>剩余时间%s<color>", 2 },
        { XoyoGame.TARGET_INFO, -1, "杀死完美的机关巨狼" },
      },
      tbUnLockEvent = {
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" }, -- 完成任务设置标志
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
    ...
    [15] = {
      ...
      tbUnLockEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "任务完成" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3280>：耶！哥哥姐姐，你们太棒了！啊？要回家了，不然会被妈妈骂的。哥哥姐姐下次要来我家做客哦。",
        },
        { XoyoGame.ADD_GOUHUO, 2, 150, "gouhuo", "45_gouhuo" },
      },
    },
    [16] = { nTime = 0, nNum = 2, tbPrelock = { 7 }, tbStartEvent = {}, tbUnLockEvent = {} },
  },
}
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3265>：“人家好不容易才从雪山逃出来，没想到又被关在这了，这些机关人好可怕。呜……我可不想成为这里的一堆白骨哇……你们快帮帮我吧。”",
        },
        ...
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
        { XoyoGame.TARGET_INFO, -1, "救助被困的晓菲" },
      },
      tbUnLockEvent = {},
    },
    [4] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "保护晓菲离开此地" },
      },
      tbUnLockEvent = {
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" }, -- 完成任务设置标志
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
        ...
        { XoyoGame.TARGET_INFO, -1, "任务完成" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3265>：“你们真是好心人，听说再往前走就是逍遥谷的最深处了，不知道有没有机会见到传说中英俊潇洒的谷主呢，先走一步了哟。”\n说完，这位冒失的大小姐又不知跑到什么地方去了……",
        },
  ...
  LOCK = {
    ...
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "击败20个闯谷贼" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
      },
      tbUnLockEvent = {},
    },
    [4] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "击败完美的机关巨狼" },
      ...
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3292>：“几位大侠真是仗义！行走江湖，最重要的就是一个“<color=gold>义<color>”字，这里的宝箱就留给你们作为谢礼吧。兄弟们，快出来谢谢几位救命恩人！”",
        },
        { XoyoGame.TARGET_INFO, -1, "任务完成" },
    ...
    [7] = { nTime = 3, nNum = 0, tbPrelock = { 6 }, tbStartEvent = {}, tbUnLockEvent = {} },
    [8] = {
      nTime = 8,
      nNum = 0,
      tbPrelock = { 7 },
    ...
    [9] = {
      ...
      tbUnLockEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "江湖险恶！干掉所有贼人！" },
  ...
  LOCK = {
    ...
    [2] = {
      ...
      tbUnLockEvent = {
        ...
        { XoyoGame.DEL_NPC, "boss" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3244>：“算了……火也发过了，架也打了，为了几只兔子没必要弄出人命。我去山里再抓两只来，你们好自为之。”",
        },
        { XoyoGame.TARGET_INFO, -1, "任务失败" },
      },
    },
    ...
    [4] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
        { XoyoGame.TARGET_INFO, -1, "弄点兔肉填饱肚子" },
      },
      tbUnLockEvent = {
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3245>：“能来到这里，证明你们不是泛泛之辈。来吧！让我将你们的身体改造成最杰出的作品吧！”",
        },
        { XoyoGame.ADD_NPC, 1, 1, 7, "guaiwu", "51_hukun" },
        { XoyoGame.TARGET_INFO, -1, "击败胡坤" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
      ...
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3245>：“可恶……难道是我的作品还不够完美……等着瞧！下次要让你们见识到真正的恐怖……禁术！影遁！”\n转眼间，这个神秘的狂徒已遁去无踪……经历了一场恶战的我们还是先休息休息，烤烤火吧。",
        },
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" }, -- 完成任务设置标志
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
        { XoyoGame.DO_SCRIPT, "self.tbLock[3]:Close()" },
  ...
  LOCK = {
      ...
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "监军：“什么，侦查队那边有魔枪的线索！算你们运气好，今天就放过你们了。兄弟们，撤！”",
        },
        { XoyoGame.TARGET_INFO, -1, "任务失败" },
        { XoyoGame.DEL_NPC, "guaiwu" },
      },
    ...
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "击败30个远征军，4个督军" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {},
    ...
    [4] = {
      ...
      tbUnLockEvent = {
        { XoyoGame.ADD_GOUHUO, 2, 150, "gouhuo", "52_gouhuo" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "监军：“你们这群毛贼，竟敢在太岁头上动土，胆子不小。你们等着，看我以后怎么收拾你们！”",
        },
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" }, -- 完成任务设置标志
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
        { XoyoGame.CLOSE_INFO, -1 },
  ...
  LOCK = {
      ...
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "这世道变化也忒大了吧。我们都在这江湖上混了这么久了，竟然连这点事都做不好。哎！这是什么江湖啊！",
        },
        { XoyoGame.TARGET_INFO, -1, "任务失败" },
        { XoyoGame.DEL_NPC, "husong" },
        { XoyoGame.DEL_NPC, "guaiwu" },
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3208>：我们相聚就是缘分呐。既然有缘分就劳烦各位送我到前方的亭子那休息下吧，要知道我在谷里也走了很久了。",
        },
      },
      tbUnLockEvent = {},
    },
      ...
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3208>：我发现前方的高地上有个箱子，说不定里面有宝藏哦，你们要不要也一起去看看啊。",
        },
        { XoyoGame.TARGET_INFO, -1, "保护寻宝者过去一探究竟。" },
      },
    },
    [6] = {
      nTime = 0,
    ...
    [8] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "击败2名追踪者。" },
      },
      tbUnLockEvent = {},
    },
    [9] = {
      ...
      tbUnLockEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "任务完成" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "虽然击败了寻宝者，但是还是没能制止C4迦楼罗的发动，哎，找个好地方，等着爆炸的风暴把我们带出逍遥谷吧。",
        },
        { XoyoGame.ADD_GOUHUO, 2, 150, "gouhuo", "53_xunbaozhe_zhandou" },
      },
    },
    [10] = { nTime = 0, nNum = 1, tbPrelock = { 1 }, tbStartEvent = {}, tbUnLockEvent = {} },
    [11] = {
      nTime = 0,
      nNum = 23,
      tbPrelock = { 10 },
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "击败23名武装捕快" },
      },
    },
    [12] = {
      nTime = 0,
      ...
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3206>：可恶，没想到你们这群帮凶还真了得。不过俺们也是不吃素的，接招吧C4迦楼罗！！\n<playername>:切，我们正愁没法出谷呢，这下好了，可以借着爆炸飞出谷咯。",
        },
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" },
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
        { XoyoGame.CLOSE_INFO, -1 },
  ...
  LOCK = {
    ...
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "击败32个强盗" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {},
    ...
    [4] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "击败2个强盗头领" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {
  ...
  LOCK = {
    ...
    [4] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "尽可能消灭所有吴兵。" },
        { XoyoGame.DO_SCRIPT, "self.tbLock[10]:Close()" },
      },
      tbUnLockEvent = {},
    },
    ...
    [6] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "击败吴军的两名统领" },
      },
      tbUnLockEvent = {},
    },
    [7] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.DEL_NPC, "boss2" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3227>：我是说我们的演习为什么会出现错误，原来又是你们这群莫名其妙的家伙在捣乱。上次摧毁我杰作的账还没算呢！！\n<npc=3228>：师妹，别生气。让我们一起教训教训这群狂妄的家伙。",
        },
        { XoyoGame.TARGET_INFO, -1, "击败紫苑和秦仲" },
      },
      tbUnLockEvent = {
        { XoyoGame.TARGET_INFO, -1, "任务完成" },
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" },
    ...
    [8] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.MOVIE_DIALOG, -1, "一群机关人突然出现还对打起来！！真是有意思。我们也去凑凑热闹吧。" },
        { XoyoGame.TARGET_INFO, -1, "尽可能消灭所有魏兵。" },
        { XoyoGame.DO_SCRIPT, "self.tbLock[6]:Close()" },
      },
      tbUnLockEvent = {},
    },
    ...
    [10] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "击败一名魏兵统领" },
      },
      tbUnLockEvent = {},
    },
    [11] = {
...
tbRoom[57] = {
  ...
  LOCK = {
    ...
    [2] = {
      ...
      tbPrelock = { 1 },
      tbStartEvent = {
        { XoyoGame.TIME_INFO, -1, "<color=green>离本关开启还有%s<color>", 2 },
      },
      tbUnLockEvent = {
    ...
    [6] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "前往下片区域开启机关" },
      },
      tbUnLockEvent = {},
    },
    [7] = {
    ...
    [12] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "击杀20个劣质机关人" },
      },
      tbUnLockEvent = {
        { XoyoGame.DEL_NPC, "guaiwu" },
        { XoyoGame.CHANGE_TRAP, "57_trap_3", nil },
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3264>：“是的！我就是传说中的萧神捕！你们几个，咋这么眼熟呢？哦，对了，我听说叛军首领煞大目就藏着在这附近，你们要不要和我一起将他捉拿归案？”",
        },
      },
      tbUnLockEvent = {},
    },
      ...
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3264>：“你们这群小贼给我等着，萧爷爷我吃了10级护甲片再来会你们！”\n说完一溜烟就不见了踪影。突然传来一声巨吼：“萧不实啊萧不实，你也有今天！！”",
        },
      },
    },
    [7] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "到西方，阻止萧不实逃走" },
      },
      tbUnLockEvent = {
  ...
  LOCK = {
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3292>：“弟兄们，看看这附近有什么值钱的东西，全部拿走！”\n<npc=3210>：“前方乃是逍遥谷禁地！擅闯者死！”",
        },
      },
      tbUnLockEvent = {
        { XoyoGame.DO_SCRIPT, "self.tbLock[3]:Close()" },
    ...
    [4] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "帮谁？自己决定吧。" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 8 },
      },
      tbUnLockEvent = {
        { XoyoGame.DO_SCRIPT, "self.tbLock[5]:Close()" },
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
    ...
    [6] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.ADD_NPC, 7, 3, 0, "baoxiang", "59_chuangguzeitouling" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3292>：“这里可是逍遥谷藏宝之地，我们正愁没人收拾这些烦人的侍卫呢，这下好了，一群笨蛋帮了我们不少忙，哈哈哈哈哈”",
        },
        { XoyoGame.TARGET_INFO, -1, "击败闯谷贼头领" },
      },
      tbUnLockEvent = {
  ...
  LOCK = {
      ...
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3214>：“能与我等战成均势，果然是后生可畏，不过今日时候不早，诸位也该离谷了，来日有缘再战。”",
        },
        { XoyoGame.TARGET_INFO, -1, "任务失败" },
        { XoyoGame.DEL_NPC, "guaiwu" },
        { XoyoGame.DO_SCRIPT, "self.tbLock[5]:Close()" },
    ...
    [4] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "击败28个侍卫" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {
    ...
    [5] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "击败竹叶青、石横霞、羌郭来、吴建" },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 3 },
      },
      tbUnLockEvent = {
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3268>：“几位少侠好生眼熟，不知道能不能帮小女子一个忙？”\n<playername>:“请讲！”\n<npc=3268>：“刚刚有个狂徒说是对我一见钟情，想与我交好。我不依，他便放出好多恐怖的机关怪兽来威胁我，你们能保护我离开这里吗？”",
        },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TARGET_INFO, -1, "护送香玉仙离开此地" },
      },
      tbUnLockEvent = {},
    },
    [4] = {
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3268>：“呼，终于可以松一口气了。啊？那家伙好像追来了，我先藏起来，你们帮我拖住他。”\n<npc=3245>：“香香，你为什么不肯接受我？！我知道你藏在这里，我一定会找到你的！”",
        },
        { XoyoGame.ADD_NPC, 8, 1, 6, "boss", "61_hukun" }, -- 胡坤
        { XoyoGame.TARGET_INFO, -1, "击败因爱而发狂的胡坤" },
        { XoyoGame.FINISH_ACHIEVE, -1, 202 }, -- achieve 胡坤
      },
      tbUnLockEvent = {
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" }, -- 完成任务设置标志
        ...
        { XoyoGame.TARGET_INFO, -1, "任务完成" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3268>：“你们打败那个大坏蛋了？真是太谢谢了！诶呀，天色不早，我该离谷了，出去后要是有机会再见我一定送把好武器给你们。”",
        },
        { XoyoGame.ADD_GOUHUO, 2, 150, "gouhuo", "61_gouhuo" },
      },
    },
      ...
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3247>：“好好好，打住打住！你们功夫火候还差那么点，不过老夫很开心，来，先休息会，待会老夫送你们离开逍遥谷。”",
        },
        { XoyoGame.TARGET_INFO, -1, "任务失败" },
        { XoyoGame.DEL_NPC, "guaiwu" },
      },
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3247>：“有朋自远方来，不亦说乎。哈哈哈哈哈！好久没有外人来老夫这光顾了。来来来，陪我活动活动筋骨吧。”",
        },
        { XoyoGame.ADD_NPC, 1, 1, 3, "guaiwu", "64_mojun" },
        { XoyoGame.TARGET_INFO, -1, "击败墨君" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3247>：“好久没有这么爽快的打上一场了，各位功夫着实不错，来，喝喝酒，休息一下，老夫会送各位离开逍遥谷的。”",
        },
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" }, -- 完成任务设置标志
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
        { XoyoGame.CLOSE_INFO, -1 },
      ...
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3250>：“年轻人呐，你们还得多多修炼啊。我好长时间没有激烈运动过了，今天动了下就腰酸背痛腿抽筋了，哎，回去休息啰。”",
        },
        { XoyoGame.TARGET_INFO, -1, "任务失败" },
        { XoyoGame.DEL_NPC, "guaiwu" },
      },
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3250>：“在这谷里住了这么久，很少能看到生面孔呢。看几位应该身手不错，来陪老夫过上几招吧，不知道你们有没有本领接老夫十招呢？”",
        },
        { XoyoGame.ADD_NPC, 1, 1, 3, "guaiwu", "65_tangyu" },
        { XoyoGame.TARGET_INFO, -1, "击败唐羽" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3250>：“哎，不承认不行了啊，人呐，到了这个年龄，是该好好休息了，舞刀弄枪这种事，还是适合你们年轻人去做。年轻真好啊。”",
        },
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" }, -- 完成任务设置标志
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
        { XoyoGame.CLOSE_INFO, -1 },
  ...
  LOCK = {
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3320>：逍遥谷中的外人是越来越多了，欺负过我弟弟的人也是越来越多了。我这个做哥哥的实在看不下去了，一定要教训教训你们。想当年师傅传授技巧时，我为了我弟弟放弃了学艺，但是师傅他老人家被我的行动所感动，传授了他不为人所知的一面给我。今天我就要让你们知道什么叫做生不如死。",
        },
        { XoyoGame.TIME_INFO, -1, "<color=green>离本关开启还有%s<color>", 1 },
        { XoyoGame.TARGET_INFO, -1, "" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
    ...
    [2] = {
      ...
      tbUnLockEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "任务失败" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3320>:啊！弟弟啊，你来了，看哥哥帮你教训这群。。可恶，竟然趁我分神之际溜走了。哼！你们下次别落在我手里！",
        },
        { XoyoGame.DO_SCRIPT, "self.tbLock[3]:Close()" },
      },
    },
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "击败胡乾" },
      },
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3320>：不！这不是真的！弟弟，做哥哥的对不起你，没能帮你报仇！师傅啊，徒儿不孝，给您老抹黑了！",
        },
  ...
  LOCK = {
    ...
    [2] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "制伏女孩子以便解释。" },
      },
      tbUnLockEvent = {
    ...
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "不管用？继续吧。" },
      },
      tbUnLockEvent = {
    ...
    [5] = {
      ...
      tbStartEvent = {
        { XoyoGame.CHANGE_TRAP, "67_trap", { 58400 / 32, 74336 / 32 } },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=3316>：哎哟喂，想不到会有谷外之人来到这里，既然是这样就让奴家好好伺候各位吧。\n- -b，这里究竟是什么地方。",
        },
      },
      tbUnLockEvent = {},
    },
    ...
    [7] = {
      ...
      tbPrelock = { 1 },
      tbStartEvent = {
        { XoyoGame.TIME_INFO, -1, "<color=green>离本关结束还有%s<color>", 7 },
      },
      tbUnLockEvent = {
        { XoyoGame.DEL_NPC, "guaiwu" },
        { XoyoGame.TARGET_INFO, -1, "任务失败" },
  ...
  LOCK = {
    ...
    [2] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "我们有0个萝卜\n他们有0个萝卜" },
        { XoyoGame.TIME_INFO, -1, "<color=green>拔萝卜剩余时间%s<color>", 2 },
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "宝果子、二丫、小荷、小楚这四个捣蛋鬼已经藏好了，他们四个中只有一个是真正的小偷，你要在时间结束前抓住他。找对的有奖，找错了要受罚。如果想知道谁是真的小偷，那就去问小神童易周和小机灵易凡吧！",
        },
        --{XoyoGame.TIME_INFO, -1, "<color=green>捉迷藏剩余时间%s<color>", 2},
        { XoyoGame.TARGET_INFO, -1, "抓到了0个捣蛋鬼" },
  ...
  LOCK = {
    ...
    [1] = {
      ...
      tbStartEvent = {
        { XoyoGame.TIME_INFO, -1, "<color=green>离本关开启还有%s<color>", 1 },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "根据探子回报，金军已经集结在城门外，并兵分两路准备进犯本城，请各位大侠全力击退金军，万不可让他们攻到内城门口。",
        },
        { XoyoGame.TARGET_INFO, -1, "" },
    ...
    [2] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "击退入侵的金军" },
    ...
    [3] = {
      nTime = 0,
      nNum = 1, -- switch_a1 -> trap_a1, gate_a1
      tbPrelock = { 1 },
      tbStartEvent = {},
      tbUnLockEvent = {
    ...
    [4] = {
      nTime = 0,
      nNum = 1, -- switch_b1 -> trap_b1, gate_b1
      tbPrelock = { 1 },
      tbStartEvent = {},
      tbUnLockEvent = {
    ...
    [5] = {
      nTime = 0,
      nNum = 1, -- switch_a2 -> trap_a2, gate_a2
      tbPrelock = { 1 },
      tbStartEvent = {},
      tbUnLockEvent = {
    ...
    [6] = {
      nTime = 0,
      nNum = 1, -- switch_b2 -> trap_b2, gate_b2
      tbPrelock = { 1 },
      tbStartEvent = {},
      tbUnLockEvent = {
  ...
  LOCK = {
    ...
    [2] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TIME_INFO, -1, "<color=green>剩余时间%s<color>", 2 },
        { XoyoGame.TARGET_INFO, -1, "<color=red>将飞贼赶入官府的埋伏圈\n找出张德恒夺回青花瓷瓶<color>" },
  ...
  LOCK = {
    ...
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "击败围攻上前的老妈子" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {},
  ...
  LOCK = {
    ...
    [2] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "帮助工匠徒弟点燃火焰" },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
      },
      tbUnLockEvent = {
...
tbRoom[75] = {
  ...
  LOCK = {
    ...
    [2] = {
      ...
      tbPrelock = { 1 },
      tbStartEvent = {
        { XoyoGame.TARGET_INFO, -1, "完成六道军令的操演" },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
      },
      tbUnLockEvent = {
...
tbRoom[76].LOCK[2].tbUnLockEvent[2] = {
  XoyoGame.MOVIE_DIALOG,
  -1,
  "只听见有人大吼一声：萧捕头来了！顷刻间，剩下的叛军都已逃匿无踪，只剩下一个疑问萦绕在我们心中：萧捕头是何许人也？",
}
...
tbRoom[79] = {
  ...
  LOCK = {
    ...
    [4] = { nTime = 150, nNum = 0, tbPrelock = { 1 }, tbStartEvent = {}, tbUnLockEvent = {} },
    [5] = { nTime = 300, nNum = 0, tbPrelock = { 1 }, tbStartEvent = {}, tbUnLockEvent = {} },
    [6] = {
      nTime = 0,
      nNum = 1,
      tbPrelock = { 4 },
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=6737>：“大哥哥，大姐姐，你们来陪我玩好吗，我们玩毒毒的游戏，如果你们死不了就是你们赢了。”",
        },
  ...
  LOCK = {
    ...
    [2] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.DO_SCRIPT, "self:CreateNpc()" },
        { XoyoGame.TARGET_INFO, -1, "击败百草园丁郑雨华" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {
    ...
    LOCK = {
      ...
      [3] = {
        ...
        tbStartEvent = {
          ...
          { XoyoGame.TARGET_INFO, -1, "击杀礼信" },
        },
        tbUnLockEvent = {
          { XoyoGame.TARGET_INFO, -1, "往前跑，不要被哑哑追到" },
          { XoyoGame.CHANGE_TRAP, "86_trap1", nil },
          { XoyoGame.DEL_NPC, "shuijing1" },
      ...
      [7] = { nTime = 0, nNum = 1, tbPrelock = { 6 }, tbStartEvent = {}, tbUnLockEvent = {
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=6739>：“妹子，我们这片林子有客人到了呢，看来今天谷里来了了不起的人物了呢。”<end><npc=6740>：“姐姐，好久没看到您显露功夫了，不如今天露一手给小妹开开眼啊！”<end>",
        },
        { XoyoGame.ADD_NPC, 1, 1, 3, "yexuan", "87_yexuan" },
        { XoyoGame.TARGET_INFO, -1, "击败璇静双姝" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {
  ...
  LOCK = {
    ...
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "杀死36名金军溃兵" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {
  ...
  LOCK = {
    ...
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "杀死32名流寇" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {},
  ...
  LOCK = {
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "监牢里最近收押了几名罪大恶极的犯人，为防止有人前来劫狱，捕头请我们前来协助看守。一定不能让这些货色得逞",
        },
        { XoyoGame.TIME_INFO, -1, "<color=green>离本关开启还有%s<color>", 1 },
        { XoyoGame.TARGET_INFO, -1, "" },
      },
    ...
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
        { XoyoGame.TARGET_INFO, -1, "击杀8名劫狱者" },
      },
      tbUnLockEvent = {
        { XoyoGame.DEL_NPC, "guaiwu" },
      },
    ...
    [6] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.ADD_NPC, 2, 3, 0, "guaiwu", "104_yueyuzhe_4" }, -- 越狱者4
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "看来这次行动的首领出现了。声东击西的计策么，居然亲自来劫狱。想必是很重要的犯人。既然来了，说不得，要请留下喝茶详细叙说叙说才是。",
        },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
        { XoyoGame.TARGET_INFO, -1, "击杀劫狱者首领" },
      },
      tbUnLockEvent = {
        { XoyoGame.DEL_NPC, "guaiwu" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "犯下累累罪行者，就不要妄图能脱离正义的审判了。我们没有辜负捕头的信任，休息一下吧。",
        },
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" }, -- 完成任务设置标志
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
        { XoyoGame.CLOSE_INFO, -1 },
  ...
  LOCK = {
    ...
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TARGET_INFO, -1, "开启南侧的机关" },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {},
    },
    [4] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "开启北侧的机关" },
      },
      tbUnLockEvent = {},
    },
    [5] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "杀死20头机关兽" },
      },
      tbUnLockEvent = {},
    },
    [6] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "教训西侧房屋前的天机道童" },
      },
      tbUnLockEvent = {
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" }, -- 完成任务设置标志
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
        ...
        { XoyoGame.TARGET_INFO, -1, "任务完成" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "出口慢慢的浮现了出来，看来成功通过了密境。先休息一下吧，如有机会真想见见这个神秘的人物。",
        },
  ...
  LOCK = {
      ...
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "居然被这些野狼把难得的猎物偷走了，看来真的是修行不足啊，还是回去多多锻炼才是……",
        },
        { XoyoGame.DEL_NPC, "guaiwu" },
        { XoyoGame.TARGET_INFO, -1, "任务失败" },
      },
    ...
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "狩猎32头马鹿" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {},
    ...
    [4] = {
      ...
      tbUnLockEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "任务完成" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "狩猎收获颇丰，又成功的教训了偷食的野狼。坐下来烤烤火，休息一下，等待下一个挑战吧。",
        },
  ...
  LOCK = {
    ...
    [1] = {
      ...
      tbStartEvent = {
        { XoyoGame.TIME_INFO, -1, "<color=green>离本关开启还有%s<color>", 1 },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "近日有很多灾民辗转而来，口粮渐渐成了问题，军需官老王分身乏术，请我们在谷中看看能不能寻到什么食物。",
        },
        { XoyoGame.TARGET_INFO, -1, "" },
      },
      tbUnLockEvent = {},
    ...
    [2] = {
      ...
      tbUnLockEvent = {
        { XoyoGame.DEL_NPC, "guaiwu" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "这下杯具了，西瓜都被猴子抢走了，只好在去寻找别的食物。也不知道猴子是怎么想的，他们会吃西瓜么……",
        },
        { XoyoGame.TARGET_INFO, -1, "任务失败" },
      },
    },
    ...
    [4] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "击败20只来夺食的野猴" },
    ...
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.ADD_NPC, 3, 10, 0, "guaiwu6", "108_shibing_1" }, -- 刷怪
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "敌人开始进攻了，襄阳城高墙厚，敌军虽然人多势众也都无用！，只需要消灭敌军携带攻城器械的先登死士和先登统帅即可！",
        },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TARGET_INFO, -1, "阻止敌人的先登死士和先登统帅靠近城门" },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {},
    },
  ...
  LOCK = {
    ...
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
        { XoyoGame.TARGET_INFO, -1, "解开前方的秘道机关" },
      },
      tbUnLockEvent = {},
    },
    [4] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TARGET_INFO, -1, "击退8名古墓派追兵弟子" },
      },
      tbUnLockEvent = {
    ...
    [6] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "击退8名古墓派追兵弟子和齐倚剑" },
      },
      tbUnLockEvent = {
    ...
    [8] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "击退8名古墓派追兵弟子和厉凌霄" },
      },
      tbUnLockEvent = {
    ...
    [10] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.ADD_NPC, 5, 1, 10, "guaiwu", "109_zhuibing3" }, -- 追兵头3
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "这里是通道尽头了，追来的这三个人看来是有些地位的弟子，迅速摆脱他们我们就安全了！",
        },
        { XoyoGame.TARGET_INFO, -1, "击退齐倚剑，厉凌霄和梅胜云" },
      },
      tbUnLockEvent = {
  ...
  LOCK = {
    ...
    [1] = {
      ...
      tbStartEvent = {
        { XoyoGame.TIME_INFO, -1, "<color=green>离本关开启还有%s<color>", 1 },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "义军出奇思妙想，以棋局为形，演练军势。现下棋武坪上有汉楚两营士兵在互相操演。此前不曾见过此等操演方式，今次定要好好观摩一番。",
        },
        { XoyoGame.TARGET_INFO, -1, "" },
      },
      tbUnLockEvent = {},
      ...
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "果然久经训练的精锐之兵，不是我等未曾配合的初练之军可以抵挡的。还是先行退去好好研习武艺兵法为上。",
        },
        { XoyoGame.DEL_NPC, "guaiwu" },
        { XoyoGame.TARGET_INFO, -1, "任务失败" },
      },
    ...
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "击败所有楚军棋武士" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {},
    ...
    [5] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "击败剩余楚军棋武士和楚军棋武将" },
      },
      tbUnLockEvent = {
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" }, -- 完成任务设置标志
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
  ...
  LOCK = {
    ...
    [1] = {
      ...
      tbStartEvent = {
        { XoyoGame.TIME_INFO, -1, "<color=green>离本关开启还有%s<color>", 1 },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "风闻此间恶名遍播的恶霸头子今日娶亲，娶的也是一手上沾了不知多少血腥的女魔头。如此奸邪之辈，我等岂能让其如意？这就前去大闹一场吧！",
        },
        { XoyoGame.TARGET_INFO, -1, "" },
      },
      tbUnLockEvent = {},
    ...
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "击败32个恶霸" },
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {},
    ...
    [4] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "击败刘一家和钟多盐" },
      },
      tbUnLockEvent = {
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" }, -- 完成任务设置标志
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
  ...
  LOCK = {
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "收到消息得知，近期几宗失窃案被窃的宝物都被贼人埋藏在此处，仔细搜索，莫要惊动了贼人。",
        },
        { XoyoGame.TIME_INFO, -1, "<color=green>离本关开启还有%s<color>", 1 },
        { XoyoGame.TARGET_INFO, -1, "" },
      },
    ...
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
        { XoyoGame.TARGET_INFO, -1, "挖出西侧被埋藏的宝物，击杀8名守宝贼" },
      },
      tbUnLockEvent = {
    ...
    [4] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
        { XoyoGame.TARGET_INFO, -1, "挖出南侧被埋藏的宝物，击杀8名守宝贼" },
      },
      tbUnLockEvent = {
    ...
    [5] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
        { XoyoGame.TARGET_INFO, -1, "挖出东侧被埋藏的宝物，击杀8名守宝贼" },
      },
      tbUnLockEvent = {
    ...
    [6] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
        { XoyoGame.TARGET_INFO, -1, "查看北侧无人看守的宝物箱" },
      },
      tbUnLockEvent = {},
    },
    [7] = {
      ...
      tbStartEvent = {
        { XoyoGame.ADD_NPC, 3, 1, 7, "guaiwu", "112_dingge" }, -- 丁格
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "眼前腾的一声出现了一个人影，拿起地上的宝物就准备逃走，看着身手多半就是江湖上出名的飞贼王了，有趣得紧，今日定要砸了他的招牌。",
        },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
        { XoyoGame.TARGET_INFO, -1, "击败丁格" },
      },
      tbUnLockEvent = {
        { XoyoGame.DEL_NPC, "guaiwu" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "成功夺回了全部被窃的财物，顺便教训了号称专业夺宝的飞贼王，先烤烤火，休息一下吧！",
        },
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" }, -- 完成任务设置标志
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
        { XoyoGame.CLOSE_INFO, -1 },
  ...
  LOCK = {
    ...
    [2] = {
      ...
      tbUnLockEvent = {
        ...
        { XoyoGame.DEL_NPC, "husong" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "趁我们不注意，一个大飞贼一把抄起小丽影，大笑着夺路而去，只能懊悔的看着他们的背影祈祷小丽影平安了。",
        },
        { XoyoGame.TARGET_INFO, -1, "任务失败" },
      },
    },
    ...
    [7] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TARGET_INFO, -1, "采集4个小蘑菇" },
      },
      tbUnLockEvent = {},
    },
    [8] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TARGET_INFO, -1, "保护小丽影，击杀8名大飞贼" },
      },
      tbUnLockEvent = {},
    },
    [9] = {
    ...
    [16] = {
      ...
      tbUnLockEvent = {
        { XoyoGame.DEL_NPC, "husong" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=10198>：“谢谢哥哥姐姐！我家就在谷外马上就到了，就不麻烦哥哥姐姐了。有空的话一定要再来找我玩啊~”",
        },
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" }, -- 完成任务设置标志
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
        { XoyoGame.CLOSE_INFO, -1 },
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "终南山下，绝谷幽幽，此等幽然静谧之处，让人不禁想要驻足……前方似有男女二人争执，不如上前一看究竟。",
        },
        { XoyoGame.TIME_INFO, -1, "<color=green>离本关开启还有%s<color>", 1 },
        { XoyoGame.TARGET_INFO, -1, "" },
      },
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=10201>：“走……走了？就这么走了？是谁让你走的？是谁赶你走的？是，是你们！你们几个小辈气走了他，给我纳命来！”",
        },
        { XoyoGame.ADD_NPC, 2, 1, 4, "guaiwu3", "114_linchaoying2" }, --林朝英
        { XoyoGame.TARGET_INFO, -1, "击败失常的林朝英" },
      },
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=10201>：“我这是怎么了……怎么会去为难几名江湖小辈……罢了，罢了……你们去吧……”",
        },
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" }, -- 完成任务设置标志
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
        { XoyoGame.CLOSE_INFO, -1 },
  ...
  LOCK = {
      ...
      tbStartEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "数十年前，有一块天外陨铁坠落在这里，一位绝世名匠将其打造为一柄绝世神剑藏于此处。此地也就更名为神剑岭，我们当仔细探访这把剑的下落。",
        },
        { XoyoGame.TIME_INFO, -1, "<color=green>离本关开启还有%s<color>", 1 },
        { XoyoGame.TARGET_INFO, -1, "" },
      },
    ...
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TARGET_INFO, -1, "调查四个方向的剑碑" },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {},
    },
    [4] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "击退阻碍的守护剑灵" },
      },
      tbUnLockEvent = {},
    },
    [5] = {
      ...
      tbStartEvent = {
        { XoyoGame.ADD_NPC, 3, 1, 5, "guaiwu", "115_jianshen" }, -- Boss
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=10204>：“既从来出来，仍当往来处去。诸位为当时英雄豪杰，以贪念夺其神，妄失性命，岂非不智之极？”",
        },
        { XoyoGame.TARGET_INFO, -1, "击败剑神" },
      },
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=10204>：“既然汝等有心求剑，吾亦不妨以实相告。当年神匠本欲将陨铁打造成神剑，但又担心被心术不正之辈以之为祸苍生。故他将陨铁融入凡铁，打造成了万件农具分发给了山侧之民。此等仁心，吾自当守之。”",
        },
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" }, -- 完成任务设置标志
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
        { XoyoGame.CLOSE_INFO, -1 },
  ...
  LOCK = {
    ...
    [1] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.CHANGE_NPC_AI, "guaiwu", XoyoGame.AI_ATTACK, "", 0 }, -- 改变阵营AI
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=10205>：“传说中有位武林前辈在此处峭壁之上修行过，并将其佩剑以及生平所学留在了此处。若是传闻非虚，能与我胸中所学印证一番，我的武功必定可以独步天下了，哈哈哈哈！”",
        },
        { XoyoGame.TIME_INFO, -1, "<color=green>离本关开启还有%s<color>", 1 },
        { XoyoGame.TARGET_INFO, -1, "" },
      },
    ...
    [2] = {
      ...
      tbUnLockEvent = {
        { XoyoGame.DEL_NPC, "guaiwu" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "望着将我们轻松击败，狂妄大笑离去的杨往的背影，日后其必将因为自身的大意而付出惨痛的代价，我们也只能祈祷他生命无虞了。",
        },
        { XoyoGame.TARGET_INFO, -1, "任务失败" },
      },
    },
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.TARGET_INFO, -1, "陪同杨往查探剑冢" },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
      },
      tbUnLockEvent = {},
    },
    [4] = {
      ...
      tbStartEvent = {
        { XoyoGame.DEL_NPC, "guaiwu" },
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=10205>：“唔，唔。这大侠也不过如此，这把剑倒是不错，我与之有缘，就收下了。既然有所得，几位就来陪我印证一下吧，看我的武艺精进了多少。”",
        },
        { XoyoGame.ADD_NPC, 1, 1, 4, "guaiwu2", "116_yangwang1" }, --杨往
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TARGET_INFO, -1, "击败杨往" },
      },
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "<npc=10205>：“看来我真的是井底之蛙，大侠所言十年练剑，十年悟剑，当真金玉良言。在下先行拜别，日后若再相见，定好好报答各位点拨之恩！”",
        },
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" }, -- 完成任务设置标志
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
        { XoyoGame.CLOSE_INFO, -1 },
  ...
  LOCK = {
    ...
    [3] = {
      ...
      tbStartEvent = {
        ...
        { XoyoGame.CHANGE_FIGHT, -1, 1, Player.emKPK_STATE_PRACTISE },
        { XoyoGame.TIME_INFO, -1, "<color=green>本关剩余时间%s<color>", 2 },
        { XoyoGame.TARGET_INFO, -1, "击败12名黑衣人" },
      },
      tbUnLockEvent = {},
    },
    [4] = {
      ...
      tbStartEvent = {
        { XoyoGame.ADD_NPC, 2, 1, 4, "guaiwu", "117_shenmiren" }, --神秘人
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "这些贼人也不知道什么来头，一个个溜得飞快……你，你是，恩师？！不，非我族类其心必异，你这奸细，杀人凶手。今日就纳命来吧！",
        },
        { XoyoGame.TARGET_INFO, -1, "击败神秘人" },
      },
      tbUnLockEvent = {
        {
          XoyoGame.MOVIE_DIALOG,
          -1,
          "神秘人一言不发的离去了。仔细想来，似乎是那些黑衣人故意将我等引来此地，这里面会不会有什么阴谋？",
        },
        { XoyoGame.DO_SCRIPT, "self.tbTeam[1].bIsWiner = 1" }, -- 完成任务设置标志
        { XoyoGame.DO_SCRIPT, "self.tbLock[2]:Close()" },
        { XoyoGame.CLOSE_INFO, -1 },

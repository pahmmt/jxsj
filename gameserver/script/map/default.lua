...
--定义开关类进入事件
function tbMapBase:OnEnterConsole() end

-- 定义玩家进入事件Onlogin前调用
function tbMapBase:OnEnter() end

-- 定义玩家进入事件Onlogin后调用
function tbMapBase:OnEnter2() end
...
function tbMapBase:OnDyLoad(nDynMapId) end

--定义开关类离开事件
function tbMapBase:OnLeaveConsole() end

-- 定义玩家离开事件
function tbMapBase:OnLeave() end

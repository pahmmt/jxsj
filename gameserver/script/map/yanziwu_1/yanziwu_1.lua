...
-- 定义玩家离开事件
function tbTest:OnLeave(szParam) end

-------------- 定义特定Trap点回调 ---------------
local tbTestTrap = tbTest:GetTrapClass("to_baishan1")

-- 定义玩家Trap事件
function tbTestTrap:OnPlayer() end

-------------- 定义特定Trap点回调 ---------------
local tbTestTrap2 = tbTest:GetTrapClass("to_baishan2")

-- 定义玩家Trap事件
function tbTestTrap2:OnPlayer() end
...
-- 定义玩家Trap事件
function tbTestTrap5:OnPlayer() end
...
-- 定义玩家Trap事件
function tbTestTrap12:OnPlayer() end

...
-- 队长的领袖荣誉
BaiHuTang.HONOR = {
  { [3] = 6, [4] = 9, [5] = 12, [6] = 15 }, -- 第一关
  { [3] = 6, [4] = 9, [5] = 12, [6] = 15 }, -- 第二关
  { [3] = 12, [4] = 18, [5] = 24, [6] = 30 }, -- 第三关
}

if EventManager.IVER_bOpenTiFu == 1 then
  BaiHuTang.STATE_TRANS = { --时间有延迟
...
BaiHuTang.szApplyMsg = "勇闯白虎堂活动已经开始接受报名，50级以上的大侠们可以通过各大城市的传送人到“白虎堂大殿”报名参加。"
...
function BaiHuTang:OnPlayerTrap(nMapId)
  ...
  if me.CountFreeBagCell() >= 1 then
    ...
    me.Msg("背包空间不足，无法获得<color=yellow>黄金福袋<color>")
  end
...
function BaiHuTang:SetTrapList()
  self.tbMapKey[226] = 230
  self.tbMapKey[228] = 230
  self.tbMapKey[234] = 238
  self.tbMapKey[236] = 238
  self.tbMapKey[227] = 231
  self.tbMapKey[229] = 231
  self.tbMapKey[235] = 239
  self.tbMapKey[237] = 239
  self.tbMapKey[230] = 232
  self.tbMapKey[231] = 232
  self.tbMapKey[238] = 240
  self.tbMapKey[239] = 240
  self.tbMapKey[232] = 225
  self.tbMapKey[240] = 233
  -- 初级第二场
  self.tbMapKey[275] = 279
  self.tbMapKey[277] = 279
  self.tbMapKey[276] = 280
  self.tbMapKey[278] = 280
  self.tbMapKey[279] = 281
  self.tbMapKey[280] = 281
  self.tbMapKey[281] = 274

  -- 初级第三场
  self.tbMapKey[334] = 338
  self.tbMapKey[336] = 338
  self.tbMapKey[335] = 339
  self.tbMapKey[337] = 339
  self.tbMapKey[338] = 340
  self.tbMapKey[339] = 340
  self.tbMapKey[340] = 333

  --黄金白虎堂
  self.tbMapKey[822] = 826
  self.tbMapKey[823] = 826
  self.tbMapKey[824] = 827
  self.tbMapKey[825] = 827
  self.tbMapKey[826] = 828
  self.tbMapKey[827] = 828
...
function BaiHuTang:init()
  ...
  BaiHuTang.tbBatte[self.ChuJi] = {
    MapId = {
      { 226, 227, 228, 229, 275, 276, 277, 278, 334, 335, 336, 337 }, --第一层地图
      { 230, 231, 279, 280, 338, 339 }, --第二层地图
      { 232, 281, 340 }, --第三层地图
    },
  ...
  BaiHuTang.tbBatte[self.Goldlen] = {
    MapId = {
      { 822, 823, 824, 825 },
      { 826, 827 },
      { 828 },
  ...
  self.tbSysMsg[1] = "勇闯白虎堂活动正式开始，白虎堂内出现闯堂贼！"
  self.tbSysMsg[2] = "勇闯白虎堂活动报名已经截止，活动正式开始！"
  self.tbSysMsg[3] = "白虎堂一层闯堂贼头领出现！"
  self.tbSysMsg[4] = "白虎堂二层窃图贼头领出现！"
  self.tbSysMsg[5] = "白虎堂三层护图使出现！"
  self.tbSysMsg[6] = "恭喜你成功闯过了白虎堂！"
  self.tbSysMsg[7] = "时间到，你被救出了白虎堂。"

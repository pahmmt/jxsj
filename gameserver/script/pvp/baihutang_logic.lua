...
function tbBase:OnDeath(pKillerNpc)
  ...
  if pKillerPlayer then
    ...
    pKillerPlayer.Msg("<color=green>你击退了闯堂者 " .. me.szName .. "。<color>")
    local tbPlayer, nCount = KPlayer.GetMapPlayer(me.nMapId)

    if nCount > 2 then
      local szMsg = pKillerPlayer.szName .. " 击退了闯堂者 " .. me.szName .. "。"

...
function tbNpc:OnDialog()
  local szMsg = "    那是一条神奇的天路啊，带我们走进人间天堂。。。你想去哪里？"
  local tbOpt = {}
  ...
  tbOpt[#tbOpt + 1] = { "<color=yellow>洗点功能<color>", self.ResetPoint, self }
  tbOpt[#tbOpt + 1] = { "我知道了" }
...
function tbNpc:TransPole(nIndex)
  ...
  GeneralProcess:StartProcess("传送中", 5 * Env.GAME_FPS, { self.DoTransPole, self, nIndex }, nil, tbBreakEvent)
end

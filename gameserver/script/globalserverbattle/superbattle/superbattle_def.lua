...
SuperBattle.MAX_QUEUE = 160 -- 最大战场人数
SuperBattle.MIN_QUEUE = 120 -- 最小战场人数
...
SuperBattle.POLE_POS = {
  [1] = { tbPos = { 1603, 3887 }, tbTransPos = { 1607, 3887 }, tbCamp = { [0] = 4695, [1] = 4697, [2] = 4699 }, nOrgCamp = 1, szName = "营地（玄武）" },
  [2] = { tbPos = { 1901, 3870 }, tbTransPos = { 1906, 3869 }, tbCamp = { [0] = 4694, [1] = 4696, [2] = 4698 }, nOrgCamp = 0, szName = "营地（朱雀）" },
  [3] = { tbPos = { 1771, 3796 }, tbTransPos = { 1776, 3796 }, tbCamp = { [0] = 4694, [1] = 4696, [2] = 4698 }, nOrgCamp = 0, szName = "营地（白虎）" },
  [4] = { tbPos = { 1656, 3653 }, tbTransPos = { 1662, 3652 }, tbCamp = { [0] = 4695, [1] = 4697, [2] = 4699 }, nOrgCamp = 0, szName = "营地（青龙）" },
  [5] = { tbPos = { 2121, 3477 }, tbTransPos = { 2125, 3477 }, tbCamp = { [0] = 4694, [1] = 4696, [2] = 4698 }, nOrgCamp = 2, szName = "营地（北斗）" },
  [6] = { tbPos = { 1982, 3748 }, tbTransPos = { 1987, 3748 }, tbCamp = { [0] = 4695, [1] = 4697, [2] = 4699 }, nOrgCamp = 0, szName = "营地（吉祥）" },
  [7] = { tbPos = { 1911, 3594 }, tbTransPos = { 1915, 3595 }, tbCamp = { [0] = 4695, [1] = 4697, [2] = 4699 }, nOrgCamp = 0, szName = "营地（金鳞）" },
  [8] = { tbPos = { 1776, 3500 }, tbTransPos = { 1780, 3499 }, tbCamp = { [0] = 4694, [1] = 4696, [2] = 4698 }, nOrgCamp = 0, szName = "营地（如意）" },
}
...
SuperBattle.NPC_CHAT_MSG = {
  ...
  --	},
  [1] = {
    "我脚下的每一寸土地都流淌着将士们的鲜血，我们不能失去它。",
    "聚拢到我的身边来，孩子，我会给你们力量的！",
    "我要亲自去会会对面那个头头，我要让他知道我的厉害。",
    "疾如风，徐如林，侵略如火，不动如山，我手下的将士是最英勇的。",
    "抓住机会一击致命，不要给他们任何喘息之机。",
    "给我狠狠的打，积分最多的，我重重有赏！！",
  },
  [2] = {
    "我脚下的每一寸土地都流淌着将士们的鲜血，我们不能失去它。",

...
tbqianghuajuanzhou.szInfo = "防具强化卷轴帮您加强防具，您可以自己使用或是交易给队友。强大的伙伴是您胜利的关键！<color=yellow>最大可强化+14<color>"

function tbqianghuajuanzhou:OnUse()
  local tbOpt = {
    { "使用", self.OnUseEx, self, it.dwId },
    { "交易给队友", DaTaoSha.tbqianghuajuanzhou.Trade, DaTaoSha.tbqianghuajuanzhou, it.dwId, 2 },
    { "关闭" },
  }
...
function tbqianghuajuanzhou:OnUseEx(nId)
  local tbFangJu = { "强化头盔", "强化衣服", "强化腰带", "强化鞋子", "强化护腕" }
  local tbOpt = {}

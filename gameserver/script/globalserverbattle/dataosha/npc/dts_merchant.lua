...
function tbNpc:OnBuy(nType, nRate, nCount)
  ...
  if tbItemInformation then
    local szMsg = string.format("队友<color=yellow>%s<color>在商人处花费 <color=yellow>%s<color> 银币购买了%s个<color=yellow>%s<color>。", me.szName, nRate * nCount, nCount, tbItemInformation.szName)
...
function tbNpc:BuyLifeEx(nCount)
  ...
  local szMsg = string.format("队友<color=yellow>%s<color>在商人处花费 <color=yellow>%s<color> 银币购买了%s条命。", me.szName, self.BuyLifeRate * nCount, nCount)
  KTeam.Msg2Team(me.nTeamId, szMsg)

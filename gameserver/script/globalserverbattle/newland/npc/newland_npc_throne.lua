...
function tbNpc:OnDialog()
  ...
  GeneralProcess:StartProcess("占领中", 20 * Env.GAME_FPS, { self.OnOccupyThrone, self, him.dwId }, nil, tbBreakEvent)
end
...
function tbNpc:OnOccupyThrone(pNpcDwId)
  ...
  local szMsg = string.format("<color=yellow>[%s]<color>帮会的<color=green>[%s]<color>坐上了%s。", szGroupName, me.szName, pNpc.szName)

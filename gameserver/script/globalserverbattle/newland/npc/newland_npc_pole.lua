...
function tbNpc:OnDeath(pNpcKiller)
  ...
  local szMsg = string.format("【%s战报】<color=yellow>[%s]<color>帮会的<color=green>[%s]<color>占领了<color=yellow>[%s]<color>", Newland.MAP_LEVEL_NAME[nMapLevel] or "未知", szGroupName, me.szName, him.szName)

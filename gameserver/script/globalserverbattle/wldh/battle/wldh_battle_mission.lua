...
function tbMissionBase:OnDeath(pKillerNpc)
  ...
  if pKillerPlayer then
    ...
    -- 文字要改
    local szMsg = string.format("%s方%s <color=yellow>%s<color> 击退了 %s方%s <color=yellow>%s<color>", Wldh.Battle.NAME_CAMP[nKillerGroupId], Wldh.Battle.NAME_RANK[tbKillerBattleInfo.nRank], tbKillerBattleInfo.pPlayer.szName, Wldh.Battle.NAME_CAMP[nGroupId], Wldh.Battle.NAME_RANK[tbDeathBattleInfo.nRank], tbDeathBattleInfo.pPlayer.szName)

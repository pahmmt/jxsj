...
function KItem.AddPlayerGeneralEquip(pPlayer, nDetail, nParticular, nLevel, nSeries, nEnhTimes, nLucky, nVersion, uRandSeed, nWay)
  return KItem.AddPlayerItem(pPlayer, Item.EQUIP_GENERAL, nDetail, nParticular, nLevel, nSeries or Env.SERIES_NONE, nEnhTimes or 0, nLucky or 0, nil, nil, nVersion or 0, uRandSeed or 0, 0, 0, 1, nWay or 100)
end

-- 给指定角色增加一个黄金装备
function KItem.AddPlayerGoldEquip(pPlayer, nDetail, nParticular, nLevel, nSeries, nEnhTimes, nVersion, nWay)
  return KItem.AddPlayerItem(pPlayer, Item.EQUIP_GOLD, nDetail, nParticular, nLevel, nSeries or Env.SERIES_NONE, nEnhTimes or 0, 0, nil, nil, nVersion or 0, 0, 0, 0, 1, nWay or 100)
end

-- 给指定角色增加一个绿色装备
function KItem.AddPlayerGreenEquip(pPlayer, nDetail, nParticular, nLevel, nSeries, nEnhTimes, nVersion, nWay)
  return KItem.AddPlayerItem(pPlayer, Item.EQUIP_GREEN, nDetail, nParticular, nLevel, nSeries or Env.SERIES_NONE, nEnhTimes or 0, 0, nil, nil, nVersion or 0, 0, 0, 0, 1, nWay or 100)
end

-- 给指定角色增加一个药品
function KItem.AddPlayerMedicine(pPlayer, nDetail, nParticular, nLevel, nSeries, nVersion, nWay)
  return KItem.AddPlayerItem(pPlayer, Item.MEDICINE, nDetail, nParticular, nLevel, nSeries or Env.SERIES_NONE, 0, 0, nil, nil, nVersion or 0, 0, 0, 0, 1, nWay or 100)
end

-- 给指定角色增加一个脚本道具
function KItem.AddPlayerScriptItem(pPlayer, nDetail, nParticular, nLevel, nSeries, tbGenInfo, nVersion, nWay)
  return KItem.AddPlayerItem(pPlayer, Item.SCRIPTITEM, nDetail, nParticular, nLevel, nSeries or Env.SERIES_NONE, 0, 0, tbGenInfo, nil, nVersion or 0, 0, 0, 0, 1, nWay or 100)
end

-- 给指定角色增加一个技能道具
function KItem.AddPlayerSkillItem(pPlayer, nDetail, nParticular, nLevel, nSeries, nVersion, nWay)
  return KItem.AddPlayerItem(pPlayer, Item.SKILLITEM, nDetail, nParticular, nLevel, nSeries or Env.SERIES_NONE, 0, 0, nil, nil, nVersion or 0, 0, 0, 0, 1, nWay or 100)
end

-- 给指定角色增加一个任务道具
function KItem.AddPlayerQuest(pPlayer, nDetail, nParticular, nLevel, nSeries, tbGenInfo, nVersion, nWay)
  return KItem.AddPlayerItem(pPlayer, Item.TASKQUEST, nDetail, nParticular, nLevel, nSeries or Env.SERIES_NONE, 0, 0, tbGenInfo, nil, nVersion or 0, 0, 0, 0, 1, nWay or 100)
end

-- 给指定角色增加一个扩展背包
function KItem.AddPlayerExtBag(pPlayer, nDetail, nParticular, nVersion, nWay)
  return KItem.AddPlayerItem(pPlayer, Item.EXTBAG, nDetail, nParticular, 1, 0, Env.SERIES_NONE, 0, nil, nil, nVersion or 0, 0, 0, 0, 1, nWay or 100)
end

-- 给指定角色增加一个生活技能材料
function KItem.AddPlayerStuffItem(pPlayer, nDetail, nParticular, nLevel, nSeries, nVersion, nWay)
  return KItem.AddPlayerItem(pPlayer, Item.STUFFITEM, nDetail, nParticular, nLevel, 0, nSeries or Env.SERIES_NONE, 0, nil, nil, nVersion or 0, 0, 0, 0, 1, nWay or 100)
end

-- 给指定角色增加一个生活技能配方
function KItem.AddPlayerPlanItem(pPlayer, nDetail, nParticular, nLevel, nSeries, nVersion, nWay)
  return KItem.AddPlayerItem(pPlayer, Item.PLANITEM, nDetail, nParticular, nLevel, 0, nSeries or Env.SERIES_NONE, 0, nil, nil, nVersion or 0, 0, 0, 0, 1, nWay or 100)
end

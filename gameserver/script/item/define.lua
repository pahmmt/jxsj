...
Item.EQUIPPOS_NAME = {
  ...
  [Item.EQUIPPOS_HORSE] = "马牌",
  [Item.EQUIPPOS_MASK] = "面具",
  [Item.EQUIPPOS_BOOK] = "秘籍",
  [Item.EQUIPPOS_ZHEN] = "阵法",
  [Item.EQUIPPOS_SIGNET] = "印鉴",
  [Item.EQUIPPOS_MANTLE] = "披风",
  [Item.EQUIPPOS_CHOP] = "官印",
  [Item.EQUIPPOS_ZHENYUAN_MAIN] = "真元",
  [Item.EQUIPPOS_ZHENYUAN_SUB1] = "真元",
  [Item.EQUIPPOS_ZHENYUAN_SUB2] = "真元",
  [Item.EQUIPPOS_GARMENT] = "外衣",
  [Item.EQUIPPOS_OUTHAT] = "外帽",
  [Item.EQUIPPOS_NUM + Item.PARTNEREQUIP_WEAPON] = "同伴之刃",
  [Item.EQUIPPOS_NUM + Item.PARTNEREQUIP_BODY] = "同伴之衣",
  [Item.EQUIPPOS_NUM + Item.PARTNEREQUIP_RING] = "同伴之戒",
  [Item.EQUIPPOS_NUM + Item.PARTNEREQUIP_CUFF] = "同伴护腕",
  [Item.EQUIPPOS_NUM + Item.PARTNEREQUIP_AMULET] = "同伴护符",
}

Item.WEAPON_NAME = {
  [Item.emKEQUIP_WEAPON_CATEGORY_HAND] = "缠手",
  [Item.emKEQUIP_WEAPON_CATEGORY_SWORD] = "剑",
  [Item.emKEQUIP_WEAPON_CATEGORY_KNIFE] = "刀",
  [Item.emKEQUIP_WEAPON_CATEGORY_STICK] = "棍",
  [Item.emKEQUIP_WEAPON_CATEGORY_SPEAR] = "枪",
  [Item.emKEQUIP_WEAPON_CATEGORY_HAMMER] = "锤",
  [Item.emKEQUIP_WEAPON_CATEGORY_DART] = "镖",
  [Item.emKEQUIP_WEAPON_CATEGORY_FLYBAR] = "飞刀",
  [Item.emKEQUIP_WEAPON_CATEGORY_ARROW] = "箭矢",
}
...
Item.TIP_SERISE = {
  "<color=yellow>金系<color>",
  "<color=green>木系<color>",
  "<color=blue>水系<color>",
  "<color=red>火系<color>",
  "<color=gray>土系<color>",
}

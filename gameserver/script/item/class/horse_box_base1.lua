...
tbItem.tbHorse = {
  ...
  [1] = { 40, { { 1, 12, 27, 4 }, "[坐骑]吉祥虎" }, { { 1, 12, 54, 4 }, "[坐骑]月华·澜" }, { { 1, 12, 49, 4 }, "[坐骑]雪魂" } },
  [2] = { 40, { { 1, 12, 63, 4 }, "[坐骑]绝世雪羽" }, { { 1, 12, 70, 4 }, "[坐骑]兕夔" } },
}
...
function tbItem:OnUse()
  ...
  if 1 == nCount then
    tbOpt[#tbOpt + 1] = { self.tbHorse[nCount][4][2], self.AddMask, self, 4, it.dwId, nType, nTime, nCount }
  end

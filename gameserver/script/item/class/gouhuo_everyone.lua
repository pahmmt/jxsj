...
function tbGouhuoItem:DelayTime(pPlayer, nObjId)
  GeneralProcess:StartProcess("篝火点燃中...", self.nDelayTime * Env.GAME_FPS, { self.DoPickUp, self, pPlayer.nId, nObjId }, nil, tbEvent)
end
...
function tbGouhuoItem:CallGouhuoNpc(nX, nY, nExistentTime, nBaseMultip)
  ...
  tbNpc:InitGouHuo(pNpc.dwId, 0, nExistentTime, 5, 100, nBaseMultip, 0)

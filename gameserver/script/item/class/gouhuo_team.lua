...
function tbGouhuoItem:DelayTime(pPlayer, nObjId)
  GeneralProcess:StartProcess("篝火点燃中...", self.nDelayTime * Env.GAME_FPS, { self.DoPickUp, self, pPlayer.nId, nObjId }, { self.PickUpInterrupted, self }, tbEvent)
end
...
function tbGouhuoItem:CallGouhuoNpc(nX, nY, nExistentTime, nBaseMultip)
  ...
  me.SendMsgToFriend("您的好友[" .. me.szName .. "]点燃了篝火。")

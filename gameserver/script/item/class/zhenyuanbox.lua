...
function tbItem:OnSureUse(dwId, nStep)
  ...
  elseif nStep == 1 then
    ...
    if pItem.Delete(me) == 1 then
      ...
      local szLog = string.format("%s使用%s获得真元%s[%d,%d,%d,%d,%d]", me.szName, szItemName, pZhenYuan.szName, Item.tbZhenYuan:GetAttribPotential1(pZhenYuan), Item.tbZhenYuan:GetAttribPotential2(pZhenYuan), Item.tbZhenYuan:GetAttribPotential3(pZhenYuan), Item.tbZhenYuan:GetAttribPotential4(pZhenYuan), Item.tbZhenYuan:GetEquiped(pZhenYuan))

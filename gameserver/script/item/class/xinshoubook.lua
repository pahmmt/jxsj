...
function tbXinShouBook:JiBenCaoZuo()
  ...
  Dialog:Say(
    "    <color=yellow>角色移动<color>：鼠标左键点击地面。按<color=gold>R键<color>可以切换走路和跑步。\n"
...
function tbXinShouBook:JiaRuMenPai()
  ...
  Dialog:Say("   在角色等级达到<color=gold>10级<color>时，即可由新手村的<color=gold>各门派接引弟子<color>传送到<color=gold>掌门<color>处申请加入该门派。\n" .. "   每个门派根据战斗特色均划分两条路线，在加入门派后需要手动投点确认路线。在投点后，修炼路线暂时不能更改，需要等到角色到达60级时，方可从掌门处传送到洗髓岛洗点更换。\n" .. "   各门派的介绍，请查阅F12帮助锦囊里的详细帮助内容，或者访问官方网站的相关资料页面。", tbOpt)
...
function tbXinShouBook:JiHuoShunXu()
  ...
  Dialog:Say("    <color=gold>按F1打开角色属性面板，点击“五行换装模式”，<color>可以查看各类装备激活的顺序。\n\n" .. "帽子和武器，可以激活鞋子和护身符。\n" .. "鞋子和护身符，可以激活护腕和腰坠。\n" .. "护腕和腰坠，可以激活腰带和戒指。\n" .. "腰带和戒指，可以激活衣服和项链。\n" .. "衣服和项链，可以激活帽子和武器。\n\n" .. "    <color=gold>装备Tips上有门派推荐提示，<color>按提示装备推荐自身门派的装备就可以完成五行相生激活。", tbOpt)
...
function tbXinShouBook:JiaoTongZhiNan()
  ...
  Dialog:Say("    <color=gold>每个新手村都与特定的门派和城市相连。<color>按Tab打开地图界面，可以通过<color=gold>区域地图<color>和<color=gold>世界地图<color>查看各新手村周边的交通路线。\n" .. "    <color=gold>各新手村和城市的车夫可以相互传送。<color>\n" .. "    每个新手村都有12大门派的接引弟子，负责传送玩家到该门派，同时<color=gold>各门派里的门派传送人会负责传送玩家回各新手村。<color>", tbOpt)
...
function tbXinShouBook:LianJiDiTu()
  ...
  Dialog:Say("    <color=gold>1~20级<color>建议做主线剧情任务升级（找各新手村的白秋琳接取），也可以在新手村周边的5级和15级地图打怪练级。\n" .. "    <color=gold>21~50级<color>可以在门派周边的25级、35级、45级地图练级。\n" .. "    <color=gold>50~90级<color>可以在城市周边的地图练级。\n" .. "    <color=gold>90级后<color>可以在新手村周边的高级地图练级。", tbOpt)
...
function tbXinShouBook:TianCiHongFu()
  ...
  Dialog:Say("    在野外打练级怪有一定几率会获得<color=gold>黄金福袋<color>。\n" .. string.format("    打开福袋可以获得一定的奖励，包括经验、绑定银两或绑定%s。<color=gold>绑定%s可以在奇珍阁商城消费。<color>\n", IVER_g_szCoinName, IVER_g_szCoinName) .. "    每个帐号每天开启的头10个福袋才能获得这些奖励，超过10个的黄金福袋仍然可以使用，但是只能得到100绑定银两的奖励。", tbOpt)

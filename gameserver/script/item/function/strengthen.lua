...
Item.STRENGTHEN_RECIPE_CALSS = { -- 武器
  [Item.STRENGTHEN_RECIPE_WEAPON] = { Item.EQUIP_MELEE_WEAPON, Item.EQUIP_RANGE_WEAPON },
  -- 防具
  [Item.STRENGTHEN_RECIPE_ARMOR] = {
    Item.EQUIP_ARMOR,
    Item.EQUIP_BOOTS,
    Item.EQUIP_BELT,
    Item.EQUIP_HELM,
  ...
  -- 饰品
  [Item.STRENGTHEN_RECIPE_JEWELRY] = {
    Item.EQUIP_RING,
    Item.EQUIP_NECKLACE,
    Item.EQUIP_AMULET,
    Item.EQUIP_PENDANT,
...
function Item:Strengthen(pEquip, tbStrItem, nMoneyType, nParam)
  ...
  local nRet = pEquip.Regenerate(pEquip.nGenre, pEquip.nDetail, pEquip.nParticular, pEquip.nLevel, pEquip.nSeries, pEquip.nEnhTimes, pEquip.nLucky, pEquip.GetGenInfo(), 0, pEquip.dwRandSeed, 1)
  ...
  me.SendMsgToFriend(string.format("您的好友[%s]将+%d的%s改造成功。", me.szName, pEquip.nEnhTimes, szTypeName))

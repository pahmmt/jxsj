...
function Item:RecordPlayerAddItem(pItem, nCount, eWay)
  if Item.tbStone.tbStoneLogItem[pItem.SzGDPL()] then
    -- 宝石相关的产出log
    StatLog:WriteStatLog("stat_info", "baoshixiangqian", "advanced", me.nId, string.format("%d_%d_%d_%d", pItem.nGenre, pItem.nDetail, pItem.nParticular, pItem.nLevel), nCount)
  end
  --时光殿产出log

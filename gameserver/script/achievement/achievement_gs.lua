...
function Achievement:__SendMsg_Sys(szAchivementMsg)
  ...
  local szMsg = string.format("恭喜您完成了一个新成就：%s", szAchivementMsg)
  me.Msg(szMsg)
end
...
function Achievement:__SendMsg_Team(szAchivementMsg)
  ...
  local szMsg = string.format("恭喜队伍成员%s完成了一个新成就：%s", me.szName, szAchivementMsg)
...
function Achievement:__SendMsg_Friend(szAchivementMsg)
  ...
  local szMsg = string.format("恭喜您的好友%s完成了一个新成就：%s", me.szName, szAchivementMsg)
...
function Achievement:__SendMsg_KinTong(szAchivementMsg)
  ...
  local szMsg = string.format("恭喜%s完成了一个新成就：%s", me.szName, szAchivementMsg)
...
PlayerEvent:RegisterGlobal("OnLoginOnly", Achievement._OnLogin, Achievement)

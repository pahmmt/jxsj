...
function Achievement:__TeamShareAchievement(pPlayer, nAchievementId, nWishCount)
  if not pPlayer or not nAchievementId or not nWishCount or nAchievementId <= 0 or nWishCount <= 0 then
    return
  end
...
function Achievement:_GetAchievementList_KillNpc(nNpcTemplateId)
  ...
  for _, tbInfo in pairs(tbCondInfo) do
    if tbInfo.nNpcTemplateId1 == nNpcTemplateId or tbInfo.nNpcTemplateId2 == nNpcTemplateId or tbInfo.nNpcTemplateId3 == nNpcTemplateId or tbInfo.nNpcTemplateId4 == nNpcTemplateId or tbInfo.nNpcTemplateId5 == nNpcTemplateId or tbInfo.nNpcTemplateId6 == nNpcTemplateId or tbInfo.nNpcTemplateId7 == nNpcTemplateId or tbInfo.nNpcTemplateId8 == nNpcTemplateId then
...
function Achievement:_GetAchievementList_EnterMap(nMapTemplateId)
  ...
  for _, tbInfo in pairs(tbCondInfo) do
    if tbInfo.nTemplateMapId1 == nMapTemplateId or tbInfo.nTemplateMapId2 == nMapTemplateId or tbInfo.nTemplateMapId3 == nMapTemplateId or tbInfo.nTemplateMapId4 == nMapTemplateId or tbInfo.nTemplateMapId5 == nMapTemplateId or tbInfo.nTemplateMapId6 == nMapTemplateId or tbInfo.nTemplateMapId7 == nMapTemplateId or tbInfo.nTemplateMapId8 == nMapTemplateId or tbInfo.nTemplateMapId9 == nMapTemplateId or tbInfo.nTemplateMapId10 == nMapTemplateId or tbInfo.nTemplateMapId11 == nMapTemplateId or tbInfo.nTemplateMapId12 == nMapTemplateId or tbInfo.nTemplateMapId13 == nMapTemplateId or tbInfo.nTemplateMapId14 == nMapTemplateId or tbInfo.nTemplateMapId15 == nMapTemplateId or tbInfo.nTemplateMapId16 == nMapTemplateId or tbInfo.nTemplateMapId17 == nMapTemplateId or tbInfo.nTemplateMapId18 == nMapTemplateId or tbInfo.nTemplateMapId19 == nMapTemplateId or tbInfo.nTemplateMapId20 == nMapTemplateId then
      table.insert(tbRet, tbInfo)
    end
  end
...
function Achievement:OnAddRepute(pPlayer, nCampId, nClassId, nPoint)
  ...
  if not pPlayer or not nCampId or not nClassId or not nPoint or nCampId <= 0 or nClassId <= 0 or nPoint <= 0 then
    return
  end
...
function Achievement:OnAddTitle(pPlayer, nGenre, nDetailtype, nlevel)
  ...
  if not pPlayer or not nGenre or not nDetailtype or not nlevel or nGenre <= 0 or nDetailtype <= 0 or nlevel <= 0 then
    return
  end
...
function Achievement:_GetAchievementList_Title(nGenre, nDetailtype, nlevel)
  ...
  for _, tbInfo in pairs(tbCondInfo) do
    if tbInfo.nGenre == nGenre and tbInfo.nDetailtype == nDetailtype and tbInfo.nlevel == nlevel then
      table.insert(tbRet, tbInfo)
    end
  end

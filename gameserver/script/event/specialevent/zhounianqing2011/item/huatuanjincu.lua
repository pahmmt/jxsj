...
function tbMaterial:ConfirmMakeFlower()
  ...
  GeneralProcess:StartProcess("制作庆典鲜花中", 5 * Env.GAME_FPS, { ZhouNianQing2011.MakeFlower, ZhouNianQing2011, me.nId }, nil, tbEvent)
end
...
function tbFlower:OnUse()
  ...
  GeneralProcess:StartProcess("摆放庆典鲜花中", 5 * Env.GAME_FPS, { ZhouNianQing2011.ShowFlower, ZhouNianQing2011, me.nId, it.dwId }, nil, tbEvent) -- 没有使用鲜花id
  return 0
end

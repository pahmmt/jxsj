...
function tbNpc:CheckCanEat()
  ...
  local nFlag = Player:CheckTask(ZhouNianQing2011.TASKGID, ZhouNianQing2011.TASK_JIAYAO_DATE, "%Y%m%d", ZhouNianQing2011.TASK_JIAYAO_COUNT, ZhouNianQing2011.nCanEatTimesPerDay)
  if nFlag == 0 then
...
function tbNpc:OnProgressFull(dwPlayerId, dwNpcId)
  ...
  -- 记录玩家吃菜
  pPlayer.SetTask(ZhouNianQing2011.TASKGID, ZhouNianQing2011.TASK_JIAYAO_COUNT, pPlayer.GetTask(ZhouNianQing2011.TASKGID, ZhouNianQing2011.TASK_JIAYAO_COUNT) + 1)

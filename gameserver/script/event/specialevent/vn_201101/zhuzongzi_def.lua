...
tbZongZi.BOIL_STEP_MSG = -- 各阶段提示
  {
    [1] = {
      szStep = "您的锅子已经开始煮粽子了",
      szAlert = "你的锅还有<color=yellow>%s秒<color>就要熄火了，赶快添木柴啊！！",
      szMsgActived = "再等<color=yellow>%s秒<color>才能加木柴",
    },
    [2] = {
      szStep = "火不够旺了，赶快加点木柴吧",
      szAlert = "你的锅还有<color=yellow>%s秒<color>就要熄火了，赶快添木柴啊！！",
      szFlameOut = "真遗憾，你煮粽子的火已经熄灭了，下次要仔细点呀！！",
      szMsgActived = "再等<color=yellow>%s秒<color>才能收获",
      szMsgNoActive = "快快加木柴，不然再<color=yellow>%s秒<color>后会熄火",
    },
    [3] = {
      szStep = "粽子已经煮熟了，可以收获了",
      szAlert = "你的锅子再过<color=yellow>%s秒<color>就要消失了，赶快收获啊！！",
      szFlameOut = "真遗憾，你煮粽子的锅因为时间到消失了，下次要及时收获呀！！",
      szMsgNoActive = "快快收获，不然锅子会在<color=yellow>%s秒<color>后消失",
    },
  }

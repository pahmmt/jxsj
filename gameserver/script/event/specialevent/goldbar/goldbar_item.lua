...
function tbItem:OnUse()
  ...
  --五级套  （一天）
  me.AddSkillState(880, 1, 2, 24 * 3600 * Env.GAME_FPS, 1, 0, 1)
  me.AddSkillState(385, 5, 2, 24 * 3600 * Env.GAME_FPS, 1, 0, 1)
  me.AddSkillState(386, 5, 2, 24 * 3600 * Env.GAME_FPS, 1, 0, 1)
  me.AddSkillState(387, 5, 2, 24 * 3600 * Env.GAME_FPS, 1, 0, 1)
  ...
  --双倍经验buff（一天）
  me.AddSkillState(890, 1, 2, 24 * 3600 * Env.GAME_FPS, 1, 0, 1)

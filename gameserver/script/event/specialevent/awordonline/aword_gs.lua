...
function tbAword:Open(bExchangeServerComing)
  ...
  me.CallClientScript({
    ...
    self.nCloseTime,
    tbOpenFlag,
    EventManager.IVER_bOpenZaiXian,
  })
...
if tbAword.bOpen == 1 then
  PlayerEvent:RegisterGlobal("OnLoginOnly", SpecialEvent.tbAword.Open, SpecialEvent.tbAword)
end

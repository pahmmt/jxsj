...
NewPlayerGift.tbData = {
  ...
  [2] = { 10, { { 18, 1, 85, 1 }, 1 } },
  [3] = { 20, { { 18, 1, 71, 2 }, 2 }, { { 18, 1, 392, 1 }, 2, 10 } },
  [4] = { 30, { { 18, 1, 113, 1 }, 1 }, { { 18, 1, 2, 3 }, 1 } },
  [5] = { 40, { "BindCoin", 1000 }, { { 18, 1, 114, 4 }, 10, nil, 30 * 24 * 60 } },
  [6] = { 50, { { 21, 5, 1, 1 }, 1 }, { "BindMoney", 200000 } },
  [7] = { 60, { "BindCoin", 2000 }, { { 18, 1, 393, 1 }, 5 } },
  [8] = { 69, { { 18, 1, 114, 7 }, 2, nil, 30 * 24 * 60 }, { { 18, 1, 394, 1 }, 5 } },
  [9] = { 79, { { 18, 1, 394, 1 }, 10 }, { { 18, 1, 212, 1 }, 2 } },
  [10] = { 89, { { 18, 1, 394, 1 }, 10 }, { { 18, 1, 212, 1 }, 3 } },
  [11] = { 99, { { 18, 1, 395, 1 }, 2 } },
}
...
function NewPlayerGift:ShowOption()
  if GetTime() <= Lib:GetDate2Time(self.SHOW_OPTION_UNTIL) and self.SERVER_OPEN_DAY <= tonumber(os.date("%Y%m%d", KGblTask.SCGetDbTaskInt(DBTASD_SERVER_STARTTIME))) then
    return 1
  end
end

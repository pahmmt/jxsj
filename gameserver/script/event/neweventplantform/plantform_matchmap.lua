...
function tbMapPk:OnLeave()
  ...
  if NewEPlatForm.MissionList[nReadyId] and NewEPlatForm.MissionList[nReadyId][nDynId] and NewEPlatForm.MissionList[nReadyId][nDynId]:IsOpen() == 1 and NewEPlatForm.MissionList[nReadyId][nDynId]:GetPlayerGroupId(me) >= 0 then

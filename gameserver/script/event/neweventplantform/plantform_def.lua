...
NewEPlatForm.nCurMatchMinTeamCount = 8 --本阶段比赛最少开启比赛人数
NewEPlatForm.MACTH_MAX_JOINCOUNT = 8 --最大累计次数
NewEPlatForm.nMaxAllCount = 24 --每月最大参加数量
NewEPlatForm.DEF_PLAYER_TEAM = 4 --组队只能是4个人
...
--比赛时间
NewEPlatForm.CALEMDAR = { 1115, 1145, 1215, 1245, 1315, 1345, 1715, 1745, 1815, 1845, 1915, 1945, 2015, 2045, 2115, 2145, 2215 }
...
NewEPlatForm.szUITitle = "家族趣味竞技奖励"
NewEPlatForm.tbPayItem = { nil, { { 18, 1, 1731, 1, 1 } }, { { 18, 1, 1731, 2, 1 } } }
NewEPlatForm.tbMsg = {
  {
    "点击开始按钮开始卡牌抽奖",
    "选择一张卡牌领取奖励",
    "选择继续按钮可以进行新一轮抽奖，选择离开可以离开本场地",
  },
  {
    "点击开始按钮您可以花费一个胜利果（小）开始卡牌抽奖",
    "选择一张卡牌领取奖励",
    "选择继续按钮可以进行新一轮抽奖，选择离开可以离开本场地",
  },
  { "点击开始按钮您可以花费一个胜利果（大）开始卡牌抽奖", "选择一张卡牌领取奖励", "选择离开可以离开本场地" },
}

NewEPlatForm.szScreenMsg = "倒计时结束后您将离开比赛场，请尽快选择奖励。"

NewEPlatForm.tbBuyItem = { 620, 500 }

NewEPlatForm.tbCardAward = {
  {
    { ["szType"] = "item", ["varValue"] = { 18, 1, 1732, 1, 1, 6 }, ["nRate"] = 1500 },
    { ["szType"] = "item", ["varValue"] = { 18, 1, 1732, 1, 1, 8 }, ["nRate"] = 1500 },
    { ["szType"] = "item", ["varValue"] = { 18, 1, 1738, 1, 1, 2 }, ["nRate"] = 1500 },
    { ["szType"] = "item", ["varValue"] = { 18, 1, 1738, 1, 1, 3 }, ["nRate"] = 1500 },
  },
  {
    { ["szType"] = "item", ["varValue"] = { 18, 1, 1732, 1, 1, 16 }, ["nRate"] = 2000 },
    { ["szType"] = "item", ["varValue"] = { 18, 1, 1732, 1, 1, 19 }, ["nRate"] = 2000 },
    { ["szType"] = "item", ["varValue"] = { 18, 1, 1732, 1, 1, 21 }, ["nRate"] = 2000 },
    { ["szType"] = "item", ["varValue"] = { 18, 1, 1732, 1, 1, 24 }, ["nRate"] = 2000 },
    { ["szType"] = "item", ["varValue"] = { 18, 1, 1732, 2, 0, 2 }, ["nRate"] = 1000 },
    { ["szType"] = "item", ["varValue"] = { 18, 1, 1732, 2, 0, 4 }, ["nRate"] = 1000 },
  },
  {
    { ["szType"] = "item", ["varValue"] = { 18, 1, 1732, 1, 1, 26 }, ["nRate"] = 2000 },
    { ["szType"] = "item", ["varValue"] = { 18, 1, 1732, 1, 1, 29 }, ["nRate"] = 2000 },
    { ["szType"] = "item", ["varValue"] = { 18, 1, 1732, 1, 1, 32 }, ["nRate"] = 2000 },
    { ["szType"] = "item", ["varValue"] = { 18, 1, 1732, 1, 1, 35 }, ["nRate"] = 2000 },
    { ["szType"] = "item", ["varValue"] = { 18, 1, 1732, 2, 0, 4 }, ["nRate"] = 1000 },
    { ["szType"] = "item", ["varValue"] = { 18, 1, 1732, 2, 0, 6 }, ["nRate"] = 1000 },
  },
}

...
NewServerEvent.szAnnounceKinEvent = "<color=purple>【家族挑战活动】<color>已经开启，各家族可由族长在家族领地NPC<color=green>萧汜<color>处开启活动，可获得包括<color=green>大量亲密度<color>在内的丰厚奖励！"
...
NewServerEvent.nWelFareGiveExpRate = 12 * 60 --每次给的经验的倍率,乘60是一个小时的经验
...
NewServerEvent.szAnnounceBefore = "古墓派掌门人林烟卿即将出现在<color=green>临安府、大理府和襄阳府<color>，请大家做好准备，迎接古墓派掌门人的到来！"
NewServerEvent.szAnnounceBegin = "古墓派掌门人林烟卿已经出现在<color=green>临安府、大理府和襄阳府<color>，请大家<color=yellow>跟随林烟卿<color>，沾染喜气！"
NewServerEvent.szAnnounceEnd = "古墓派掌门人林烟卿已经离开了城市，请期待古墓派掌门人下一次的到来！"
...
NewServerEvent.tbAwardList = {
  [2581] = { "bindcoin", 50, 0 },
  [3871] = { "bindcoin", 100, 2581 },
  [4516] = { "bindcoin", 150, 3871 },
  [4839] = { "bindcoin", 200, 4516 },
  [5000] = { "bindcoin", 400, 4839 },
  [7581] = { "bindmoney", 10000, 5000 },
  [8871] = { "bindmoney", 10000, 7581 },
  [9516] = { "bindmoney", 15000, 8871 },
  [9839] = { "bindmoney", 20000, 9516 },
  [10000] = { "bindmoney", 40000, 9839 },
}

NewServerEvent.nExpAward = 30 --30分钟基准经验

...
function HundredKin:DialogLogic(nItemLevel)
  ...
  if nSort == 1 then
    Dialog:Say("  恭喜你们家族位于百家之首，族长和正式成员分别获得<color=yellow>“第一家族族长”、“第一家族成员”<color>称号以及<color=yellow>盛夏黄金宝箱<color>3个！族长可获得1000点江湖威望，5000点领袖荣誉，成员可获得500点江湖威望！" .. string.format(szInfo, self.KIN_AWARD[1][1].bindmoney), { { "领取", self.DialogLogic, self, 1 }, { "取消" } })
  elseif nSort <= 10 then
    Dialog:Say("  恭喜你们家族位于十大家族，族长和正式成员可以分别获得<color=yellow>“十大家族族长”、“十大家族成员”<color>称号以及<color=yellow>盛夏黄金宝箱<color>2个！族长可获得600点江湖威望，3000点领袖荣誉，成员可获得300点江湖威望！" .. string.format(szInfo, self.KIN_AWARD[2][1].bindmoney), { { "领取", self.DialogLogic, self, 2 }, { "取消" } })
  elseif nSort <= 30 then
    Dialog:Say("  恭喜你们家族位于前三十家族，族长和正式成员可以分别获得<color=purple>“出类拔萃的族长”、“出类拔萃的成员”<color>称号以及<color=yellow>盛夏黄金宝箱<color>1个！族长可获得400点江湖威望，2000点领袖荣誉，成员可获得200点江湖威望！" .. string.format(szInfo, self.KIN_AWARD[3][1].bindmoney), { { "领取", self.DialogLogic, self, 3 }, { "取消" } })
  elseif nSort <= 60 then
    Dialog:Say("  恭喜你们家族位于前六十之列，族长和正式成员可以分别获得<color=blue>“干劲十足的族长”、“干劲十足的成员”<color>称号以及<color=purple>盛夏白银宝箱<color>2个！族长可获得200点江湖威望，1000点领袖荣誉，成员可获得100点江湖威望！" .. string.format(szInfo, self.KIN_AWARD[4][1].bindmoney), { { "领取", self.DialogLogic, self, 4 }, { "取消" } })
  elseif nSort <= 100 then
    Dialog:Say("  恭喜你们家族位于百家之列，族长和正式成员可以分别获得<color=purple>盛夏白银宝箱<color>1个！族长可获得500点领袖荣誉！" .. string.format(szInfo, self.KIN_AWARD[5][1].bindmoney), { { "领取", self.DialogLogic, self, 5 }, { "取消" } })
  else
    Dialog:Say("很遗憾，你家族在100名之外，不能获得任何奖励")
  end
end

...
function tbItem:CanUse()
  ...
  if me.dwCurGTP < tbEvent.JH_USECARD or me.dwCurMKP < tbEvent.JH_USECARD then
...
function tbItem:Identify(nItemId, bSure)
  ...
  GeneralProcess:StartProcess("鉴定爱我中华卡...", self.IdentifyDuration, { self.Identify, self, nItemId, 1 }, nil, tbEvent)
end

...
function tbOldSeed:PlantTree(pPlayer, dwItemId)
  ...
  if nRes == 1 then
    ...
    GeneralProcess:StartProcess("植树中", 5 * Env.GAME_FPS, { SpecialEvent.ZhiShu2009.Plant1stTree, SpecialEvent.ZhiShu2009, pPlayer, dwItemId }, nil, tbEvent)
  elseif szMsg then
    Dialog:Say(szMsg)
  end
end
...
tbSeed.tbRate = { [1] = { 50, { 18, 1, 954, 1 } }, [2] = { 80, { 18, 1, 954, 2 } }, [3] = { 100, { 18, 1, 954, 3 } } }

    ...
    if tbInfor.szType == tbSelect.szType then
      if type(tbInfor.varValue) == "number" and tbInfor.varValue == tbSelect.varValue then
        ...
        if tbInfor.szType == "bindmoney" and tbInfor.varValue >= 100000 then
          ...
          me.SendMsgToFriend("您的好友[" .. me.szName .. "]在[葫芦兄弟送大礼]活动中获得了<color=green>" .. tbInfor.varValue .. "绑银<color>。")
        end
        if tbInfor.szType == "bindcoin" and tbInfor.varValue >= 2000 then
          ...
          me.SendMsgToFriend("您的好友[" .. me.szName .. "]在[葫芦兄弟送大礼]活动中获得了<color=green>" .. tbInfor.varValue .. "绑金<color>。")
        end
        return i
      elseif type(tbInfor.varValue) == "table" and tbInfor.varValue[1] == tbSelect.varValue[1] and tbInfor.varValue[2] == tbSelect.varValue[2] and tbInfor.varValue[3] == tbSelect.varValue[3] and tbInfor.varValue[4] == tbSelect.varValue[4] and tbInfor.varValue[5] == tbSelect.varValue[5] and tbInfor.varValue[6] == tbSelect.varValue[6] then
        ...
        if szGDP == "18,1,1251" then
          ...
          me.SendMsgToFriend("您的好友[" .. me.szName .. "]在[葫芦兄弟送大礼]活动中获得了<color=green>" .. self.tbRepute[tbInfor.varValue[4]][6] or "小游龙阁声望令" .. "<color>。")
        ...
        if szGDP == "18,1,1730" then
          ...
          me.SendMsgToFriend("您的好友[" .. me.szName .. "]在[葫芦兄弟送大礼]活动中获得了<color=green>【宠物宝箱】·葫芦娃<color>。")
        ...
        if szGDP == "18,1,114" then
          if tbSelect.varValue[4] >= 7 then
            ...
            me.SendMsgToFriend("您的好友[" .. me.szName .. "]在[葫芦兄弟送大礼]活动中获得了<color=green>" .. tbSelect.varValue[4] .. "级玄晶<color>。")
          end
        end
...
function tbChildrenDay2012:StarCondition()
  ...
  if nCount < tbCostItem[1][5] then
    ...
    Dialog:Say("本轮需要<color=yellow>小葫芦" .. tbCostItem[1][5] .. "个<color>，您的葫芦数量不足，是否在奇珍阁购买？\n\n<color=green>小葫芦：<color>    <color=yellow>10金币 / 个<color>\n<color=green>小葫芦·箱：<color><color=yellow>1000金币 / 个（包含小葫芦100个）<color>", { { "购买小葫芦", self.BuyItem, self, 1 }, { "购买小葫芦·箱", self.BuyItem, self, 2 }, { "我再想想" } })
    return 0
  end
end

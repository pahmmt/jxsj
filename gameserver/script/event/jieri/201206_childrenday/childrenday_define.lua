...
tbChildrenDay2012.tbFactionName = { "少林", "天王", "唐门", "五毒", "峨嵋", "翠烟", "丐帮", "天忍", "武当", "昆仑", "明教", "大理段氏", "古墓" }
...
tbChildrenDay2012.tbRepute = {
  { 5, 4, 2600, { 18, 1, 1251, 1, 1, 1 }, 3, "小游龙阁声望令[护身符]" },
  { 8, 1, 17750, { 18, 1, 1251, 2, 1, 1 }, 4, "小游龙阁声望令[帽子]" },
  { 7, 1, 21000, { 18, 1, 1251, 3, 1, 1 }, 4, "小游龙阁声望令[衣服]" },
  { 5, 2, 250, { 18, 1, 1251, 4, 1, 1 }, 1, "小游龙阁声望令[腰带]" },
}

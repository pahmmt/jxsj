...
function tbItem:UseThis(nItemId)
  ...
  elseif nNumber >= 4 and nNumber <= 10 then
    ...
    if nRand <= tbShengXia2012.tbPaiZi[nNumber] and nGetNow < nGetMost then
      ...
      me.SendMsgToFriend("您的好友[<color=yellow>" .. me.szName .. "<color>]在盛夏典藏集卡活动中，成功获得<color=yellow>" .. pItemEx.szName .. "<color>")
      ...
      if bOk == 1 then
        ...
        if nType == 1 and nLevel >= 8 then
          me.SendMsgToFriend("您的好友[<color=yellow>" .. me.szName .. "<color>]在盛夏典藏集卡活动中，成功获得<color=yellow>" .. szMsg .. "<color>")

...
function tbNpc:OnGetAward()
  ...
  local nNeed = KItem.GetNeedFreeBag(tbSeventhEvening.tbShijiBoxId[1], tbSeventhEvening.tbShijiBoxId[2], tbSeventhEvening.tbShijiBoxId[3], tbSeventhEvening.tbShijiBoxId[4], nil, nBox)
  ...
  me.AddStackItem(tbSeventhEvening.tbShijiBoxId[1], tbSeventhEvening.tbShijiBoxId[2], tbSeventhEvening.tbShijiBoxId[3], tbSeventhEvening.tbShijiBoxId[4], nil, nBox)

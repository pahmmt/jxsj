...
function tbNpc:OnDialog()
  ...
  if me.szName ~= szMaleName and me.szName ~= szFemaleName or pTeamMate.szName ~= szMaleName and pTeamMate.szName ~= szFemaleName then
  ...
  GeneralProcess:StartProcess("培育中...", 5 * Env.GAME_FPS, { self.OnClick, self, him.dwId, me.szName }, nil, tbEvent)
end

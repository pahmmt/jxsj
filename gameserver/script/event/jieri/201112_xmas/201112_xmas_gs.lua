...
function Xmas2011:OnGetPrizeSock()
  ...
  local szMsg = "    圣诞获得期间，每日11点~14点、19点~22点，可在襄阳、临安寻找圣诞老人领取圣诞袜子，与拥有同花色袜子的玩家组队后，在规定时间内，来此领取奖励。"
  local tbOpt = {}
...
function Xmas2011:GivePrizeSock()
  ...
  StatLog:WriteStatLog("stat_info", "shengdanjie_2012", "socks_put_star", 0, unpack(tbLogName))
end

...
function RoomXmas:OnWaringTime()
  ...
  if self.nCurSec % 120 == 0 then
    self.tbBase:BlackMsg(-1, "当前距离圣诞关卡关闭还有" .. math.floor((self.nGameTime - self.nCurSec) / 60) .. "分钟")
    self.tbBase:SendPlayerMsg(-1, "当前距离圣诞关卡关闭还有" .. math.floor((self.nGameTime - self.nCurSec) / 60) .. "分钟")
  end
end

...
function tbNpcHuoDongDaShi:Transmit(nNpcId)
  ...
  if (nPosX1 - nNpcPosX) * (nPosX1 - nNpcPosX) + (nPosY1 - nNpcPosY) * (nPosY1 - nNpcPosY) > tbQiXi2012.MAX_TRANSMIT_RANGE * tbQiXi2012.MAX_TRANSMIT_RANGE or (nPosX2 - nNpcPosX) * (nPosX2 - nNpcPosX) + (nPosY2 - nNpcPosY) * (nPosY2 - nNpcPosY) > tbQiXi2012.MAX_TRANSMIT_RANGE * tbQiXi2012.MAX_TRANSMIT_RANGE then

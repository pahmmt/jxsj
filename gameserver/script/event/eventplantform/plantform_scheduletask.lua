...
function EPlatForm:ScheduleCallOut(nTaskId)
  ...
  --如果不在比赛期
  if (EPlatForm:GetMacthState() == EPlatForm.DEF_STATE_MATCH_1 and EPlatForm:GetMatchStateForDate() == EPlatForm.DEF_STATE_MATCH_1) or (EPlatForm:GetMacthState() == EPlatForm.DEF_STATE_MATCH_2 and EPlatForm:GetMatchStateForDate() == EPlatForm.DEF_STATE_MATCH_2) then

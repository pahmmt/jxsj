...
function EPlatForm:ClearReadyMap() end
...
function EPlatForm:GiveWeleeAwardToPlayer(pPlayer, nRank)
  ...
  local nHonor = 0
  if EPlatForm.AWARD_WELEE_LIST[nSession] and EPlatForm.AWARD_WELEE_LIST[nSession][nRank] and EPlatForm.AWARD_WELEE_LIST[nSession][nRank].honor then

...
Relation.TASKID_TRAINED_NUM = 13 -- 记录已出师徒弟的个数
...
Relation.GAPMINILEVEL = 10 -- 拜师时，师徒之间的最小等级差
Relation.TEACHER_NIMIEVEL = 60 -- 师傅的最低等级
...
Relation.tbRelationName = {
  [Player.emKPLAYERRELATION_TYPE_TMPFRIEND] = "好友", -- 临时好友
  [Player.emKPLAYERRELATION_TYPE_BLACKLIST] = "黑名单",
  [Player.emKPLAYERRELATION_TYPE_BIDFRIEND] = "好友",
  [Player.emKPLAYERRELATION_TYPE_SIBLING] = "结拜",
  [Player.emKPLAYERRELATION_TYPE_ENEMEY] = "仇人",
  [Player.emKPLAYERRELATION_TYPE_TRAINING] = "师徒",
  [Player.emKPLAYERRELATION_TYPE_TRAINED] = "师徒",
  [Player.emKPLAYERRELATION_TYPE_COUPLE] = "知己",
  [Player.emKPLAYERRELATION_TYPE_INTRODUCTION] = "介绍人",
  [Player.emKPLAYERRELATION_TYPE_BUDDY] = "指定密友",
}

Relation.DEF_MAX_RELATIONGROUP_COUNT = 1
Relation.DEF_MAX_RELATIONGROUP_MAX_PLAYER = 40

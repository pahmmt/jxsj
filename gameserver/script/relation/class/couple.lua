...
if MODULE_GC_SERVER then
  ...
  function tbCouple:CanCreateRelation(nRole, nAppId, nDstId)
    ...
    -- 配偶只能有一个
    if KRelation.GetOneRelationCount(nAppId, Player.emKPLAYERRELATION_TYPE_COUPLE, 1) >= 1 or KRelation.GetOneRelationCount(nDstId, Player.emKPLAYERRELATION_TYPE_COUPLE, 0) >= 1 then

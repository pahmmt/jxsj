...
do
  ...
  local tt_object_key, tt_object_colon, tt_object_value, tt_doublequote_string, tt_singlequote_string, tt_array_value, tt_array_seperator, tt_numeric, tt_boolean, tt_null, tt_comment_start, tt_comment_middle, tt_ignore --< tt_ignore is special - marked tokens will be tt_ignored
    = {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}
  ...
  init_token_table(tt_array_seperator)
    ...
    :link(tt_object_key)
    :to "{"
    :link(tt_array_seperator)
    :to "["
    :link(true)
    :to "]" -- added by wangzhiguang 2011-03-13 for "empty array" support, see line 476
...
tbJson.encode = encode
tbJson.decode = decode

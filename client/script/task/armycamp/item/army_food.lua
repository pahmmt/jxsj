...
function tbItem:OnUse()
  ...
  GeneralProcess:StartProcess("享用食物中...", nTime * Env.GAME_FPS, { self.SuccessUse, self, me.nId, it.dwId }, { self.FailUse, self, me.nId, it.dwId }, tbEvent)
...
function tbItem:GetTip(nState)
  ...
  szTip = szTip .. string.format("<color=yellow>食物获得经验: %s/%s<color>", nExp, self.tbFood[it.nLevel])
  return szTip
end

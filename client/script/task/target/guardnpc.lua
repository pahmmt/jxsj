...
function tb:Init(nMapId, nMapPosX, nMapPosY, nDialogNpcTempId, szOption, szMsg, nFightNpcTempId, nFightNpcLevel, nFightNpcHP, nGuardDuration, nDeathDuration, szStaticDesc, szDynamicDesc, szFailedMsg, szBeforePop, szLaterPop)
  self.nMapId = nMapId

...
function tb:GetDesc()
  ...
  szMsg = szMsg .. string.format("%s并获得%s：%d/%d", self.szNpcName, self.szItemName, nCurCount, self.nNeedCount)
  return szMsg
end
...
function tb:GetStaticDesc()
  ...
  szMsg = szMsg .. string.format("%s并获得%s%d 个", self.szNpcName, self.szItemName, self.nNeedCount)
  return szMsg
end

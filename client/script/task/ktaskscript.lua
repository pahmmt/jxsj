...
TASK_AWARD_TIP.exp = function(tbAward)
  return "经验：<color=green>" .. tostring(tbAward.varValue) .. "<color>"
end

TASK_AWARD_TIP.money = function(tbAward)
  return "绑定银两：<color=green>" .. tostring(tbAward.varValue) .. "<color>"
end
...
TASK_AWARD_TIP.activemoney = function(tbAward)
  return "银两：<color=green>" .. tostring(tbAward.varValue) .. "<color>"
end

TASK_AWARD_TIP.gatherpoint = function(tbAward)
  return "活力：<color=green>" .. tbAward.varValue .. "<color>"
end

TASK_AWARD_TIP.linktask_repute = function(tbAward)
  return "义军声望：<color=green>" .. tbAward.varValue[3] .. "<color>"
end

TASK_AWARD_TIP.linktask_cancel = function(tbAward)
  return "<color=green>一次取消任务的机会<color>"
end

TASK_AWARD_TIP.makepoint = function(tbAward)
  return "精力：<color=green>" .. tbAward.varValue .. "<color>"
end
...
TASK_AWARD_TIP.title = function(tbAward)
  ...
  return "称号：<color=green>" .. szDesc .. "<color>"
end
...
TASK_AWARD_TIP.repute = function(tbAward)
  ...
  return "声望：<color=green>" .. szReputeDesc .. " " .. tbAward.varValue[3] .. "点<color>"
end

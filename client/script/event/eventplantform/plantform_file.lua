    ...
    if tbFileName[nType] then
      ...
      for nId, tbParam in ipairs(tbTypeFile) do
        if nId > 1 then
          ...
          if nTimeCommonStart and nTimeCommonEnd and nTimeCommonLong and nTimeCommonStart > 0 and nTimeCommonEnd > 0 and nTimeCommonLong > 0 then
          ...
          if nTimeCommon_Adv_Start and nTimeCommon_Adv_End and nTimeCommon_Adv_Long and nTimeCommon_Adv_Start > 0 and nTimeCommon_Adv_End > 0 and nTimeCommon_Adv_Long > 0 then

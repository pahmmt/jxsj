...
function tbChuangTangzeiBoss:OnDeath(pNpcKiller)
  ...
  if nCount > 0 and pPlayerKiller then
    ...
    szMsg = "[" .. pNpcKiller.szName .. "]杀死了" .. szBoss .. ", " .. szMsg
    KDialog.Msg2PlayerList(tbPlayer, szMsg, "系统提示")

    pPlayerKiller.SendMsgToFriend("您的好友[" .. pPlayerKiller.szName .. "]杀死了白虎堂" .. szBoss .. "。")
    Player:SendMsgToKinOrTong(pPlayerKiller, "杀死了白虎堂" .. szBoss .. "。", 0)
  ...
  Dbg:WriteLogEx(Dbg.LOG_INFO, "白虎堂", pNpcKiller.szName .. "杀死了" .. szBoss) --记录是谁杀死的

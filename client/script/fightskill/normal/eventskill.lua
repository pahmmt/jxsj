...
local tb = {
  ...
  -------------------------------------四周年活动-------------------------------------------------
  fouryear_transmutation = { --变身技能
    --参数1,变身npcid,参数2变身npc等级,参数3变身类型:1变外观,2变属性,4改变技能
    domainchangeself = { { { 1, 3607 }, { 2, 7056 }, { 3, 3608 }, { 4, 4483 }, { 5, 4483 } }, { { 1, 100 }, { 2, 100 } }, { { 1, 1 }, { 2, 1 } } },
    skill_statetime = { 18 * 60 },
  },
  -------------------------------------2012年圣诞活动-------------------------------------------------
  sd2012_transmutation = { --变身技能
    --参数1,变身npcid,参数2变身npc等级,参数3变身类型:1变外观,2变属性,4改变技能
    domainchangeself = { { { 1, 11289 }, { 2, 11289 } }, { { 1, 100 }, { 2, 100 } }, 7 },
    adddomainskill1 = { 15, 1 },
    adddomainskill2 = { 1983, 1 },
    skill_statetime = { 18 * 60 },
  },
  sd2012_flee = { --闪避增益状态
    ignoreskill = { 100, 0, 8 },
  ...
  Children2012_transmutation = {
    ...
    adddomainskill1 = { { { 1, 0 }, { 44, 0 }, { 45, 15 }, { 46, 15 } }, 1 },
    adddomainskill2 = { { { 1, 0 }, { 44, 0 }, { 45, 1983 }, { 46, 1983 } }, 1 },
...
function tbSkill:GetAutoDesc(tbAutoInfo, tbSkillInfo)
  ...
  local szMsg = string.format("\n每隔%s秒释放：<color=green>月华千里<color>\n幸运值：增加<color=gold>%s点<color>\n杀死敌人的经验：增加<color=gold>%s%%<color>\n持续时间<color=gold>%s秒<color>", FightSkill:Frame2Sec(tbAutoInfo.nPerCastTime), tbChildInfo.tbWholeMagic["lucky_v"][1], tbChildInfo.tbWholeMagic["expenhance_p"][1], FightSkill:Frame2Sec(tbChildInfo.nStateTime))
  return szMsg
end

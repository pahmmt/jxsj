...
function tbSkill:GetAutoDesc(tbAutoInfo, tbSkillInfo)
  ...
  local szMsg = string.format("<color=blue>自身效果：<color>\n完全闪避极效攻击概率：增加<color=gold>%s%%<color>\n<color=blue>友方效果：<color>\n完全闪避极效攻击概率：增加<color=gold>%s%%<color>", tbChildInfo2.tbWholeMagic["ignoreskill"][1], tbChildInfo.tbWholeMagic["ignoreskill"][1])
  return szMsg
end

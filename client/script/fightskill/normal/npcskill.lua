...
local tb = {
  ...
  cbt_dongjie = { --90级藏宝图小怪冻结冰爆
    state_freeze_attack = { { { 1, 100 }, { 2, 50 }, { 3, 50 } }, { { 1, 18 * 1 }, { 2, 18 * 1 } } },
    skill_deadlystrike_r = { { { 1, 212 }, { 20, 212 } } },
  },
  ...
  cbt_fastlifereplenish2 = { --藏宝图改造全屏回血光环,对应各星级副本回血值
    fastlifereplenish_v = {
      {
        { 1, 5895 },
        { 2, 10881 },
  ...
  dispute_transmutation = { --变身技能
    domainchangeself = {
      { { 1, 3402 }, { 4, 3402 }, { 5, 3403 }, { 8, 3403 }, { 9, 3404 }, { 12, 3404 } },
      { { 1, 85 }, { 4, 115 }, { 5, 85 }, { 8, 115 }, {
        9,
        85,
      }, {
        12,
  ...
  ------------------藏宝图_冥灵庭院-------------------
  mlty_dmgstack = { --增加目标受到的伤害百分比,，包含按比例伤血，可叠加
    --redeivedamage_dec_p2={{{1,-5},{2,-10}}},
    percentreducelife_percent = { 30 },
    reducepercentonmaxhp_p = { 60, { { 1, 0 }, { 10, 0 } }, { { 1, 0 }, { 10, 0 } } },
    superposemagic = { 99 },
  },
  mlty_autoatkfriendly = { --自动波浪
    autoskill = { 150, { { 1, 1 }, { 20, 20 } } },
    ignoredebuff = { { { 1, 32767 }, { 10, 32767 } } },
    --prop_invincibility={1},
    skill_statetime = { { { 1, -1 }, { 20, -1 } } },
  },
  mlty_autoatkfriendly2 = { --自动攻击友方
    autoskill = { 151, { { 1, 1 }, { 20, 20 } } },
    --ignoredebuff = {{{1,32767},{10,32767}}},
  },
  mlty_gezhongkongzhi = { --击退浮空定身
    state_float_attack = { { { 1, 1000 }, { 10, 1000 } }, { { 1, 18 * 7 }, { 2, 18 * 7 } } },
    state_knock_attack = { { { 1, 1000 }, { 10, 1000 } }, 20, { { 1, 32 }, { 2, 32 } } },
    state_fixed_attack = { { { 1, 1000 }, { 20, 1000 } }, { { 1, 18 * 7 }, { 20, 18 * 7 } } },
    missile_collzheight = { 9999 },
    --ignoredebuff = {{{1,32767},{10,32767}}},
  },
  mlty_autoatkenemy = { --自动攻击背后敌方
    autoskill = { 152, { { 1, 1 }, { 20, 20 } } },
    --ignoredebuff = {{{1,32767},{10,32767}}},
    skill_statetime = { { { 1, -1 }, { 20, -1 } } },
  },
}
...
local tbSkill = FightSkill:GetClass("mlty_autoatkfriendly2")
...
function tbSkill:GetAutoDesc(tbAutoInfo, tbSkillInfo)
  ...
  szMsg = szMsg .. string.format("每<color=Gold>%s秒<color>自动攻击附近友方\n", FightSkill:Frame2Sec(tbAutoInfo.nPerCastTime))
...
local tbSkill = FightSkill:GetClass("mlty_autoatkfriendly")
...
function tbSkill:GetAutoDesc(tbAutoInfo, tbSkillInfo)
  ...
  local szMsg = ""
  local szSkillName = FightSkill:GetSkillName(tbChildInfo.nId)
  szMsg = szMsg .. string.format("每<color=Gold>%s秒<color>有<color=Gold>%d%%<color>几率释放<color=green>[%s]<color>", FightSkill:Frame2Sec(tbAutoInfo.nPerCastTime), tbAutoInfo.nPercent, szSkillName)
  FightSkill:GetClass("default"):GetDescAboutLevel(tbMsg, tbChildInfo, 0)
  for i = 1, #tbMsg do
    szMsg = szMsg .. "    " .. tostring(tbMsg[i]) .. (i ~= #tbMsg and "\n" or "")
  end
...
local tbSkill = FightSkill:GetClass("mlty_autoatkenemy")
...
function tbSkill:GetAutoDesc(tbAutoInfo, tbSkillInfo)
  ...
  local szMsg = ""
  local szSkillName = FightSkill:GetSkillName(tbChildInfo.nId)
  szMsg = szMsg .. string.format("每<color=Gold>%s秒<color>释放<color=green>[%s]<color>", FightSkill:Frame2Sec(tbAutoInfo.nPerCastTime), szSkillName)
  FightSkill:GetClass("default"):GetDescAboutLevel(tbMsg, tbChildInfo, 0)
  for i = 1, #tbMsg do
    szMsg = szMsg .. "    " .. tostring(tbMsg[i]) .. (i ~= #tbMsg and "\n" or "")
  end

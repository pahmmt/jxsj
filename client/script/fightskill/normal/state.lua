...
function tbSkill:GetAutoDesc(tbAutoInfo, tbSkillInfo)
  ...
  local szMsg = string.format("\n每隔%s秒释放：<color=green>通微显化<color>\n<color=blue>自身效果:<color>\n对怪物伤害：增加<color=gold>%s%%<color>\n生命最大值比例：增加<color=gold>%s%%<color>\n内力最大值比例：增加<color=gold>%s%%<color>\n<color=blue>友方效果:<color>\n对怪物伤害：增加<color=gold>%s%%<color>\n持续时间<color=gold>%s秒<color>", FightSkill:Frame2Sec(tbAutoInfo.nPerCastTime), tbChildInfo2.tbWholeMagic["npcdamageadded"][1], tbChildInfo2.tbWholeMagic["lifemax_p"][1], tbChildInfo2.tbWholeMagic["manamax_p"][1], tbChildInfo.tbWholeMagic["npcdamageadded"][1], FightSkill:Frame2Sec(tbChildInfo.nStateTime))
  return szMsg
end
...
function tbSkill:GetAutoDesc(tbAutoInfo, tbSkillInfo)
  local tbChildInfo = KFightSkill.GetSkillInfo(tbAutoInfo.nSkillId, tbAutoInfo.nSkillLevel)
  local tbChildInfo2 = KFightSkill.GetSkillInfo(tbChildInfo.tbEvent.nStartSkillId, tbChildInfo.tbEvent.nLevel)
  local szMsg = string.format("\n每隔%s秒释放：<color=green>游龙真气<color>\n<color=blue>自身效果:<color>\n移动速度：增加<color=gold>%s%%<color>\n五行相克强化：增加<color=gold>%s<color>\n五行相克弱化：增加<color=gold>%s<color>\n<color=blue>友方效果:<color>\n移动速度：增加<color=gold>%s%%<color>\n五行相克强化：增加<color=gold>%s<color>\n五行相克弱化：增加<color=gold>%s<color>\n持续时间<color=gold>%s秒<color>", FightSkill:Frame2Sec(tbAutoInfo.nPerCastTime), tbChildInfo2.tbWholeMagic["fastwalkrun_p"][1], tbChildInfo2.tbWholeMagic["seriesenhance"][1], tbChildInfo2.tbWholeMagic["seriesabate"][1], tbChildInfo.tbWholeMagic["fastwalkrun_p"][1], tbChildInfo.tbWholeMagic["seriesenhance"][1], tbChildInfo.tbWholeMagic["seriesabate"][1], FightSkill:Frame2Sec(tbChildInfo.nStateTime))
  return szMsg
end
...
function tbSkill:GetAutoDesc(tbAutoInfo, tbSkillInfo)
  ...
  local szMsg = string.format(
    "\n<color=blue>自身效果:<color>\n发挥基础攻击力：增加<color=gold>%s%%<color>\n受到五行状态的几率：减少<color=gold>%s<color>\n生命最大值比例：增加<color=gold>%s%%<color>\n内力最大值比例：增加<color=gold>%s%%<color>\n%s\n<color=blue>友方效果:<color>\n发挥基础攻击力：增加<color=gold>%s%%<color>\n受到五行状态的几率：减少<color=gold>%s<color>\n生命最大值比例：增加<color=gold>%s%%<color>\n内力最大值比例：增加<color=gold>%s%%<color>\n%s\n最大影响的目标数：<color=gold>%s个<color>\n持续时间<color=gold>%s秒<color>",
...
function tbSkill:GetAutoDesc(tbAutoInfo, tbSkillInfo)
  local tbChildInfo = KFightSkill.GetSkillInfo(tbAutoInfo.nSkillId, tbAutoInfo.nSkillLevel)
  local szMsg = string.format("濒死时触发几率：<color=gold>%d%%<color>\n不受任何伤害，持续<color=Gold>%s秒<color>\n触发间隔时间：<color=Gold>%s秒<color>", tbAutoInfo.nPercent, FightSkill:Frame2Sec(tbChildInfo.nStateTime), FightSkill:Frame2Sec(tbAutoInfo.nPerCastTime))
  return szMsg
end
...
function tbSkill:GetAutoDesc(tbAutoInfo, tbSkillInfo)
  local tbChildInfo = KFightSkill.GetSkillInfo(tbAutoInfo.nSkillId, tbAutoInfo.nSkillLevel)
  local szMsg = string.format("生命降低到50%%时自动触发：\n    <color=green>护身真气<color>\n    受到的伤害减少<color=Gold>%s%%<color>，持续<color=Gold>%s秒<color>\n    触发间隔时间：<color=Gold>%s秒<color>", tbChildInfo.tbWholeMagic["dynamicmagicshield_v"][2], FightSkill:Frame2Sec(tbChildInfo.nStateTime), FightSkill:Frame2Sec(tbAutoInfo.nPerCastTime))
  return szMsg
end

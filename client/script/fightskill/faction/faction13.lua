...
local tb = {
  ...
  sxgm_40 = { --杀闪精通_20
    ...
    addstartskill = { 2806, 2818, { { 1, 1 }, { 20, 3 }, { 21, 3 } } },
  ...
  lygm_horseskill3 = { --高级坐骑技能_50
    lifemax_v = { { { 1, 29 }, { 50, 1450 } } },
    --manamax_v={{{1,19},{50,965}}},
    --lifemax_p={{{1,13*1.2},{50,60*1.2}}},
    manamax_p = { { { 1, 13 * 0.8 }, { 50, 60 * 0.8 } } },
    --manamax_v={{{1,54},{50,2710}}},
    skill_statetime = { { { 1, -1 }, { 2, -1 } } },
    skill_skillexp_v = FightSkill.tbParam.tbHorseSkillExp3,
  },
  -----------------------------古墓针法-------------------------
  ...
  lygm_atk_10 = { --10
    ...
    lightingdamage_v = {
      [1] = { { 1, 1.75 * 395 * 0.8 * nS01 }, { 10, 1.75 * 395 * 0.8 }, { 11, 1.75 * 395 * 0.8 * nA0 } },
      [3] = { { 1, 1.75 * 395 * 1.2 * nS01 }, { 10, 1.75 * 395 * 1.2 }, { 11, 1.75 * 395 * 1.2 * nA0 } },
    },
  ...
  lygm_atk_50 = { --10
    ...
    lightingdamage_v = {
      [1] = { { 1, 1.5 * 645 * 0.8 * nS01 }, { 10, 1.5 * 645 * 0.8 }, { 11, 1.5 * 645 * 0.8 * nA0 } },
      [3] = { { 1, 1.5 * 645 * 1.2 * nS01 }, { 10, 1.5 * 645 * 1.2 }, { 11, 1.5 * 645 * 1.2 * nA0 } },
    },
    state_stun_attack = { { { 1, 21 }, { 10, 30 }, { 11, 31 } }, { { 1, 18 }, { 10, 18 } } },
  ...
  lygm_atk_30_child = { --冰魄银针_伤害_10
    ...
    lightingdamage_v = {
      [1] = { { 1, 585 * 0.8 * nS01 }, { 10, 585 * 0.8 }, { 11, 585 * 0.8 * nA0 } },
      [3] = { { 1, 585 * 1.2 * nS01 }, { 10, 585 * 1.2 }, { 11, 585 * 1.2 * nA0 } },
    },
    seriesdamage_r = { 0 }, --={{{1,250},{10,500},{11,500}}},
    missile_hitcount = { { { 1, 3 }, { 10, 3 }, { 11, 3 } } },
  },
  ...
  lygm_60_b = { --_5
    deadlystrikeenhance_r = {
      { --每级+3%会心,+1的时候每级+2%,作为一定程度上减少会心递减
        { 1, 121 },
        { 2, 259 },
        { 3, 417 },
        { 4, 600 },
...
function tbSkill:GetExtraDesc(tbInfo)
  ...
  local szMsg = string.format("\n释放技能同时获得<color=gold>%d<color>层<color=green>[%s]<color>", tbChildInfo.tbWholeMagic["superposemagic"][3], szSkillName)
  return szMsg
end
...
function tbSkill:GetExtraDesc(tbInfo)
  ...
  local szMsg = string.format("\n释放技能同时获得<color=gold>%d<color>层<color=green>[%s]<color>", tbChildInfo2.tbWholeMagic["superposemagic"][3], szSkillName)
  return szMsg
end
...
function tbSkill:GetExtraDesc(tbInfo)
  ...
  local tbInfo2 = KFightSkill.GetSkillInfo(tbInfo.nId, tbInfo.nLevel, me, 1)
  if not tbInfo2.tbEvent.nAddStartSkillId then
    return ""
  end
  local tbChildInfo = KFightSkill.GetSkillInfo(tbInfo2.tbEvent.nAddStartSkillId, tbInfo2.tbEvent.nAddStartSkillLevel, me, 1)
  if not tbChildInfo then
    return ""
  end
  local szSkillName = FightSkill:GetSkillName(tbChildInfo.nId)
  local szMsg = string.format("\n释放技能同时获得<color=gold>%d<color>层<color=green>[%s]<color>", tbChildInfo.tbWholeMagic["superposemagic"][3], szSkillName)
...
function tbSkill:GetExtraDesc(tbInfo)
  ...
  local tbInfo2 = KFightSkill.GetSkillInfo(tbInfo.nId, tbInfo.nLevel, me, 1)
  local tbStartInfo = tbInfo2.tbWholeMagic["addstartskill"]
  --local szSkillName	= FightSkill:GetSkillName(tbStartInfo[1]);
  local szMsg = string.format("<color=gold>%s<color>释放同时获得<color=gold>%d<color>层<color=green>[%s]<color>", FightSkill:GetSkillName(tbStartInfo[1]), tbStartInfo[3], FightSkill:GetSkillName(tbStartInfo[2]))
  return szMsg
end
...
function tbSkill:GetAutoDesc(tbAutoInfo, tbSkillInfo)
  ...
  szMsg = szMsg .. string.format("自动释放持续<color=gold>%s秒<color>的烟雾弹，自身处于烟雾附近时可以保持隐身状态", FightSkill:Frame2Sec(tbChildInfo.tbWholeMagic["missile_lifetime_v"][1]))

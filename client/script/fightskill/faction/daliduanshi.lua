...
function tbSkill:GetExtraDesc(tbInfo)
  ...
  local szMsg =
    string.format("<color=green>中冲剑<color>\n冰攻攻击：<color=gold>%s到%s点<color>\n造成迟缓的几率：<color=gold>%d%%<color>，持续<color=gold>%s秒<color>\n发挥基础攻击力：<color=gold>%s%%<color>\n<color=green>少泽剑<color>\n冰攻攻击：<color=gold>%s到%s点<color>\n发挥基础攻击力：<color=gold>%s%%<color>\n<color=green>商阳剑<color>\n造成灼伤的几率：<color=gold>%d%%<color>，持续<color=gold>%s秒<color>\n<color=green>关冲剑<color>\n造成虚弱的几率：<color=gold>%d%%<color>，持续<color=gold>%s秒<color>\n<color=green>少冲剑<color>\n造成眩晕的几率：<color=gold>%d%%<color>，持续<color=gold>%s秒<color>", tbCCInfo2.tbWholeMagic["colddamage_v"][1], tbCCInfo2.tbWholeMagic["colddamage_v"][3], tbCCInfo2.tbWholeMagic["state_slowall_attack"][1], FightSkill:Frame2Sec(tbCCInfo2.tbWholeMagic["state_slowall_attack"][2]), tbCCInfo2.nAppenDamageP, tbCCInfo5.tbWholeMagic["colddamage_v"][1], tbCCInfo5.tbWholeMagic["colddamage_v"][3], tbCCInfo5.nAppenDamageP, tbCCInfo1.tbWholeMagic["state_burn_attack"][1], FightSkill:Frame2Sec(tbCCInfo1.tbWholeMagic["state_burn_attack"][2]), tbCCInfo3.tbWholeMagic["state_weak_attack"][1], FightSkill:Frame2Sec(tbCCInfo3.tbWholeMagic["state_weak_attack"][2]), tbCCInfo4.tbWholeMagic["state_stun_attack"][1], FightSkill:Frame2Sec(tbCCInfo4.tbWholeMagic["state_stun_attack"][2]))
  return szMsg
end

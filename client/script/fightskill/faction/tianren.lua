...
local tb = {
  ...
  zhanren120 = { --战忍120_10
    changecdtype = {
      { { 1, 492 }, { 10, 492 } },
      { { 1, 100 }, { 5, 100 }, { 6, 200 }, { 9, 200 }, { 10, 300 }, { 11, 300 } },
      { { 1, 100 }, { 10, 150 }, {
        11,
        150,
      } },
...
function tbSkill:GetAutoDesc(tbAutoInfo, tbSkillInfo)
  local tbChildInfo = KFightSkill.GetSkillInfo(tbAutoInfo.nSkillId, tbAutoInfo.nSkillLevel)
  local szMsg = string.format("重伤时触发几率：<color=gold>%d%%<color>\n最多同时影响目标：<color=gold>%d个<color>\n造成周围对手混乱的几率：<color=gold>%d%%<color>，持续<color=gold>%s秒<color>\n造成周围对手灼伤的几率：<color=gold>%d%%<color>，持续<color=gold>%s秒<color>\n触发间隔时间：<color=Gold>%s秒<color>", tbAutoInfo.nPercent, tbChildInfo.nMissileHitcount, tbChildInfo.tbWholeMagic["state_confuse_attack"][1], FightSkill:Frame2Sec(tbChildInfo.tbWholeMagic["state_confuse_attack"][2]), tbChildInfo.tbWholeMagic["state_burn_attack"][1], FightSkill:Frame2Sec(tbChildInfo.tbWholeMagic["state_burn_attack"][2]), FightSkill:Frame2Sec(tbAutoInfo.nPerCastTime))
  return szMsg
end
...
function tbSkill:GetAutoDesc(tbAutoInfo, tbSkillInfo)
  local tbChildInfo = KFightSkill.GetSkillInfo(tbAutoInfo.nSkillId, tbAutoInfo.nSkillLevel)
  local tbCCInfo = KFightSkill.GetSkillInfo(tbChildInfo.tbEvent.nStartSkillId, tbChildInfo.tbEvent.nLevel)
  local szMsg = string.format("\n<color=green>子招式<color>\n被攻击命中时触发几率：<color=gold>%d%%<color>\n最多同时影响目标：<color=gold>%d个<color>\n造成攻击者麻痹的几率：<color=gold>%d%%<color>，持续<color=gold>%s秒<color>\n自身移动速度：<color=gold>增加%s%%<color>，持续<color=gold>%s秒<color>\n触发间隔时间：<color=Gold>%s秒<color>", tbAutoInfo.nPercent, tbChildInfo.nMissileHitcount, tbChildInfo.tbWholeMagic["state_palsy_attack"][1], FightSkill:Frame2Sec(tbChildInfo.tbWholeMagic["state_palsy_attack"][2]), tbCCInfo.tbWholeMagic["fastwalkrun_p"][1], FightSkill:Frame2Sec(tbCCInfo.nStateTime), FightSkill:Frame2Sec(tbAutoInfo.nPerCastTime))
  return szMsg
end
...
function tbSkill:GetAutoDesc(tbAutoInfo, tbSkillInfo)
  local tbChildInfo = KFightSkill.GetSkillInfo(tbAutoInfo.nSkillId, tbAutoInfo.nSkillLevel)
  local szMsg = string.format("下<color=gold>%d次<color>攻击命中时会使自身进入异常状态：\n<color=gold>%d%%的几率受伤%s秒\n%d%%的几率虚弱%s秒\n%d%%的几率迟缓%s秒\n%d%%的几率灼伤%s秒\n%d%%的几率眩晕%s秒<color>", tbAutoInfo.nCastCount, tbChildInfo.tbWholeMagic["state_hurt_attack"][1], FightSkill:Frame2Sec(tbChildInfo.tbWholeMagic["state_hurt_attack"][2]), tbChildInfo.tbWholeMagic["state_weak_attack"][1], FightSkill:Frame2Sec(tbChildInfo.tbWholeMagic["state_weak_attack"][2]), tbChildInfo.tbWholeMagic["state_slowall_attack"][1], FightSkill:Frame2Sec(tbChildInfo.tbWholeMagic["state_slowall_attack"][2]), tbChildInfo.tbWholeMagic["state_burn_attack"][1], FightSkill:Frame2Sec(tbChildInfo.tbWholeMagic["state_burn_attack"][2]), tbChildInfo.tbWholeMagic["state_stun_attack"][1], FightSkill:Frame2Sec(tbChildInfo.tbWholeMagic["state_stun_attack"][2]))
  return szMsg
end

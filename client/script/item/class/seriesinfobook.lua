...
tbSeriesInfoBook.MSG_INFO = "五行书：五行轮转，万象更新。阴阳之法，造化乾坤。" .. "阁下若对某件装备可以被什么属性的装备激活，或者可以激活什么属性的装备不理解，" .. "请按书中所指明确你要查询五行关系的装备，由五行书告知你一切。"
...
function tbSeriesInfoBook:Conclusion()
  ...
  local szMsg = "您当前指定要查询的装备是<color=red>" .. tostring(Env.SERIES_NAME[self.nSelSeries]) .. "<color>属性的<color=red>" .. tostring(Item.EQUIPPOS_NAME[self.nSelEquip]) .. "<color>。它能够被<color=red>" .. tostring(Env.SERIES_NAME[nAccruedSeries]) .. "<color>属性的<color=red>" .. tostring(Item.EQUIPPOS_NAME[nEquipActive1]) .. "<color>，<color=red>" .. tostring(Item.EQUIPPOS_NAME[nEquipActive2]) .. "<color>激活。能够激活<color=red>" .. tostring(Env.SERIES_NAME[nAccrueSeries]) .. "<color>属性功能的<color=red>" .. tostring(Item.EQUIPPOS_NAME[nEquipActived1]) .. "<color>和<color=red>" .. tostring(Item.EQUIPPOS_NAME[nEquipActived2]) .. "<color>。"

...
local function _GEN_TASK_FUN(szDesc, nTaskId)
  local funGet = function()
    return self.GetTask(nTaskId)
  end
  local funSet = function(nValue)
    return self.SetTask(nTaskId, nValue)
  end
  local funAdd = function(nValue)
...
local function _GEN_TASK_FUN_CHECK_U(szDesc, nTaskId)
  ...
  local funSet = function(nValue)
    if nValue < 0 then
      ...
      print(string.format("Error:_GEN_TASK_FUN_CHECK_U SetTaskValue szDesc = %s, nOrgValue = %s nSetValue = %s", szDesc, nOrgValue, nValue))
      nValue = 0
    end
    return self.SetTask(nTaskId, nValue)
  end
  local funAdd = function(nValue)
    ...
    if (nOrgValue + nValue) < 0 then
      print(string.format("Error:_GEN_TASK_FUN_CHECK_U AddTaskValue szDesc = %s, nOrgValue = %s nAddValue = %s", szDesc, nOrgValue, nValue))
      nValue = -nOrgValue
    end
    return self.AddTask(nTaskId, nValue)
  end
...
local function _GEN_TASK_RANGE_FUN(szDesc, nBeginTaskId, nEndTaskId)
  ...
  local funSet = function(nIndex, nValue)
    assert(self) -- 不能是删……为了保证第一个参数是self
    if nBeginTaskId + nIndex - 1 > nEndTaskId then
      return
    end
  ...
  local funAdd = function(nIndex, nValue)
    assert(self) -- 不能是删……为了保证第一个参数是self
    if nBeginTaskId + nIndex - 1 > nEndTaskId then
      return
    end
...
_GEN_HISTORY_RECORD_FUN("Establish", 1, 8, "<color=purple>%s<color>帮会正式成立，帮主为：<color=green>%s<color>，成员有：<color=purple>%s %s %s %s %s %s<color> 家族")
_GEN_HISTORY_RECORD_FUN("Split", 2, 1, "<color=purple>%s<color>帮会从本帮中分离")
_GEN_HISTORY_RECORD_FUN("Compose", 3, 1, "<color=purple>%s<color>并入本帮中")
_GEN_HISTORY_RECORD_FUN("KinJoin", 4, 1, "<color=purple>%s<color>家族加入了本帮")
_GEN_HISTORY_RECORD_FUN("KinLeave", 5, 1, "<color=purple>%s<color>家族离开了本帮")
_GEN_HISTORY_RECORD_FUN("Decleared", 6, 1, "帮会<color=purple>%s<color>向本帮宣战")
_GEN_HISTORY_RECORD_FUN("DeclearTo", 7, 1, "本帮向帮会<color=purple>%s<color>宣战")
_GEN_HISTORY_RECORD_FUN("Occupy", 8, 1, "本帮占领了<color=yellow>%s<color>")
_GEN_HISTORY_RECORD_FUN("Lost", 9, 1, "本帮会失去了<color=yellow>%s<color>")
_GEN_HISTORY_RECORD_FUN("FactionElect", 15, 3, "<color=green>%s<color>荣获第%s届<color=gold>%s门派大师兄/大师姐<color>称号！")
_GEN_HISTORY_RECORD_FUN("Ladder", 16, 3, "<color=green>%s<color>荣获第%s届<color=gold>武林联赛%s<color>！")

_GEN_AFFAIR_RECORD_FUN("Occupy", 8, 1, "本帮占领了<color=yellow>%s<color>")
_GEN_AFFAIR_RECORD_FUN("Lost", 9, 1, "本帮会失去了<color=yellow>%s<color>")
_GEN_AFFAIR_RECORD_FUN("Union", 10, 5, "本帮与帮会<color=purple>%s %s %s %s %s<color>结盟")
_GEN_AFFAIR_RECORD_FUN("LeaveUnion", 11, 1, "<color=purple>%s<color>帮会退出联盟")
_GEN_AFFAIR_RECORD_FUN("ChangeMaster", 12, 2, "<color=green>%s<color>代替玩家<color=green>%s<color>成为本帮帮主")
_GEN_AFFAIR_RECORD_FUN("SaveFund", 13, 2, "<color=green>%s<color>存入了<color=yellow>%s<color>两帮会资金")
_GEN_AFFAIR_RECORD_FUN("TakeFund", 14, 2, "<color=green>%s<color>取出了<color=yellow>%s<color>两帮会资金")
_GEN_AFFAIR_RECORD_FUN("FactionElect", 15, 3, "<color=green>%s<color>荣获第%s届<color=gold>%s门派大师兄/大师姐<color>称号！")
_GEN_AFFAIR_RECORD_FUN("Ladder", 16, 3, "<color=green>%s<color>荣获第%s届<color=gold>武林联赛%s<color>！")
_GEN_AFFAIR_RECORD_FUN("GreatMember", 17, 5, "<color=green>%s %s %s %s %s<color>当选为本周帮会优秀成员！")
_GEN_AFFAIR_RECORD_FUN("TongAward", 18, 2, "<color=green>%s<color>发放了价值<color=yellow>%s<color>两帮会建设资金的领土战军饷")
_GEN_AFFAIR_RECORD_FUN("DispenseFund", 19, 3, "<color=green>%s<color>发放了<color=yellow>%s<color>(两/人)帮会资金给<color=green>%s<color>")
_GEN_AFFAIR_RECORD_FUN("BuildFund", 20, 2, "<color=green>%s<color>使用帮会银锭增加了<color=yellow>%s<color>两帮会建设资金")
_GEN_AFFAIR_RECORD_FUN("Capital", 21, 1, "本帮将主城设立在了<color=yellow>%s<color>")

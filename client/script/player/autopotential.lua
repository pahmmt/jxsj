-- Chức năng tự động phân phối điểm tiềm năng
...
function Player:AutoAssginPotential(nFactionId, nRouteId, nRemain) -- Giao diện gọi lại chương trình: Tự động phân phối tiềm năng
  ...
  if 0 == nSum then
    print("Giá trị của mỗi mục trong bảng phân phối tự động không thể đều là 0!")
    return
  end

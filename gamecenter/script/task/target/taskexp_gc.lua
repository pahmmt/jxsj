...
function tbTaskExp:AlterRoleName(szOldName, szNewName)
  self:LoadBuffer_GC()
  if self.tbCheXiaoBuffer and self.tbCheXiaoBuffer[szOldName] then
    self.tbCheXiaoBuffer[szNewName] = self.tbCheXiaoBuffer[szOldName]
    self.tbCheXiaoBuffer[szOldName] = nil
    self:SaveBuffer_GC()
  end
end

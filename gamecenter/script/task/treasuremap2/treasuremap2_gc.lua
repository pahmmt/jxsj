...
function TreasureMap2:Apply_GC(tbData)
  GlobalExcute({ "TreasureMap2:SyncMap", tbData })
end
...
function TreasureMap2:ApplyGiveHorse_BiLuoGu(tbInstancKey)
  ...
  local nTodayCount = KGblTask.SCGetDbTaskInt(DBTASK_TREASUREMAP_BILUOGU_HORSE_COUNT) or 0

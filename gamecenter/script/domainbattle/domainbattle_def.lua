...
DOMAINBATTLE_SCORE_RATE_TABLE = { -- 功勋档次&比例	帮会奖励价值量比例   档次名称					系统奖励价值量比例
...
JUNXU_MEDICINE_NAME = {
  [JUNXU_MEDICINE] = { [1783] = "回血丹", [1784] = "回内丹", [1785] = "乾坤造化丸" },
}
...
Domain.bOpenWritePlayerInfo = 1
Domain.nCheckPlayerTimeLimit = 3 * 30 * 24 * 3600
Domain.nTimeJianju1 = 15 * 60 * Env.GAME_FPS
Domain.nTimeJianju2 = 10 * 60 * Env.GAME_FPS
Domain.nEndTimes = 8
Domain.nMinPay = 100

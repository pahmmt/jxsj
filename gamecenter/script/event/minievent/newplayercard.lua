...
tbEvent.DEF_AWARD_NEWCARD = {
  ...
  { nLevel = 20, nTaskId = 14, tbItem = { { tbItem = { 18, 1, 71, 2 }, nNum = 20, nDay = 30 } }, szSelect = "领取20级奖励" }, --大白驹丸20个,20级
  {
    nLevel = 30,
    nTaskId = 15,
    tbItem = { { tbItem = { 18, 1, 113, 1 }, nNum = 1, nDay = 30 }, { tbItem = { 18, 1, 2, 2 }, nNum = 1, nDay = 30 } },
    szSelect = "领取30级奖励",
  }, --传声海螺（10句）1个、金犀（2级）1个,30级
  ...
  { nLevel = 50, nTaskId = 17, tbItem = { { tbItem = { 18, 1, 1, 5 }, nNum = 20, nDay = 30 } }, nBindMoney = 100000, szSelect = "领取50级奖励" }, --5级玄晶20个、100000绑定银两,50级
  {
    nLevel = 60,
    nTaskId = 18,
    tbItem = { { tbItem = { 18, 1, 1, 6 }, nNum = 10, nDay = 30 } },
    nBindMoney = 200000,
    nPayLimit = 15,
    szSelect = "领取60级奖励",
  }, --6级玄晶10个、200000绑定银两,60级,当月充值48元
  {
    nLevel = 69,
    nTaskId = 19,
    tbItem = { { tbItem = { 18, 1, 1, 7 }, nNum = 10, nDay = 30 } },
    nBindMoney = 300000,
    nBindCoin = 5000,
    nPayLimit = 15,
    szSelect = "领取69级奖励",
  }, --7级玄晶10个、300000绑定银两、5000绑定金币,69级,当月充值48元
}
...
tbEvent.DEF_AWARD_TUIGUANGYUAN = {
  ...
  { nLevel = 40, nTaskId = 16, tbItem = { { tbItem = { 18, 1, 286, 4 }, nNum = 1, nDay = 30 } }, nBindCoin = 2000, szSelect = "领取40级奖励" }, --4级玄晶20个、2000绑定金币,40级
  {
    nLevel = 50,
    nTaskId = 17,
    tbItem = { { tbItem = { 18, 1, 286, 5 }, nNum = 1, nDay = 30 }, { tbItem = { 18, 1, 287, 2 }, nNum = 1, nDay = 30 } },
    nBindMoney = 100000,
    szSelect = "领取50级奖励",
  }, --5级玄晶20个、100000绑定银两,50级, 大白驹丸20个
  {
    nLevel = 60,
    nTaskId = 18,
    tbItem = { { tbItem = { 18, 1, 286, 6 }, nNum = 1, nDay = 30 } },
    nBindMoney = 200000,
    nPayLimit = 48,
    szSelect = "领取60级奖励",
  }, --6级玄晶10个、200000绑定银两,60级,当月充值48元
  {
    nLevel = 69,
    nTaskId = 19,
    tbItem = { { tbItem = { 18, 1, 286, 7 }, nNum = 1, nDay = 30 } },
    nBindMoney = 300000,
    nBindCoin = 5000,
    nPayLimit = 48,
    szSelect = "领取69级奖励",
...
tbEvent.DEF_AWARD_FEEDBACK = {
  {
    nLevel = 69,
    nTaskId = 12,
    tbItem = { { tbItem = { 18, 1, 23, 1 }, nNum = 1, nDay = 7 } },
    nPayLimit = 48,
    szSelect = "领取无限回城符（1周）",
    nPayMax = 500,
    nPrestige = 100,
  }, --无限回城符（1周）,1级
  {
    nLevel = 69,
    nTaskId = 13,
    tbItem = { { tbItem = { 18, 1, 85, 1 }, nNum = 1, nDay = 30 } },
    nPayLimit = 48,
    szSelect = "领取1张乾坤符",
    nPayMax = 500,
    nPrestige = 100,
  }, --乾坤符1张,10级
  {
    nLevel = 69,
    nTaskId = 14,
    tbItem = { { tbItem = { 18, 1, 71, 2 }, nNum = 20, nDay = 30 } },
    nPayLimit = 48,
    szSelect = "领取20个大白驹丸",
    nPayMax = 500,
    nPrestige = 100,
  ...
  }, --传声海螺（10句）1个、金犀（2级）1个,30级
  {
    nLevel = 69,
    nTaskId = 16,
    tbItem = { { tbItem = { 18, 1, 1, 4 }, nNum = 20, nDay = 30 } },
    nBindCoin = 2000,
    nPayLimit = 48,
    szSelect = "领取20个4级玄晶和2000绑定金币",
    nPayMax = 500,
    nPrestige = 100,
  }, --4级玄晶20个、2000绑定金币,40级
  {
    nLevel = 69,
    nTaskId = 17,
    tbItem = { { tbItem = { 18, 1, 1, 5 }, nNum = 20, nDay = 30 } },
    nBindMoney = 100000,
    nPayLimit = 48,
    szSelect = "领取20个5级玄晶和100000绑定银两",
    nPayMax = 500,
    nPrestige = 100,
  }, --5级玄晶20个、100000绑定银两,50级
  {
    nLevel = 69,
    nTaskId = 18,
    tbItem = { { tbItem = { 18, 1, 1, 6 }, nNum = 10, nDay = 30 } },
...
tbEvent.DEF_BUYFULI_LIST = {
  --					选项，					条件等级区间，金币，奇珍阁Id，任务变量
  {
    ...
    613,
    231,
    "你确定要使用<color=yellow>10金币<color>，<color=yellow>低于0.1折<color>的优惠购买<color=yellow>游龙阁开心蛋（2000绑定金币）<color>吗？",
  },
  {
    "[30-50级]购买游龙阁金锭",
    30,
    ...
    612,
    232,
    "你确定要使用<color=yellow>200金币<color>，<color=yellow>低于1折<color>的优惠购买<color=yellow>游龙阁金锭（50万绑定银两）<color>吗？",
  },
  {
    "[50-60级]购买游龙阁开心蛋",
    50,
    ...
    90,
    233,
    "你确定要使用<color=yellow>200金币<color>，<color=yellow>低于1折<color>的优惠购买<color=yellow>游龙阁开心蛋（2000绑定金币）<color>吗？",
  },
  {
    "[60-70级]购买游龙阁开心蛋",
    60,
...
function tbEvent:OnGetAwardFeedBack(tbData, tbAbout)
  ...
  for nId, tbAward in ipairs(tbData) do
    if me.GetTask(self.TASK_GOURP_ID, tbAward.nTaskId) == 0 and ((tbAward.nLevel and me.nLevel >= tbAward.nLevel) or (tbAward.funCondition and tbAward.funCondition(me) == 1)) then
...
function tbEvent:BuyItemFuliSure(nType)
  ...
  if me.GetExtMonthPay() <= 0 then
    Dialog:Say("你的本月还没有进行过充值，只要进行任意充值，就可拥有购买资格。", tbPayOpt)
    return
  end

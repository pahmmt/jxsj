...
tbEuropean.BASE_BUFFER = {
  [1] = {
    szTime = "2012年6月22日",
    tbTime = { 201206201400, 201206220200 },
    tbTeam = { "意大利", "平局", "克罗地亚" },
    tbAward = { 3.66, 1.88, 1.22 },
    nResult = 0,
  },
  [2] = {
    szTime = "2012年6月23日",
    tbTime = { 201206221400, 201206230200 },
    tbTeam = { "荷兰", "平局", "法国" },
    tbAward = { 3.66, 1.88, 1.22 },
    nResult = 0,
  },
  [3] = {
    szTime = "2012年6月24日",
    tbTime = { 201206231400, 201206240200 },
    tbTeam = { "西班牙", "平局", "德国" },
    tbAward = { 3.66, 1.88, 1.22 },
    nResult = 0,
  },
  [4] = {
    szTime = "2012年6月25日",
    tbTime = { 201206241400, 201206250200 },
    tbTeam = { "英格兰", "平局", "克罗地亚" },
    tbAward = { 3.66, 1.88, 1.22 },
    nResult = 0,
  },
  [5] = {
    szTime = "2012年6月29日",
    tbTime = { 201206251400, 201206290200 },
    tbTeam = { "意大利", "平局", "西班牙" },
    tbAward = { 3.66, 1.88, 1.22 },
    nResult = 0,
  },
  [6] = {
    szTime = "2012年6月30日",
    tbTime = { 201206291400, 201206300200 },
    tbTeam = { "英格兰", "平局", "法国" },
    tbAward = { 3.66, 1.88, 1.22 },
    nResult = 0,
  },
  [7] = {
    szTime = "2012年7月02日",
    tbTime = { 201206301400, 201207020200 },
    tbTeam = { "意大利", "平局", "英格兰" },
    tbAward = { 3.66, 1.88, 1.22 },
    nResult = 0,
  },

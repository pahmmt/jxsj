...
tbRoleTransfer.nCancelApplyCoin = 5000 --角色转移资格证兑换的绑金
...
tbRoleTransfer.tbInfo = {
  ...
  [[
	<color=green>转移条件：<color>
		...
		2、角色等级超过90级
		3、账号解锁状态
		4、携带角色转移资格证(15000金币,现打折只需5000金币)
	]],
  [[
	<color=green>转移流程：<color>
		...
		5、转出角色将被传入灵山顶，需要在山顶老人处购买神仙绳（15000金币,现打折只需5000金币）才能进入游戏。
	]],
  [[
	<color=green>注意事项：<color>
		...
		4、取消申请需要上交角色转移资格证，角色转移证被扣除的同时将会返还花费同等数量金币购买道具的绑定金币（15000绑定金币,现打折只返还5000绑定金币）； 

...
function Kinsalary:UpdateKinMemberWeeklyTask(pKin)
  ...
  while pMember do
    ...
    if MODULE_GC_SERVER then
      if nCurWeek > 0 then
        StatLog:WriteStatLog("stat_info", "family_salary", "acitive_get_new", pMember.GetPlayerId(), pMember["Get" .. self.EVENT_TYPE[1].szKey](), pMember["Get" .. self.EVENT_TYPE[1].szTimes](), pMember["Get" .. self.EVENT_TYPE[2].szKey](), pMember["Get" .. self.EVENT_TYPE[2].szTimes](), pMember["Get" .. self.EVENT_TYPE[3].szKey](), pMember["Get" .. self.EVENT_TYPE[3].szTimes](), pMember["Get" .. self.EVENT_TYPE[4].szKey](), pMember["Get" .. self.EVENT_TYPE[4].szTimes](), pMember["Get" .. self.EVENT_TYPE[5].szKey](), pMember["Get" .. self.EVENT_TYPE[5].szTimes](), pMember["Get" .. self.EVENT_TYPE[6].szKey](), pMember["Get" .. self.EVENT_TYPE[6].szTimes](), pMember["Get" .. self.EVENT_TYPE[7].szKey](), pMember["Get" .. self.EVENT_TYPE[7].szTimes](), pMember["Get" .. self.EVENT_TYPE[8].szKey](), pMember["Get" .. self.EVENT_TYPE[8].szTimes](), pMember["Get" .. self.EVENT_TYPE[9].szKey](), pMember["Get" .. self.EVENT_TYPE[9].szTimes]())
      end
    end

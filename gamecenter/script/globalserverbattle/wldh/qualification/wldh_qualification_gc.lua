...
function tbQualification:MakeProssession_GC()
  ...
  -- 取武林荣誉排行榜，返回table
  local tbPlayerRank = GetTotalLadderPart(Ladder:GetType(0, Ladder.LADDER_CLASS_WULIN, Ladder.LADDER_TYPE_WULIN_HONOR_WULIN, 0), 1, 100)
...
function tbQualification:FinalProssession_GC()
  ...
  local tbPlayerRank = GetTotalLadderPart(Ladder:GetType(0, Ladder.LADDER_CLASS_LADDER, Ladder.LADDER_TYPE_LADDER_ACTION, Ladder.LADDER_TYPE_LADDER_ACTION_PRETTYGIRL), 1, 50)

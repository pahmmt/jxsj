...
function tbBattle:LeagueRank(bFinal)
  ...
  if MODULE_GC_SERVER then
    -- 当届前10名入榜.
    self:SetRankData(self.MATCH_TYPE, self.tbLeagueRank, Wldh.MAP_LINK_TYPE_RANDOM, Wldh.LADDER_ID[nType][1], 0, Wldh.LADDER_ID[nType][2], Wldh.LADDER_ID[nType][3], Wldh.LADDER_ID[nType][4])

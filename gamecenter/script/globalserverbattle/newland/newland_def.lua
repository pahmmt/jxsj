...
Newland.MIN_MEMBER = EventManager.IVER_nNewLandMinTongMember -- 30个雏凤披风
Newland.MIN_MANTLE_LEVEL_NAME = EventManager.IVER_szNewLandMinLevelName
Newland.CONDITION_JOIN_NEWLAMD = string.format("<color=green>参战条件：<enter>    1、等级达到100级、已加入门派；<enter>    2、装备有%s或以上的披风；<enter>    3、帮会首领代表全帮报名。<color>", Newland.MIN_MANTLE_LEVEL_NAME)
...
Newland.PLAY_TIME = 60 * 60 -- 战斗进行时间
...
Newland.NPC_CLASS = {
  ...
  ["newland_floor_1_to_2"] = {
    MapLevel = 1,
    FightState = 1,
    SuperTime = 8,
    Check = "Check_Next",
    StepMap = 1,
    TransPos = { { 1672, 3384 }, { 1872, 3358 }, { 1790, 3543 } },
  },
  ["newland_floor_2_to_3"] = {
    MapLevel = 2,
    FightState = 1,
    SuperTime = 8,
    Check = "Check_Next",
    StepMap = 1,
    TransPos = { { 1513, 3251 }, { 1512, 3695 }, { 2070, 3227 }, { 1962, 3824 }, { 1618, 3138 }, { 1621, 3812 }, { 1978, 3116 }, { 2067, 3710 } },
  },
  ["newland_floor_3_to_2"] = {
    MapLevel = 3,
    FightState = 1,
    SuperTime = 8,
    Check = "Check_Back",
  ...
  ["newland_floor_2_to_1"] = {
    MapLevel = 2,
    FightState = 0,
    SuperTime = 8,
    Check = "Check_Back",
    StepMap = -1,
    TransPos = { { 1647, 3345 }, { 1884, 3302 }, { 1819, 3576 } },
  },
}

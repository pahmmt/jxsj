...
function Boss:ScheduleCallOut(nSeqNum)
  ...
  -- 为了改变boss的固定等级
  local nLevel = tbCallOutInfo.nLevel
  ...
  elseif tbCallOutInfo.nLevel == 120 then
    ...
    nLevel = Boss.Qinshihuang:GetNpcLevel()
  end
  ...
  GlobalExcute({ "Boss:DoCallOut", tbCallOutInfo.nTemplateId, nLevel, nSeries, nMapId, nMapX, nMapY })
  return 0
end

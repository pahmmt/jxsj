...
MIN_LEVEL = 30 -- 最低等级
MAX_TEAM = 8 -- 闯关最大队伍数
MAX_VIP_TEAM = 2 -- vip预留的队伍数
MAX_NOR_TEAM = MAX_TEAM - MAX_VIP_TEAM -- 普通最大队伍数
...
RANK_RECORD = 5
MAX_EASY_PRESTIGE = 50 -- 简单逍遥谷最多可获得威望点数
ONCE_EASY_PRESTIGE = 2 -- 1次简单逍遥谷通关2点威望

LIMIT_ROOM_PAYVALUE = 100 -- 充值100才能进限制充值的房间

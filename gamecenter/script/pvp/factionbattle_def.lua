...
FactionBattle.FACTION_TO_MAP = {
  ...
  [Env.FACTION_ID_TIANWANG] = 242,
  [Env.FACTION_ID_TANGMEN] = 243,
  [Env.FACTION_ID_WUDU] = 244,
  [Env.FACTION_ID_EMEI] = 245,
  [Env.FACTION_ID_CUIYAN] = 246,
  [Env.FACTION_ID_GAIBANG] = 247,
  [Env.FACTION_ID_TIANREN] = 248,
  [Env.FACTION_ID_WUDANG] = 249,
  [Env.FACTION_ID_KUNLUN] = 250,
  [Env.FACTION_ID_MINGJIAO] = 251,
  [Env.FACTION_ID_DALIDUANSHI] = 252,
  [Env.FACTION_ID_GUMU] = 2262,
}
...
PLAYER_COUNT_LIMIT = {
  ...
  [3] = 100,
  [4] = 150,
  [5] = 100000, --(无限大,假如因为人数>10W人而造成BUG，我们该庆祝了)
}

-- 淘汰赛刷箱子数量表
BOX_NUM = { --	 比赛各强	散落宝箱数(2)	(3)		(4)		(5)
  { 16, 1, 2, 3, 4 }, -- 16进8奖励
  { 8, 2, 4, 6, 8 }, -- 8进4奖励
  { 4, 4, 8, 12, 16 }, -- 4进2奖励
  { 2, 8, 16, 24, 30 }, -- 2进1奖励
...
tbDescrption_2S = {
  ["KillInMelee"] = {
    [_MODEL_OLD] = "你击败了<color=yellow>%s<color>，当前连胜为<color=green>%d<color>",
    [_MODEL_NEW] = "你击败了<color=yellow>%s<color>，当前积分为<color=green>%d<color>",
  },
}
...
-- 自由PK重新投入战斗时间表
RETURN_TO_MELEE_TIME = { -- 死亡次数			等待时间
  [1] = 10,
  [2] = 20,
  [3] = 40,
  [4] = 60,
...
AWARD_TABLE = { --		心得		威望		门派声望	额外奖励（X分钟经验、X个箱子）  股份基数	荣誉
...
TB_TITLE = {
  [CAMP_RED] = { "门派竞技乾队", "blue" },
  [CAMP_BLUE] = { "门派竞技坤队", "purple" },
}
...
STATE_TRANS = {
  --	 状态 					定时时间				时间到回调函数(函数返回0表示不在继续定时，结束活动)
  { SIGN_UP, 30 * 60, "StartMelee_New" }, -- 报名定时
